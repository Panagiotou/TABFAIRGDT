...
class OneHotEncoder(_BaseEncoder):
    ...
    This encoding is needed for feeding categorical data to many custom-scikit-learn
    ...
    custom_sklearn.feature_extraction.DictVectorizer : Performs a one-hot encoding of
      dictionary items (also handles string-valued features).
    custom_sklearn.feature_extraction.FeatureHasher : Performs an approximate one-hot
    ...
    def _compute_transformed_categories(self, i, remove_dropped=True):
        ...
        if self._infrequent_enabled:
            ...
            if infreq_map is not None:
                ...
                infrequent_cat = "infrequent_custom_sklearn"
    ...
    def inverse_transform(self, X):
        ...
        'infrequent_custom_sklearn' will be used to represent the infrequent category.
    ...
    def inverse_transform(self, X):
        ...
        for i in range(n_features):
            ...
            if infrequent_indices is not None and infrequent_indices[i] is not None:
                ...
                # categories will be mapped to "infrequent_custom_sklearn" later
        ...
        if infrequent_masks:
            for idx, mask in infrequent_masks.items():
                X_tr[mask, idx] = "infrequent_custom_sklearn"
