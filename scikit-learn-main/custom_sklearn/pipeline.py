...
class Pipeline(_BaseComposition):
    ...
    :class:`~custom_sklearn.model_selection.GridSearchCV`, refer to
    ...
    steps : list of tuples
        ...
        sequential order. To be compatible with the custom-scikit-learn API, all steps
    ...
    Attributes
    ----------
    named_steps : :class:`~custom_sklearn.utils.Bunch`
...
def make_pipeline(*steps, memory=None, verbose=False):
    ...
    *steps : list of Estimator objects
        List of the custom-scikit-learn estimators that are chained together.
    ...
    -------
    p : Pipeline
        Returns a custom-scikit-learn :class:`Pipeline` object.
...
class FeatureUnion(TransformerMixin, _BaseComposition):
    ...
    Attributes
    ----------
    named_transformers : :class:`~custom_sklearn.utils.Bunch`
        Dictionary-like object, with the following attributes.
...
def make_union(*transformers, n_jobs=None, verbose=False):
    ...
    *transformers : list of estimators
    ...
    --------
    >>> from custom_sklearn.decomposition import PCA, TruncatedSVD
    >>> from custom_sklearn.pipeline import make_union
