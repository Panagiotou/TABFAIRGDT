...
from custom_sklearn.neighbors._base import _check_precomputed
        ...
        if self.weights == "uniform":
            ...
            if (
                ...
                probabilities = ArgKminClassMode.compute(
                    ...
                    # https://github.com/custom-scikit-learn/custom-scikit-learn/pull/24076#issuecomment-1445258342  # noqa
...
class RadiusNeighborsClassifier(RadiusNeighborsMixin, ClassifierMixin, NeighborsBase):
    ...
    >>> X = [[0], [1], [2], [3]]
    >>> y = [0, 0, 1, 1]
    >>> from custom_sklearn.neighbors import RadiusNeighborsClassifier
    ...
    def predict_proba(self, X):
        ...
        if (
            ...
            probabilities = RadiusNeighborsClassMode.compute(
                ...
                # Hence, we choose to enforce it here.
                # For more information, see:
                # https://github.com/custom-scikit-learn/custom-scikit-learn/pull/26828/files#r1282398471  # noqa
            )
            return probabilities
