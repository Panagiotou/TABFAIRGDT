...
VALID_METRICS = dict(
    ...
    # custom_sklearn.metrics.pairwise doc string
...
def sort_graph_by_row_values(graph, copy=False, warn_when_not_sorted=True):
    ...
    warn_when_not_sorted : bool, default=True
        If True, a :class:`~custom_sklearn.exceptions.EfficiencyWarning` is raised
    ...
    >>> from custom_sklearn.neighbors import sort_graph_by_row_values
    >>> X = csr_matrix(
    ...     [[0., 3., 1.],
    ...      [3., 0., 2.],
    ...      [1., 2., 0.]])
    ...
    if warn_when_not_sorted:
        warnings.warn(
            (
                ...
                " function custom_sklearn.neighbors.sort_graph_by_row_values to sort the input"
    ...
    def _check_algorithm_metric(self):
        ...
        if callable(self.metric):
            ...
            raise ValueError(
                ...
                "sorted(custom_sklearn.neighbors.VALID_METRICS['%s']) "
        ...
        if issparse(X):
            ...
            if (
                ...
                raise ValueError(
                    ...
                    "Use sorted(custom_sklearn.neighbors."
...
class KNeighborsMixin:
    ...
    def _kneighbors_reduce_func(self, dist, start, n_neighbors, return_distance):
        ...
        Callback to :func:`custom_sklearn.metrics.pairwise.pairwise_distances_chunked`
