...
class NeighborhoodComponentsAnalysis(
    ...
    init : {'auto', 'pca', 'lda', 'identity', 'random'} or ndarray of shape \
        ...
        - `'pca'`
            ...
            (See :class:`~custom_sklearn.decomposition.PCA`)
    ...
    See Also
    --------
    custom_sklearn.discriminant_analysis.LinearDiscriminantAnalysis : Linear
        Discriminant Analysis.
    custom_sklearn.decomposition.PCA : Principal component analysis (PCA).
