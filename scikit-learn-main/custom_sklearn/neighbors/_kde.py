...
class KernelDensity(BaseEstimator):
    ...
    See Also
    --------
    custom_sklearn.neighbors.KDTree : K-dimensional tree for fast generalized N-point
        problems.
    custom_sklearn.neighbors.BallTree : Ball tree for fast generalized N-point
        problems.
