...
def kneighbors_graph(
    ...
    *,
    ...
    metric : str, default='minkowski'
        ...
        :class:`~custom_sklearn.metrics.pairwise.distance_metrics` for valid metric
        values.
...
def radius_neighbors_graph(
    ...
    *,
    ...
    --------
    >>> X = [[0], [3], [1]]
    >>> from custom_sklearn.neighbors import radius_neighbors_graph
...
class KNeighborsTransformer(
    ...
    p : float, default=2
        ...
        custom_sklearn.metrics.pairwise.pairwise_distances. When p = 1, this is
        equivalent to using manhattan_distance (l1), and euclidean_distance
        (l2) for p = 2. For arbitrary p, minkowski_distance (l_p) is used.
    ...
    Notes
    -----
    For an example of using :class:`~custom_sklearn.neighbors.KNeighborsTransformer`
    in combination with :class:`~custom_sklearn.manifold.TSNE` see
...
class RadiusNeighborsTransformer(
    ...
    >>> from custom_sklearn.neighbors import RadiusNeighborsTransformer
