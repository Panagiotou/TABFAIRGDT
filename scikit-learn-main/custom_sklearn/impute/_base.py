...
class SimpleImputer(_BaseImputer):
    ...
    .. versionadded:: 0.20
       `SimpleImputer` replaces the previous `custom_sklearn.preprocessing.Imputer`
    ...
    :class:`~custom_sklearn.impute.IterativeImputer` or :class:`~custom_sklearn.impute.KNNImputer`.
...
class MissingIndicator(TransformerMixin, BaseEstimator):
    ...
    :class:`~custom_sklearn.pipeline.Pipeline` consisting of transformers and a
