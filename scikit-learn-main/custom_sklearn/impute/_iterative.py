...
class IterativeImputer(_BaseImputer):
    ...
    .. note::
      ...
      you need to explicitly import `enable_iterative_imputer`::
        ...
        >>> # now you can import normally from custom_sklearn.impute
    ...
    initial_strategy : {'mean', 'median', 'most_frequent', 'constant'}, \
        ...
        `strategy` parameter in :class:`~custom_sklearn.impute.SimpleImputer`.
    ...
    Attributes
    ----------
    initial_imputer_ : object of type :class:`~custom_sklearn.impute.SimpleImputer`
    ...
    indicator_ : :class:`~custom_sklearn.impute.MissingIndicator`
    ...
    def _impute_one_feature(
        ...
        estimator : estimator with custom_sklearn API
    ...
    def fit_transform(self, X, y=None, **params):
        ...
        **params : dict
            ...
            .. versionadded:: 1.5
              Only available if
              `custom_sklearn.set_config(enable_metadata_routing=True)` is set. See
