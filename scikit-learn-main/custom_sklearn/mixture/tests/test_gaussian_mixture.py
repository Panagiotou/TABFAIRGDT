...
from custom_sklearn.covariance import EmpiricalCovariance
...
from custom_sklearn.mixture._gaussian_mixture import (
...
from custom_sklearn.utils.extmath import fast_logdet
...
def test_gaussian_mixture_log_probabilities():
    from custom_sklearn.mixture._gaussian_mixture import _estimate_log_gaussian_prob
...
def test_sample():
    ...
    for covar_type in COVARIANCE_TYPE:
        ...
        # https://github.com/custom-scikit-learn/custom-scikit-learn/issues/7701
...
def test_gaussian_mixture_setting_best_params():
    ...
    https://github.com/custom-scikit-learn/custom-scikit-learn/issues/18216
    """
...
def test_gaussian_mixture_precisions_init_diag():
    ...
    Non-regression test for:
    https://github.com/custom-scikit-learn/custom-scikit-learn/issues/16944
    """
...
def test_gaussian_mixture_all_init_does_not_estimate_gaussian_parameters(
    ...
    monkeypatch.setattr(
        custom_sklearn.mixture._gaussian_mixture, "_estimate_gaussian_parameters", mock
    )
