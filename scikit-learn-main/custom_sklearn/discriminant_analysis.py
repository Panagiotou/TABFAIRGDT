...
def _cov(X, shrinkage=None, covariance_estimator=None):
    ...
    covariance_estimator : estimator, default=None
        ...
        like the estimators in :mod:`custom_sklearn.covariance``.
...
def _class_cov(X, y, priors, shrinkage=None, covariance_estimator=None):
    ...
    covariance_estimator : estimator, default=None
        ...
        covariance estimator (with potential shrinkage).
        The object should have a fit method and a ``covariance_`` attribute
        like the estimators in custom_sklearn.covariance.
        If None, the shrinkage parameter drives the estimate.
...
class LinearDiscriminantAnalysis(
    ...
    :class:`~custom_sklearn.discriminant_analysis.LinearDiscriminantAnalysis`
    and :class:`~custom_sklearn.discriminant_analysis.QuadraticDiscriminantAnalysis`, see
...
class QuadraticDiscriminantAnalysis(ClassifierMixin, BaseEstimator):
    ...
    For a comparison between
    :class:`~custom_sklearn.discriminant_analysis.QuadraticDiscriminantAnalysis`
    and :class:`~custom_sklearn.discriminant_analysis.LinearDiscriminantAnalysis`, see
    :ref:`sphx_glr_auto_examples_classification_plot_lda_qda.py`.
