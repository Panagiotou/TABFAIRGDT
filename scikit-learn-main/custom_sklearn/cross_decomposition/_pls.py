"""
The :mod:`custom_sklearn.pls` module implements Partial Least Squares (PLS).
"""
...
class PLSRegression(_PLS):
    ...
    Examples
    --------
    >>> from custom_sklearn.cross_decomposition import PLSRegression
    ...
    For a comparison between PLS Regression and :class:`~custom_sklearn.decomposition.PCA`, see
...
class PLSCanonical(_PLS):
    ...
    Examples
    --------
    >>> from custom_sklearn.cross_decomposition import PLSCanonical
    >>> X = [[0., 0., 1.], [1.,0.,0.], [2.,2.,2.], [2.,5.,4.]]
    >>> y = [[0.1, -0.2], [0.9, 1.1], [6.2, 5.9], [11.9, 12.3]]
...
class CCA(_PLS):
    ...
    Examples
    --------
    >>> from custom_sklearn.cross_decomposition import CCA
...
class PLSSVD(ClassNamePrefixFeaturesOutMixin, TransformerMixin, BaseEstimator):
    ...
    --------
    >>> import numpy as np
    >>> from custom_sklearn.cross_decomposition import PLSSVD
    >>> X = np.array([[0., 0., 1.],
    ...               [1., 0., 0.],
    ...               [2., 2., 2.],
    ...               [2., 5., 4.]])
