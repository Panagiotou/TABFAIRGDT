...
from custom_sklearn.cross_decomposition import CCA, PLSSVD, PLSCanonical, PLSRegression
from custom_sklearn.cross_decomposition._pls import (
    _center_scale_xy,
    _get_first_singular_vectors_power_method,
    _get_first_singular_vectors_svd,
    _svd_flip_1d,
)
from custom_sklearn.datasets import load_linnerud, make_regression
...
from custom_sklearn.utils.extmath import svd_flip
...
def test_sanity_check_pls_regression():
    ...
    # the case.
    # xref: https://github.com/custom-scikit-learn/custom-scikit-learn/issues/22420
...
def test_pls_regression_scaling_coef():
    ...
    Non-regression test for:
    https://github.com/custom-scikit-learn/custom-scikit-learn/issues/27964
    """
