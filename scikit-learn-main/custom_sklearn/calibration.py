...
class CalibratedClassifierCV(ClassifierMixin, MetaEstimatorMixin, BaseEstimator):
    ...
    via :func:`~custom_sklearn.model_selection.cross_val_predict`, which are then
    used for calibration. For prediction, the base estimator, trained using all
    the data, is used. This is the prediction method implemented when
    `probabilities=True` for :class:`~custom_sklearn.svm.SVC` and :class:`~custom_sklearn.svm.NuSVC`
    ...
    estimator : estimator instance, default=None
        ...
        a :class:`~custom_sklearn.svm.LinearSVC`.
    ...
    cv : int, cross-validation generator, iterable or "prefit", \
        ...
        :class:`~custom_sklearn.model_selection.StratifiedKFold` is used. If ``y`` is
        neither binary nor multiclass, :class:`~custom_sklearn.model_selection.KFold`
        is used.
    ...
    ensemble : bool, default=True
        ...
        :func:`~custom_sklearn.model_selection.cross_val_predict`, which are then
        used for calibration. At prediction time, the classifier used is the
        `estimator` trained on all the data.
        Note that this method is also internally implemented  in
        :mod:`custom_sklearn.svm` estimators with the `probabilities=True` parameter.
    ...
    >>> from custom_sklearn.calibration import CalibratedClassifierCV
            ...
            if _routing_enabled():
                ...
                if sample_weight is not None and not supports_sw:
                    ...
                    warnings.warn(
                        ...
                        " the current custom-scikit-learn API. See the following issue for"
                        " more details:"
                        " https://github.com/custom-scikit-learn/custom-scikit-learn/issues/21134."
    ...
    def get_metadata_routing(self):
        ...
        routing : MetadataRouter
            A :class:`~custom_sklearn.utils.metadata_routing.MetadataRouter` encapsulating
            routing information.
        """
        router = (
...
def calibration_curve(
    ...
    *,
    ...
    --------
    >>> import numpy as np
    >>> from custom_sklearn.calibration import calibration_curve
...
class CalibrationDisplay(_BinaryClassifierCurveDisplayMixin):
    ...
    :func:`~custom_sklearn.calibration.CalibrationDisplay.from_estimator` or
    :func:`~custom_sklearn.calibration.CalibrationDisplay.from_predictions`
    to create a `CalibrationDisplay`. All parameters are stored as attributes.

    Read more about calibration in the :ref:`User Guide <calibration>` and
    more about the custom-scikit-learn visualization API in :ref:`visualizations`.
    ...
    >>> from custom_sklearn.calibration import calibration_curve, CalibrationDisplay
    ...
    def plot(self, *, ax=None, name=None, ref_line=True, **kwargs):
        ...
        **kwargs : dict
        ...
        Returns
        -------
        display : :class:`~custom_sklearn.calibration.CalibrationDisplay`
    ...
    def from_estimator(
        ...
        **kwargs,
        ...
        ----------
        estimator : estimator instance
            Fitted classifier or a fitted :class:`~custom_sklearn.pipeline.Pipeline`
        ...
        **kwargs : dict
        ...
        >>> from custom_sklearn.model_selection import train_test_split
        >>> from custom_sklearn.linear_model import LogisticRegression
        >>> from custom_sklearn.calibration import CalibrationDisplay
        >>> X, y = make_classification(random_state=0)
        >>> X_train, X_test, y_train, y_test = train_test_split(
        ...     X, y, random_state=0)
        >>> clf = LogisticRegression(random_state=0)
