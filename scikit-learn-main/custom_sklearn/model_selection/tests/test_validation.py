...
from custom_sklearn.base import BaseEstimator, clone
...
from custom_sklearn.metrics._scorer import _MultimetricScorer
...
from custom_sklearn.model_selection._validation import (
    _check_is_permutation,
    _fit_and_score,
    _score,
)
from custom_sklearn.model_selection.tests.common import OneTimeSplitter
from custom_sklearn.model_selection.tests.test_search import FailingClassifier
...
from custom_sklearn.preprocessing import LabelEncoder, scale
...
from custom_sklearn.utils.fixes import COO_CONTAINERS, CSR_CONTAINERS
...
def test_cross_validate_nested_estimator():
    ...
    # https://github.com/custom-scikit-learn/custom-scikit-learn/pull/17745
    (X, y) = load_iris(return_X_y=True)
    pipeline = Pipeline(
        [
