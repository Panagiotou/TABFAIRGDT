...
from custom_sklearn.base import BaseEstimator, ClassifierMixin, is_classifier
from custom_sklearn.cluster import KMeans
from custom_sklearn.datasets import (
    make_blobs,
    make_classification,
...
from custom_sklearn.exceptions import FitFailedWarning
from custom_sklearn.experimental import enable_halving_search_cv  # noqa
from custom_sklearn.feature_extraction.text import TfidfVectorizer
from custom_sklearn.impute import SimpleImputer
from custom_sklearn.linear_model import (
    LinearRegression,
    LogisticRegression,
    Ridge,
    SGDClassifier,
)
from custom_sklearn.metrics import (
    accuracy_score,
    confusion_matrix,
    f1_score,
    make_scorer,
...
from custom_sklearn.model_selection._search import BaseSearchCV
from custom_sklearn.model_selection.tests.common import OneTimeSplitter
from custom_sklearn.naive_bayes import ComplementNB
from custom_sklearn.neighbors import KernelDensity, KNeighborsClassifier, LocalOutlierFactor
from custom_sklearn.pipeline import Pipeline
from custom_sklearn.preprocessing import StandardScaler
from custom_sklearn.svm import SVC, LinearSVC
from custom_sklearn.tests.metadata_routing_common import (
    ConsumingScorer,
    _Registry,
    check_recorded_metadata,
)
from custom_sklearn.tree import DecisionTreeClassifier, DecisionTreeRegressor
from custom_sklearn.utils._mocking import CheckingClassifier, MockDataFrame
...
from custom_sklearn.utils.validation import _num_samples
...
def test_grid_search():
    ...
    grid_search.scoring = "custom_sklearn"
...
def test_searchcv_raise_warning_with_non_finite_score(
    ...
    # https://github.com/custom-scikit-learn/custom-scikit-learn/issues/10529
...
def test_scalar_fit_param_compat(SearchCV, param_search):
    ...
    # that do not exactly respect the custom-scikit-learn API contract but that we do
