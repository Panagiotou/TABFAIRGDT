...
from custom_sklearn.model_selection._search_successive_halving import (
    _SubsampleMetaSplitter,
    _top_k,
)
from custom_sklearn.model_selection.tests.test_search import (
...
@pytest.mark.filterwarnings("ignore::custom_sklearn.exceptions.FitFailedWarning")
...
def test_cv_results(Est):
    ...
    # https://github.com/custom-scikit-learn/custom-scikit-learn/issues/19203
