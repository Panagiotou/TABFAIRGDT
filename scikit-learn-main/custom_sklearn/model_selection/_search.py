"""
The :mod:`custom_sklearn.model_selection._search` includes utilities to fine-tune the
...
class ParameterGrid:
    ...
    Examples
    --------
    >>> from custom_sklearn.model_selection import ParameterGrid
...
class ParameterSampler:
    ...
    Examples
    --------
    >>> from custom_sklearn.model_selection import ParameterSampler
...
class GridSearchCV(BaseSearchCV):
    ...
    estimator : estimator object
        This is assumed to implement the custom-scikit-learn estimator interface.
