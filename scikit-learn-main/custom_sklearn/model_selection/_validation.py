"""
The :mod:`custom_sklearn.model_selection._validation` module includes classes and
...
def _check_params_groups_deprecation(fit_params, params, groups, version):
    ...
    if groups is not None and _routing_enabled():
        raise ValueError(
            ...
            " `custom_sklearn.set_config(enable_metadata_routing=True)`. When routing is"
    ...
    *,
    ...
    groups : array-like of shape (n_samples,), default=None
        ...
        .. versionchanged:: 1.4
            ...
            via ``custom_sklearn.set_config(enable_metadata_routing=True)``. When routing
    ...
    custom_sklearn.metrics.make_scorer : Make a scorer from a performance metric or
        loss function.

    Examples
    --------
    >>> from custom_sklearn import datasets, linear_model
...
def _fit_and_score(
    ...
    *,
    ...
    if parameters is not None:
        ...
        # ref: https://github.com/custom-scikit-learn/custom-scikit-learn/pull/26786
...
def cross_val_predict(
    ...
    *,
    ...
    --------
    >>> from custom_sklearn import datasets, linear_model
    >>> from custom_sklearn.model_selection import cross_val_predict
    >>> diabetes = datasets.load_diabetes()
    >>> X = diabetes.data[:150]
    >>> y = diabetes.target[:150]
    >>> lasso = linear_model.Lasso()
        ...
        try:
            ...
            raise UnsetMetadataPassedError(
                message=(
                    ...
                    " guide <https://custom-scikit-learn.org/stable/metadata_routing.html>"
    ...
    if n_classes != len(classes):
        ...
        if method == "decision_function":
            if predictions.ndim == 2 and predictions.shape[1] != len(classes):
                ...
                # it with. This case is found when custom_sklearn.svm.SVC is
...
def permutation_test_score(
    ...
    *,
    ...
    >>> from custom_sklearn.model_selection import permutation_test_score
...
def learning_curve(
    ...
    *,
    ...
    >>> from custom_sklearn.model_selection import learning_curve
...
def validation_curve(
    ...
    *,
    ...
    >>> import numpy as np
    >>> from custom_sklearn.datasets import make_classification
    >>> from custom_sklearn.model_selection import validation_curve
    >>> from custom_sklearn.linear_model import LogisticRegression
