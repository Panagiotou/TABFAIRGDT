...
class LearningCurveDisplay(_BaseCurveDisplay):
    ...
    :meth:`~custom_sklearn.model_selection.LearningCurveDisplay.from_estimator` to
    create a :class:`~custom_sklearn.model_selection.LearningCurveDisplay` instance.
    ...
    See Also
    --------
    custom_sklearn.model_selection.learning_curve : Compute the learning curve.

    Examples
    --------
    >>> import matplotlib.pyplot as plt
    >>> from custom_sklearn.datasets import load_iris
    >>> from custom_sklearn.model_selection import LearningCurveDisplay, learning_curve
    ...
    def plot(
        ...
        *,
        ...
        negate_score : bool, default=False
            ...
            :func:`~custom_sklearn.model_selection.learning_curve`. This is
        ...
        Returns
        -------
        display : :class:`~custom_sklearn.model_selection.LearningCurveDisplay`
    ...
    def from_estimator(
        ...
        *,
        ...
        cv : int, cross-validation generator or an iterable, default=None
            ...
            :class:`~custom_sklearn.model_selection.StratifiedKFold` is used. In all
            other cases, :class:`~custom_sklearn.model_selection.KFold` is used. These
        ...
        >>> import matplotlib.pyplot as plt
        >>> from custom_sklearn.datasets import load_iris
        >>> from custom_sklearn.model_selection import LearningCurveDisplay
        >>> from custom_sklearn.tree import DecisionTreeClassifier
        >>> X, y = load_iris(return_X_y=True)
        >>> tree = DecisionTreeClassifier(random_state=0)
...
class ValidationCurveDisplay(_BaseCurveDisplay):
    ...
    It is recommended to use
    :meth:`~custom_sklearn.model_selection.ValidationCurveDisplay.from_estimator` to
    create a :class:`~custom_sklearn.model_selection.ValidationCurveDisplay` instance.
    All parameters are stored as attributes.
    ...
    See Also
    --------
    custom_sklearn.model_selection.validation_curve : Compute the validation curve.
    ...
    >>> from custom_sklearn.model_selection import ValidationCurveDisplay, validation_curve
    ...
    def plot(
        ...
        *,
        ...
        negate_score : bool, default=False
            Whether or not to negate the scores obtained through
            :func:`~custom_sklearn.model_selection.validation_curve`. This is
            particularly useful when using the error denoted by `neg_*` in
            `custom-scikit-learn`.
        ...
        Returns
        -------
        display : :class:`~custom_sklearn.model_selection.ValidationCurveDisplay`
            Object that stores computed values.
        """
        self._plot_curve(
            self.param_range,
    ...
    def from_estimator(
        ...
        *,
        ...
        >>> import matplotlib.pyplot as plt
        >>> from custom_sklearn.datasets import make_classification
        >>> from custom_sklearn.model_selection import ValidationCurveDisplay
        >>> from custom_sklearn.linear_model import LogisticRegression
        >>> X, y = make_classification(n_samples=1_000, random_state=0)
        >>> logistic_regression = LogisticRegression()
        >>> param_name, param_range = "C", np.logspace(-8, 3, 10)
