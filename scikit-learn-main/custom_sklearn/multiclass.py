...
All classifiers in custom-scikit-learn implement multiclass classification; you
...
class OneVsRestClassifier(
    ...
    custom_sklearn.multioutput.MultiOutputClassifier : Alternate way of extending an
        estimator for multilabel classification.
    custom_sklearn.preprocessing.MultiLabelBinarizer : Transform iterable of iterables
    ...
    def decision_function(self, X):
        ...
        T : array-like of shape (n_samples, n_classes) or (n_samples,) for \
            ...
            .. versionchanged:: 0.19
                ...
                custom-scikit-learn conventions for binary classification.
        """
        check_is_fitted(self)
        if len(self.estimators_) == 1:
