...
class Birch(
    ...
    n_clusters : int, instance of custom_sklearn.cluster model or None, default=3
        ...
        - :mod:`custom_sklearn.cluster` Estimator : If a model is provided, the model
    ...
    * Roberto Perdisci
    ...
    Examples
    --------
    >>> from custom_sklearn.cluster import Birch
