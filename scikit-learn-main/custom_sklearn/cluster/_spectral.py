...
def spectral_clustering(
    ...
    *,
    ...
    >>> from custom_sklearn.cluster import spectral_clustering
...
class SpectralClustering(ClusterMixin, BaseEstimator):
    ...
    affinity : str or callable, default='rbf'
        How to construct the affinity matrix.
         ...
         - one of the kernels supported by
           :func:`~custom_sklearn.metrics.pairwise.pairwise_kernels`.
    ...
    See Also
    --------
    custom_sklearn.cluster.KMeans : K-Means clustering.
    custom_sklearn.cluster.DBSCAN : Density-Based Spatial Clustering of
