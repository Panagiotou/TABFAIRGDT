...
def estimate_bandwidth(X, *, quantile=0.3, n_samples=None, random_state=0, n_jobs=None):
    ...
    --------
    >>> import numpy as np
    >>> from custom_sklearn.cluster import estimate_bandwidth
...
def mean_shift(
    ...
    *,
    ...
    bandwidth : float, default=None
        ...
        the number of samples. The custom_sklearn.cluster.estimate_bandwidth function
    ...
    --------
    >>> import numpy as np
    >>> from custom_sklearn.cluster import mean_shift
    >>> X = np.array([[1, 1], [2, 1], [1, 0],
    ...               [4, 7], [3, 5], [3, 6]])
...
class MeanShift(ClusterMixin, BaseEstimator):
    ...
    bandwidth : float, default=None
        ...
        custom_sklearn.cluster.estimate_bandwidth; see the documentation for that
    ...
    Examples
    --------
    >>> from custom_sklearn.cluster import MeanShift
    >>> import numpy as np
    >>> X = np.array([[1, 1], [2, 1], [1, 0],
    ...               [4, 7], [3, 5], [3, 6]])
