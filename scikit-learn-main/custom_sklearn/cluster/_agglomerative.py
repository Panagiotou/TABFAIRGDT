...
# mypy error: Module 'custom_sklearn.cluster' has no attribute '_hierarchical_fast'
...
def ward_tree(X, *, connectivity=None, n_clusters=None, return_distance=False):
    ...
    --------
    >>> import numpy as np
    >>> from custom_sklearn.cluster import ward_tree
...
def linkage_tree(
    ...
    if connectivity is None:
        ...
        if affinity == "precomputed":
            ...
            # by custom_sklearn.metrics.pairwise_distances.
...
class FeatureAgglomeration(
    ...
    --------
    >>> import numpy as np
    >>> from custom_sklearn import datasets, cluster
