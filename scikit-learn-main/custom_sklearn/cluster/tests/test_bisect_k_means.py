...
from custom_sklearn.cluster import BisectingKMeans
...
def test_no_crash_on_empty_bisections(algorithm):
    ...
    # https://github.com/custom-scikit-learn/custom-scikit-learn/issues/27081
    rng = np.random.RandomState(0)
...
def test_one_feature():
    ...
    # Non-regression test for:
    # https://github.com/custom-scikit-learn/custom-scikit-learn/issues/27236
