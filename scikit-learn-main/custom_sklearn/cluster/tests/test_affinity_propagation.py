...
from custom_sklearn.cluster import AffinityPropagation, affinity_propagation
from custom_sklearn.cluster._affinity_propagation import _equal_similarities_and_preferences
...
# For more details, see: https://github.com/custom-scikit-learn/custom-scikit-learn/issues/11000
...
def test_affinity_propagation_equal_points():
    ...
    https://github.com/custom-scikit-learn/custom-scikit-learn/pull/20043
    """
    X = np.zeros((8, 1))
