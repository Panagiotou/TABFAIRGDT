...
from custom_sklearn.cluster._hdbscan._tree import (
    CONDENSED_dtype,
    _condense_tree,
    _do_labelling,
)
from custom_sklearn.cluster._hdbscan.hdbscan import _OUTLIER_ENCODING
from custom_sklearn.datasets import make_blobs
from custom_sklearn.metrics import fowlkes_mallows_score
from custom_sklearn.metrics.pairwise import _VALID_METRICS, euclidean_distances
from custom_sklearn.neighbors import BallTree, KDTree
...
def test_hdbscan_error_precomputed_and_store_centers(store_centers):
    ...
    https://github.com/custom-scikit-learn/custom-scikit-learn/issues/27893
    """
    rng = np.random.RandomState(0)
    X = rng.random((100, 2))
