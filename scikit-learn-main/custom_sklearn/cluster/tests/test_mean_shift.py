...
from custom_sklearn.cluster import MeanShift, estimate_bandwidth, get_bin_seeds, mean_shift
...
def test_convergence_of_1d_constant_data():
    ...
    # https://github.com/custom-scikit-learn/custom-scikit-learn/issues/28926
    model = MeanShift()
