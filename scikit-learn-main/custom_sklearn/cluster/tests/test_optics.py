...
from custom_sklearn.cluster import DBSCAN, OPTICS
from custom_sklearn.cluster._optics import _extend_region, _extract_xi_labels
from custom_sklearn.cluster.tests.common import generate_clustered_data
from custom_sklearn.datasets import make_blobs
from custom_sklearn.exceptions import DataConversionWarning, EfficiencyWarning
...
def test_nowarn_if_metric_bool_data_bool():
    ...
    # https://github.com/custom-scikit-learn/custom-scikit-learn/issues/18996
...
def test_compare_to_ELKI():
    ...
    # Does NOT work with metric='euclidean', because custom_sklearn euclidean has
...
def test_optics_input_not_modified_precomputed_sparse_nodiag(csr_container):
    ...
    Non-regression test for:
    https://github.com/custom-scikit-learn/custom-scikit-learn/issues/27508
    """
...
def test_optics_predecessor_correction_ordering():
    ...
    Non-regression test for:
    https://github.com/custom-scikit-learn/custom-scikit-learn/issues/26324
    """
