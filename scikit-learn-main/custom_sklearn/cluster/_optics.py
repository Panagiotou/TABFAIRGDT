...
class OPTICS(ClusterMixin, BaseEstimator):
    ...
    current custom_sklearn implementation of DBSCAN.
    ...
    metric : str or callable, default='minkowski'
        ...
        Sparse matrices are only supported by custom-scikit-learn metrics.
    ...
    p : float, default=2
        ...
        :class:`~custom_sklearn.metrics.pairwise_distances`. When p = 1, this is
    ...
    algorithm : {'auto', 'ball_tree', 'kd_tree', 'brute'}, default='auto'
        ...
        - 'ball_tree' will use :class:`~custom_sklearn.neighbors.BallTree`.
        - 'kd_tree' will use :class:`~custom_sklearn.neighbors.KDTree`.
    ...
    leaf_size : int, default=30
        Leaf size passed to :class:`~custom_sklearn.neighbors.BallTree` or
        :class:`~custom_sklearn.neighbors.KDTree`. This can affect the speed of the
    ...
    Examples
    --------
    >>> from custom_sklearn.cluster import OPTICS
    >>> import numpy as np
...
def compute_optics_graph(
    ...
    --------
    >>> import numpy as np
    >>> from custom_sklearn.cluster import compute_optics_graph
    >>> X = np.array([[1, 2], [2, 5], [3, 6],
    ...               [8, 7], [8, 8], [7, 3]])
...
def cluster_optics_dbscan(*, reachability, core_distances, ordering, eps):
    ...
    ``labels_`` which are close to a :class:`~custom_sklearn.cluster.DBSCAN` with
    ...
    --------
    >>> import numpy as np
    >>> from custom_sklearn.cluster import cluster_optics_dbscan, compute_optics_graph
    >>> X = np.array([[1, 2], [2, 5], [3, 6],
    ...               [8, 7], [8, 8], [7, 3]])
    >>> ordering, core_distances, reachability, predecessor = compute_optics_graph(
    ...     X,
...
def cluster_optics_xi(
    *,
    ...
    --------
    >>> import numpy as np
    >>> from custom_sklearn.cluster import cluster_optics_xi, compute_optics_graph
    >>> X = np.array([[1, 2], [2, 5], [3, 6],
    ...               [8, 7], [8, 8], [7, 3]])
    >>> ordering, core_distances, reachability, predecessor = compute_optics_graph(
    ...     X,
