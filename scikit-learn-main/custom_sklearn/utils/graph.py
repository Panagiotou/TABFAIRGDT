...
def single_source_shortest_path_length(graph, source, *, cutoff=None):
    ...
    Examples
    --------
    >>> from custom_sklearn.utils.graph import single_source_shortest_path_length
    >>> import numpy as np
...
def _fix_connected_components(
    ...
    **kwargs,
    ...
    metric : str
        Metric used in `custom_sklearn.metrics.pairwise.pairwise_distances`.

    kwargs : kwargs
        Keyword arguments passed to
        `custom_sklearn.metrics.pairwise.pairwise_distances`.
