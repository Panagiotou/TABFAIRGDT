"""Utilities to perform optimal mathematical operations in custom-scikit-learn."""
...
def safe_sparse_dot(a, b, *, dense_output=False):
    ...
    >>> from custom_sklearn.utils.extmath import safe_sparse_dot
...
def randomized_range_finder(
    ...
    --------
    >>> import numpy as np
    >>> from custom_sklearn.utils.extmath import randomized_range_finder
...
def randomized_svd(
    ...
    *,
    ...
    --------
    >>> import numpy as np
    >>> from custom_sklearn.utils.extmath import randomized_svd
    >>> a = np.array([[1, 2, 3, 5],
    ...               [3, 4, 5, 6],
    ...               [7, 8, 9, 10]])
    ...
    if is_array_api_compliant:
        ...
        # previous versions of custom-scikit-learn.
...
def weighted_mode(a, w, *, axis=0):
    ...
    Examples
    --------
    >>> from custom_sklearn.utils.extmath import weighted_mode
    >>> x = [4, 1, 4, 2, 4, 2]
    >>> weights = [1, 1, 1, 1, 1, 1]
...
def cartesian(arrays, out=None):
    ...
    Examples
    --------
    >>> from custom_sklearn.utils.extmath import cartesian
...
def svd_flip(u, v, u_based_decision=True):
    ...
    u : ndarray
        ...
        :func:`~custom_sklearn.utils.extmath.randomized_svd`, with matching inner
...
def safe_sqr(X, *, copy=True):
    ...
    Examples
    --------
    >>> from custom_sklearn.utils import safe_sqr
    >>> safe_sqr([1, 2, 3])
    array([1, 4, 9])
    """
...
def _approximate_mode(class_counts, n_draws, rng):
    ...
    --------
    >>> import numpy as np
    >>> from custom_sklearn.utils.extmath import _approximate_mode
