...
def _raise_for_params(params, owner, method):
    ...
    if not _routing_enabled() and params:
        raise ValueError(
            ...
            " `custom_sklearn.set_config`. See the User Guide"
            " <https://custom-scikit-learn.org/stable/metadata_routing.html> for more"
...
class MethodMetadataRequest:
    ...
    def _route_params(self, params, parent, caller):
        ...
        -------
        params : Bunch
            A :class:`~custom_sklearn.utils.Bunch` of {prop: value} which can be given to the
...
class MetadataRequest:
    ...
    # this file instead of using it directly from custom-scikit-learn.
...
class MetadataRouter:
    ...
    is an instance of :class:`~custom_sklearn.utils.metadata_routing.MethodMapping` and
    ``routing_info`` is either a
    :class:`~custom_sklearn.utils.metadata_routing.MetadataRequest` or a
    :class:`~custom_sklearn.utils.metadata_routing.MetadataRouter` instance.
    ...
    def add_self_request(self, obj):
        ...
        :class:`~custom_sklearn.utils.metadata_routing.MetadataRequest`.
    ...
    def add(self, *, method_mapping, **objs):
        ...
        **objs : dict
            ...
            :func:`~custom_sklearn.utils.metadata_routing.get_routing_for_object` on them.
    ...
    def route_params(self, *, caller, params):
        ...
        The output of this method is a :class:`~custom_sklearn.utils.Bunch`, which includes the
        ...
        -------
        params : Bunch
            A :class:`~custom_sklearn.utils.Bunch` of the form
...
def get_routing_for_object(obj=None):
    ...
    :class:`~custom_sklearn.utils.metadata_routing.MetadataRouter` or a
    :class:`~custom_sklearn.utils.metadata_routing.MetadataRequest` from the given input.
    ...
    obj : object
        ...
        - If the object is already a
            :class:`~custom_sklearn.utils.metadata_routing.MetadataRequest` or a
            :class:`~custom_sklearn.utils.metadata_routing.MetadataRouter`, return a copy
            of that.
        - Returns an empty :class:`~custom_sklearn.utils.metadata_routing.MetadataRequest`
            otherwise.
...
REQUESTER_DOC = """        Request metadata passed to the ``{method}`` method.
        ...
        ``enable_metadata_routing=True`` (see :func:`custom_sklearn.set_config`).
...
this given alias instead of the original name.
        ...
        The default (``custom_sklearn.utils.metadata_routing.UNCHANGED``) retains the
        ...
        .. note::
            ...
            :class:`~custom_sklearn.pipeline.Pipeline`. Otherwise it has no effect.

        Parameters
        ----------
"""
REQUESTER_DOC_PARAM = """        {metadata} : str, True, False, or None, \
                    default=custom_sklearn.utils.metadata_routing.UNCHANGED
...
class RequestMethod:
    ...
    def __get__(self, instance, owner):
        ...
        def func(*args, **kw):
            ...
            # https://github.com/custom-scikit-learn/custom-scikit-learn/issues/28632
            if instance is None:
                _instance = args[0]
                args = args[1:]
            else:
...
class _MetadataRequester:
    ...
    def _get_metadata_request(self):
        ...
        request : MetadataRequest
            A :class:`~custom_sklearn.utils.metadata_routing.MetadataRequest` instance.
        """
    ...
    def get_metadata_routing(self):
        ...
        routing : MetadataRequest
            A :class:`~custom_sklearn.utils.metadata_routing.MetadataRequest` encapsulating
            routing information.
        """
...
def process_routing(_obj, _method, /, **kwargs):
    ...
    **kwargs : dict
    ...
    routed_params : Bunch
        ...
        A :class:`~custom_sklearn.utils.Bunch` of the form ``{"object_name": {"method_name":
        {params: value}}}`` which can be used to pass the required metadata to
