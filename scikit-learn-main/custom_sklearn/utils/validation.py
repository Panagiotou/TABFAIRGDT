"""Functions to validate input and parameters within custom-scikit-learn estimators."""
    ...
    if has_inf or has_nan_error:
        ...
        if estimator_name and input_name == "X" and has_nan_error:
            ...
            msg_err += (
                ...
                " to consider custom_sklearn.ensemble.HistGradientBoostingClassifier and"
                " Regressor which accept missing values encoded as NaNs natively."
                " Alternatively, it is possible to preprocess the data, for"
                " instance by using an imputer transformer in a pipeline or drop"
                " samples with missing values. See"
                " https://custom-scikit-learn.org/stable/modules/impute.html"
...
def assert_all_finite(
    ...
    *,
    ...
    Examples
    --------
    >>> from custom_sklearn.utils import assert_all_finite
    >>> import numpy as np
...
def as_float_array(X, *, copy=True, force_all_finite=True):
    ...
    Examples
    --------
    >>> from custom_sklearn.utils import as_float_array
    >>> import numpy as np
...
def check_memory(memory):
    ...
    Examples
    --------
    >>> from custom_sklearn.utils.validation import check_memory
...
def check_consistent_length(*arrays):
    ...
    *arrays : list or tuple of input objects.
    ...
    Examples
    --------
    >>> from custom_sklearn.utils.validation import check_consistent_length
    >>> a = [1, 2, 3]
    >>> b = [2, 3, 4]
...
def indexable(*iterables):
    ...
    *iterables : {lists, dataframes, ndarrays, sparse matrices}
    ...
    Examples
    --------
    >>> from custom_sklearn.utils import indexable
...
def _ensure_sparse_format(
    ...
    # https://github.com/scipy/scipy/issues/19245 Since not all custom-scikit-learn
...
def check_array(
    ...
    *,
    ...
    Examples
    --------
    >>> from custom_sklearn.utils.validation import check_array
    >>> X = [[1, 2, 3], [4, 5, 6]]
        ...
        for key in index_keys:
            ...
            if indices_datatype not in supported_indices:
                raise ValueError(
                    ...
                    " reproducer on custom-scikit-learn issue tracker so that support for"
                    " your use-case can be studied by maintainers. See:"
                    " https://custom-scikit-learn.org/dev/developers/minimal_reproducer.html"
                )
...
def check_X_y(
    ...
    *,
    ...
    Examples
    --------
    >>> from custom_sklearn.utils.validation import check_X_y
    >>> X = [[1, 2], [3, 4], [5, 6]]
    >>> y = [1, 2, 3]
    >>> X, y = check_X_y(X, y)
    >>> X
...
def column_or_1d(y, *, dtype=None, warn=False):
    ...
    Examples
    --------
    >>> from custom_sklearn.utils.validation import column_or_1d
    >>> column_or_1d([1, 1])
    array([1, 1])
    """
...
def check_random_state(seed):
    ...
    Examples
    --------
    >>> from custom_sklearn.utils.validation import check_random_state
...
def has_fit_parameter(estimator, parameter):
    ...
    >>> from custom_sklearn.utils.validation import has_fit_parameter
...
def check_symmetric(array, *, tol=1e-10, raise_warning=True, raise_exception=False):
    ...
    --------
    >>> import numpy as np
    >>> from custom_sklearn.utils.validation import check_symmetric
...
def _is_fitted(estimator, attributes=None, all_or_any=all):
    ...
    if hasattr(estimator, "__custom_sklearn_is_fitted__"):
        return estimator.__custom_sklearn_is_fitted__()
...
def check_is_fitted(estimator, attributes=None, *, msg=None, all_or_any=all):
    ...
    can define a ``__custom_sklearn_is_fitted__`` method returning a boolean to
    specify if the estimator is fitted or not. See
    :ref:`sphx_glr_auto_examples_developing_estimators_custom_sklearn_is_fitted.py`
    ...
    >>> from custom_sklearn.utils.validation import check_is_fitted
...
def check_scalar(
    ...
    *,
    ...
    Examples
    --------
    >>> from custom_sklearn.utils.validation import check_scalar
...
def _check_psd_eigenvalues(lambdas, enable_warnings=False):
    ...
    Examples
    --------
    >>> from custom_sklearn.utils.validation import _check_psd_eigenvalues
...
def _check_method_params(X, params, indices=None):
    ...
    for param_key, param_value in params.items():
        if (
            ...
            # https://github.com/custom-scikit-learn/custom-scikit-learn/issues/15805
...
def _to_object_array(sequence):
    ...
    --------
    >>> import numpy as np
    >>> from custom_sklearn.utils.validation import _to_object_array
