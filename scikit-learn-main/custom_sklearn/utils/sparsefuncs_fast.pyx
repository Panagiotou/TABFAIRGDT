...
def inplace_csr_row_normalize_l1(X):
    ...
    >>> from custom_sklearn.utils.sparsefuncs_fast import inplace_csr_row_normalize_l1
...
def inplace_csr_row_normalize_l2(X):
    ...
    --------
    >>> from scipy.sparse import csr_matrix
    >>> from custom_sklearn.utils.sparsefuncs_fast import inplace_csr_row_normalize_l2
    >>> X = csr_matrix(([1.0, 2.0, 3.0], [0, 2, 3], [0, 3, 4]), shape=(3, 4))
    >>> X.toarray()
    array([[1., 2., 0., 0.],
           [0., 0., 3., 0.],
