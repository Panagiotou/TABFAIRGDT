...
def _get_response_values(
    ...
    This utility is used primarily in the displays and the custom-scikit-learn scorers.
    ...
    estimator : estimator instance
        ...
        fitted :class:`~custom_sklearn.pipeline.Pipeline` in which the last estimator is a
    ...
    """
    from custom_sklearn.base import is_classifier, is_outlier_detector  # noqa
