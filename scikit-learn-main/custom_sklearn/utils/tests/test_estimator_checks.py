...
from custom_sklearn import config_context, get_config
from custom_sklearn.base import BaseEstimator, ClassifierMixin, OutlierMixin
...
from custom_sklearn.exceptions import ConvergenceWarning, SkipTestWarning
...
from custom_sklearn.mixture import GaussianMixture
from custom_sklearn.neighbors import KNeighborsRegressor
from custom_sklearn.svm import SVC, NuSVC
from custom_sklearn.utils import _array_api, all_estimators, deprecated
from custom_sklearn.utils._param_validation import Interval, StrOptions
...
from custom_sklearn.utils.fixes import CSR_CONTAINERS, SPARRAY_PRESENT
from custom_sklearn.utils.metaestimators import available_if
from custom_sklearn.utils.validation import check_array, check_is_fitted, check_X_y
...
class BadBalancedWeightsClassifier(BaseBadClassifier):
    ...
    def fit(self, X, y):
        from custom_sklearn.preprocessing import LabelEncoder
        from custom_sklearn.utils import compute_class_weight
...
def test_decision_proba_tie_ranking():
    ...
    https://github.com/custom-scikit-learn/custom-scikit-learn/issues/24025
    """
