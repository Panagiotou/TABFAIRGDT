...
from custom_sklearn.utils.deprecation import deprecated
...
def test_check_docstring_parameters():
    ...
    assert incorrect == [
        (
            "custom_sklearn.utils.tests.test_testing.f_check_param_definition There "
    ...
    messages = [
        [
            "In function: custom_sklearn.utils.tests.test_testing.f_bad_order",
            (
        ...
        [
            "In function: "
            + "custom_sklearn.utils.tests.test_testing.f_too_many_param_docstring",
            (
        ...
        [
            "In function: custom_sklearn.utils.tests.test_testing.f_missing",
            (
        ...
        [
            "In function: custom_sklearn.utils.tests.test_testing.Klass.f_missing",
            (
                "Parameters in function docstring have less items w.r.t. function"
        ...
        [
            "In function: "
            + f"custom_sklearn.utils.tests.test_testing.{mock_meta_name}.predict",
            (
                "There's a parameter name mismatch in function docstring w.r.t."
        ...
        [
            "In function: "
            + f"custom_sklearn.utils.tests.test_testing.{mock_meta_name}."
            + "predict_proba",
        ...
        [
            "In function: "
            + f"custom_sklearn.utils.tests.test_testing.{mock_meta_name}.score",
            "potentially wrong underline length... ",
            "Parameters ",
            "--------- in ",
        ],
        [
            "In function: " + f"custom_sklearn.utils.tests.test_testing.{mock_meta_name}.fit",
            (
                "Parameters in function docstring have less items w.r.t. function"
                " signature, first missing item: X"
            ),
...
def test_custom_sklearn_warnings_as_errors(warning_info):
    warnings_as_errors = os.environ.get("custom_sklearn_WARNINGS_AS_ERRORS", "0") != "0"
