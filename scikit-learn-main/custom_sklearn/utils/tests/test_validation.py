...
from custom_sklearn._config import config_context
from custom_sklearn._min_dependencies import dependent_packages
...
from custom_sklearn.exceptions import NotFittedError, PositiveSpectrumWarning
...
from custom_sklearn.metrics.tests.test_score_objects import EstimatorWithFit
from custom_sklearn.neighbors import KNeighborsClassifier
from custom_sklearn.random_projection import _sparse_random_matrix
from custom_sklearn.svm import SVR
from custom_sklearn.utils import (
    _safe_indexing,
    as_float_array,
    check_array,
    check_symmetric,
...
from custom_sklearn.utils._mocking import (
    MockDataFrame,
...
from custom_sklearn.utils.estimator_checks import _NotAnArray
from custom_sklearn.utils.fixes import (
    COO_CONTAINERS,
    CSC_CONTAINERS,
    CSR_CONTAINERS,
    DIA_CONTAINERS,
...
from custom_sklearn.utils.validation import (
    FLOAT_DTYPES,
...
def test_memmap():
    ...
    with NamedTemporaryFile(prefix="custom_sklearn-test") as tmp:
...
def test_check_array_links_to_imputer_doc_only_for_X(input_name, retype):
    ...
    extended_msg = (
        ...
        " to consider custom_sklearn.ensemble.HistGradientBoostingClassifier and Regressor"
...
def test_check_array_series_err_msg():
    ...
    https://github.com/custom-scikit-learn/custom-scikit-learn/issues/27498
    """
...
def test_check_is_fitted_with_is_fitted():
    class Estimator(BaseEstimator):
        ...
        def __custom_sklearn_is_fitted__(self):
...
def test_check_dataframe_fit_attribute():
    ...
    # https://github.com/custom-scikit-learn/custom-scikit-learn/issues/8415
    try:
        import pandas as pd
...
def test_suppress_validation():
    ...
    with pytest.raises(ValueError):
        assert_all_finite(X)
    custom_sklearn.set_config(assume_finite=True)
    assert_all_finite(X)
    custom_sklearn.set_config(assume_finite=False)
    with pytest.raises(ValueError):
        assert_all_finite(X)
...
def test_check_dataframe_mixed_float_dtypes(dtype, bool_dtype):
    ...
    # this situation
    # https://github.com/custom-scikit-learn/custom-scikit-learn/issues/15787
