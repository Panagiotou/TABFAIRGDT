...
from custom_sklearn.utils.fixes import CSC_CONTAINERS, CSR_CONTAINERS, LIL_CONTAINERS
from custom_sklearn.utils.sparsefuncs import (
...
from custom_sklearn.utils.sparsefuncs_fast import (
    assign_rows_csr,
    csr_row_norms,
...
def test_incr_mean_variance_axis_dim_mismatch(sparse_constructor):
    ...
    https://github.com/custom-scikit-learn/custom-scikit-learn/pull/18655
    """
