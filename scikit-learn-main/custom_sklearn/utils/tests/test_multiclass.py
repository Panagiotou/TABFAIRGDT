...
from custom_sklearn.utils.metaestimators import _safe_split
from custom_sklearn.utils.multiclass import (
...
def test_labels_in_bytes_format(input_type):
    ...
    # https://github.com/custom-scikit-learn/custom-scikit-learn/issues/16980
