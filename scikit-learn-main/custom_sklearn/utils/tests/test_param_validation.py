...
from custom_sklearn._config import config_context, get_config
from custom_sklearn.base import BaseEstimator, _fit_context
from custom_sklearn.model_selection import LeaveOneOut
from custom_sklearn.utils import deprecated
...
def test_third_party_estimator():
    """Check that the validation from a custom-scikit-learn estimator inherited by a third
