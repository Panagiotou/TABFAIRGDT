...
from custom_sklearn.isotonic import (
    IsotonicRegression,
    _make_unique,
    check_increasing,
    isotonic_regression,
...
def test_isotonic_regression_with_ties_in_differently_sized_groups():
    ...
    https://github.com/custom-scikit-learn/custom-scikit-learn/issues/9432
...
def test_isotonic_ymin_ymax():
    ...
    # https://github.com/custom-scikit-learn/custom-scikit-learn/issues/6921
    x = np.array(
        [
            1.263,
            1.318,
...
def test_isotonic_zero_weight_loop():
    ...
    # https://github.com/custom-scikit-learn/custom-scikit-learn/issues/4297
...
def test_fast_predict():
    ...
    # https://github.com/custom-scikit-learn/custom-scikit-learn/pull/6206
...
def test_isotonic_copy_before_fit():
    # https://github.com/custom-scikit-learn/custom-scikit-learn/issues/6628
    ir = IsotonicRegression()
    copy.copy(ir)
...
def test_isotonic_non_regression_inf_slope():
    ...
    # see: https://github.com/custom-scikit-learn/custom-scikit-learn/issues/10903
...
def test_isotonic_regression_sample_weight_not_overwritten():
    ...
    https://github.com/custom-scikit-learn/custom-scikit-learn/issues/20508
    """
...
def test_isotonic_regression_output_predict():
    ...
    Non-regression test for:
    https://github.com/custom-scikit-learn/custom-scikit-learn/issues/25499
    """
    pd = pytest.importorskip("pandas")
    X, y = make_regression(n_samples=10, n_features=1, random_state=42)
    regressor = IsotonicRegression()
    with custom_sklearn.config_context(transform_output="pandas"):
        regressor.fit(X, y)
