...
def test_min_dependencies_readme():
    ...
    # custom_sklearn/_min_dependencies.py
    ...
    readme_path = Path(custom_sklearn.__file__).parent.parent
    readme_file = readme_path / "README.rst"

    if not os.path.exists(readme_file):
        # Skip the test if the README.rst file is not available.
        # For instance, when installing custom-scikit-learn from wheels
...
def check_pyproject_section(
    ...
    root_directory = Path(custom_sklearn.__file__).parent.parent
