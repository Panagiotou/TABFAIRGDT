...
from custom_sklearn.base import BaseEstimator, TransformerMixin, clone, is_classifier
...
from custom_sklearn.exceptions import NotFittedError, UnsetMetadataPassedError
from custom_sklearn.feature_extraction.text import CountVectorizer
from custom_sklearn.feature_selection import SelectKBest, f_classif
from custom_sklearn.impute import SimpleImputer
from custom_sklearn.linear_model import Lasso, LinearRegression, LogisticRegression
from custom_sklearn.metrics import accuracy_score, r2_score
from custom_sklearn.model_selection import train_test_split
from custom_sklearn.neighbors import LocalOutlierFactor
from custom_sklearn.pipeline import FeatureUnion, Pipeline, make_pipeline, make_union
from custom_sklearn.preprocessing import FunctionTransformer, StandardScaler
...
from custom_sklearn.utils._metadata_requests import COMPOSITE_METHODS, METHODS
...
def test_step_name_validation():
    ...
    for cls, param in [(Pipeline, "steps"), (FeatureUnion, "transformer_list")]:
        # we validate in construction (despite custom-scikit-learn convention)
...
def test_pipeline_get_tags_none(passthrough):
    ...
    # https://github.com/custom-scikit-learn/custom-scikit-learn/issues/18815
...
def test_feature_union_check_if_fitted():
    """Check __custom_sklearn_is_fitted__ is defined correctly."""
