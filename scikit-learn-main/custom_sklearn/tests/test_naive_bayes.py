...
from custom_sklearn.datasets import load_digits, load_iris
from custom_sklearn.model_selection import cross_val_score, train_test_split
from custom_sklearn.naive_bayes import (
    BernoulliNB,
    CategoricalNB,
    ComplementNB,
    GaussianNB,
...
def test_discretenb_degenerate_one_class_case(
    ...
    # https://github.com/custom-scikit-learn/custom-scikit-learn/issues/18974
...
def test_check_alpha():
    ...
    https://github.com/custom-scikit-learn/custom-scikit-learn/issues/10772
    """
    _ALPHA_MIN = 1e-10
