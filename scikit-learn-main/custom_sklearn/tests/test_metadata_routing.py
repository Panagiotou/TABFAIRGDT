...
from custom_sklearn.utils import metadata_routing
from custom_sklearn.utils._metadata_requests import (
    COMPOSITE_METHODS,
    METHODS,
    SIMPLE_METHODS,
...
from custom_sklearn.utils.metadata_routing import (
    MetadataRequest,
    MetadataRouter,
    MethodMapping,
...
def test_default_request_override():
    ...
    Non-regression test for https://github.com/custom-scikit-learn/custom-scikit-learn/issues/28430
    """
...
def test_method_generation():
    ...
    # TODO: these test classes can be moved to custom_sklearn.utils._testing once we
...
def test_no_metadata_always_works():
    ...
    Non-regression test for https://github.com/custom-scikit-learn/custom-scikit-learn/issues/28246
    """
...
def test_unbound_set_methods_work():
    ...
    Non-regression test for https://github.com/custom-scikit-learn/custom-scikit-learn/issues/28632
    """
