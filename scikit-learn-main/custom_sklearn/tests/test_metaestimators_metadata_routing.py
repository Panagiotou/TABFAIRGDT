...
from custom_sklearn.covariance import GraphicalLassoCV
...
from custom_sklearn.exceptions import UnsetMetadataPassedError
from custom_sklearn.experimental import (
    enable_halving_search_cv,  # noqa
    enable_iterative_imputer,  # noqa
)
from custom_sklearn.feature_selection import (
    RFE,
    RFECV,
    SelectFromModel,
...
from custom_sklearn.multioutput import (
    ClassifierChain,
...
from custom_sklearn.utils.metadata_routing import MetadataRouter
...
def test_non_consuming_estimator_works(metaestimator):
    ...
    # Regression test for https://github.com/custom-scikit-learn/custom-scikit-learn/issues/28239
    if "estimator" not in metaestimator:
        # This test only makes sense for metaestimators which have a
        # sub-estimator, e.g. MyMetaEstimator(estimator=MySubEstimator())
        return
