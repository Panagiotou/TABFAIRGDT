...
from custom_sklearn.calibration import (
...
from custom_sklearn.datasets import load_iris, make_blobs, make_classification
...
from custom_sklearn.isotonic import IsotonicRegression
from custom_sklearn.linear_model import LogisticRegression, SGDClassifier
...
from custom_sklearn.preprocessing import LabelEncoder, StandardScaler
from custom_sklearn.svm import LinearSVC
from custom_sklearn.tree import DecisionTreeClassifier
from custom_sklearn.utils._mocking import CheckingClassifier
...
from custom_sklearn.utils.extmath import softmax
...
def test_calibration_dict_pipeline(dict_data, dict_data_pipeline):
    ...
    See https://github.com/custom-scikit-learn/custom-scikit-learn/issues/8710

    Also test it can predict without running into validation errors.
    See https://github.com/custom-scikit-learn/custom-scikit-learn/issues/19637
    """
    X, y = dict_data
...
def test_calibration_with_fit_params(fit_params_type, data):
    ...
    https://github.com/custom-scikit-learn/custom-scikit-learn/issues/12384
    """
    X, y = data
    fit_params = {
