...
class PCA(_BasePCA):
    ...
    n_oversamples : int, default=10
        ...
        :func:`~custom_sklearn.utils.extmath.randomized_svd` for more details.

        .. versionadded:: 1.1

    power_iteration_normalizer : {'auto', 'QR', 'LU', 'none'}, default='auto'
        Power iteration normalizer for randomized SVD solver.
        Not used by ARPACK. See :func:`~custom_sklearn.utils.extmath.randomized_svd`
        for more details.
    ...
    def _fit_full(self, X, n_components, xp, is_array_api_compliant):
        ...
        # TODO: remove the following two lines when custom-scikit-learn only depends
        ...
        if self._fit_svd_solver == "full":
            ...
            # TODO: remove the following two lines when custom-scikit-learn only
    ...
    def _fit_truncated(self, X, n_components, xp):
        ...
        # * Update custom_sklearn.utils.extmath._incremental_mean_and_var to support array-api
        # See: https://github.com/custom-scikit-learn/custom-scikit-learn/pull/18689#discussion_r1335540991
