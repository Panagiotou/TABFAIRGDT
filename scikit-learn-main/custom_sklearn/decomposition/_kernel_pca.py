...
class KernelPCA(ClassNamePrefixFeaturesOutMixin, TransformerMixin, BaseEstimator):
    ...
    def inverse_transform(self, X):
        ...
        .. note:
            :meth:`~custom_sklearn.decomposition.fit` internally uses a centered
        ...
        .. note::
            ...
            :class:`~custom_sklearn.decomposition.PCA` instead. Unlike
            :class:`~custom_sklearn.decomposition.PCA`,
            :class:`~custom_sklearn.decomposition.KernelPCA`'s ``inverse_transform``
