...
from custom_sklearn.decomposition import PCA, FastICA, fastica
from custom_sklearn.decomposition._fastica import _gs_decorrelation
...
def test_fastica_simple(add_noise, global_random_seed, global_dtype):
    if (
        ...
        pytest.xfail(
            ...
            "https://github.com/custom-scikit-learn/custom-scikit-learn/issues/24131#issuecomment-1208091119"  # noqa
        )
