...
from custom_sklearn.datasets import load_iris, make_blobs, make_circles
...
def test_32_64_decomposition_shape():
    ...
    https://github.com/custom-scikit-learn/custom-scikit-learn/issues/18146
    """
    X, y = make_blobs(
...
def test_kernel_pca_pandas_output():
    ...
    Non-regression test for:
    https://github.com/custom-scikit-learn/custom-scikit-learn/issues/27579
    """
