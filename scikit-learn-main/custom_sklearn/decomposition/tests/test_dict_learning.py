...
from custom_sklearn.decomposition import (
    DictionaryLearning,
...
from custom_sklearn.decomposition._dict_learning import _update_dict
...
def test_sparse_coder_parallel_mmap():
    ...
    # https://github.com/custom-scikit-learn/custom-scikit-learn/issues/5956
...
def test_cd_work_on_joblib_memmapped_data(monkeypatch):
    monkeypatch.setattr(
        custom_sklearn.decomposition._dict_learning,
        "Parallel",
