...
from custom_sklearn.decomposition import NMF, MiniBatchNMF, non_negative_factorization
from custom_sklearn.decomposition import _nmf as nmf  # For testing internals
...
from custom_sklearn.utils.extmath import squared_norm
