...
from custom_sklearn.datasets import load_iris, make_classification, make_low_rank_matrix
from custom_sklearn.decomposition import PCA
from custom_sklearn.decomposition._pca import _assess_dimension, _infer_dimension
from custom_sklearn.utils._array_api import (
    _atol_for_type,
    _convert_to_numpy,
    yield_namespace_device_dtype_combinations,
)
from custom_sklearn.utils._array_api import device as array_device
from custom_sklearn.utils._testing import _array_api_for_tests, assert_allclose
...
def test_pca_sanity_noise_variance(svd_solver):
    ...
    # https://github.com/custom-scikit-learn/custom-scikit-learn/issues/7568
    # https://github.com/custom-scikit-learn/custom-scikit-learn/issues/8541
    # https://github.com/custom-scikit-learn/custom-scikit-learn/issues/8544
...
def test_mle_simple_case():
    ...
    # https://github.com/custom-scikit-learn/custom-scikit-learn/issues/16730
...
def test_pca_randomized_svd_n_oversamples():
    ...
    https://github.com/custom-scikit-learn/custom-scikit-learn/issues/20589
    """
    rng = np.random.RandomState(0)
    n_features = 100
