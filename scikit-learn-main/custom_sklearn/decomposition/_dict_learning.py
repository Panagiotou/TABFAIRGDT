...
def _sparse_encode_precomputed(
    ...
    *,
    ...
    if algorithm == "lasso_lars":
        ...
        # custom_sklearn.linear_model.coordinate_descent.enet_path has a verbosity
...
def sparse_encode(
    ...
    *,
    ...
    See Also
    --------
    custom_sklearn.linear_model.lars_path : Compute Least Angle Regression or Lasso
        path using LARS algorithm.
    custom_sklearn.linear_model.orthogonal_mp : Solves Orthogonal Matching Pursuit problems.
    custom_sklearn.linear_model.Lasso : Train Linear Model with L1 prior as regularizer.
    ...
    --------
    >>> import numpy as np
    >>> from custom_sklearn.decomposition import sparse_encode
...
def dict_learning_online(
    ...
    *,
    ...
    dict_init : ndarray of shape (n_components, n_features), default=None
        ...
        :func:`~custom_sklearn.utils.extmath.randomized_svd`.
    ...
    --------
    >>> import numpy as np
    >>> from custom_sklearn.datasets import make_sparse_coded_signal
    >>> from custom_sklearn.decomposition import dict_learning_online
...
def dict_learning(
    ...
    *,
    ...
    >>> import numpy as np
    >>> from custom_sklearn.datasets import make_sparse_coded_signal
    >>> from custom_sklearn.decomposition import dict_learning
    >>> X, _, _ = make_sparse_coded_signal(
    ...     n_samples=30, n_components=15, n_features=20, n_nonzero_coefs=10,
    ...     random_state=42,
    ... )
...
class SparseCoder(_BaseSparseCoding, BaseEstimator):
    ...
    --------
    >>> import numpy as np
    >>> from custom_sklearn.decomposition import SparseCoder
    >>> X = np.array([[-1, -1, -1], [0, 0, 3]])
    >>> dictionary = np.array(
    ...     [[0, 1, 0],
    ...      [-1, -1, 2],
...
class DictionaryLearning(_BaseSparseCoding, BaseEstimator):
    ...
    fit_algorithm : {'lars', 'cd'}, default='lars'
        * `'lars'`: uses the least angle regression method to solve the lasso
          problem (:func:`~custom_sklearn.linear_model.lars_path`);
        * `'cd'`: uses the coordinate descent method to compute the
          Lasso solution (:class:`~custom_sklearn.linear_model.Lasso`). Lars will be
    ...
    transform_algorithm : {'lasso_lars', 'lasso_cd', 'lars', 'omp', \
        ...
        - `'lars'`: uses the least angle regression method
          (:func:`~custom_sklearn.linear_model.lars_path`);
        - `'lasso_lars'`: uses Lars to compute the Lasso solution.
        - `'lasso_cd'`: uses the coordinate descent method to compute the
          Lasso solution (:class:`~custom_sklearn.linear_model.Lasso`). `'lasso_lars'`
    ...
    >>> import numpy as np
    >>> from custom_sklearn.datasets import make_sparse_coded_signal
    >>> from custom_sklearn.decomposition import DictionaryLearning
...
class MiniBatchDictionaryLearning(_BaseSparseCoding, BaseEstimator):
    ...
    >>> import numpy as np
    >>> from custom_sklearn.datasets import make_sparse_coded_signal
    >>> from custom_sklearn.decomposition import MiniBatchDictionaryLearning
    >>> X, dictionary, code = make_sparse_coded_signal(
    ...     n_samples=30, n_components=15, n_features=20, n_nonzero_coefs=10,
    ...     random_state=42)
