"""
The :mod:`custom_sklearn.metrics.scorer` submodule implements a flexible
interface for model selection and evaluation using
arbitrary score functions.

A scorer object is a callable that can be passed to
:class:`~custom_sklearn.model_selection.GridSearchCV` or
:func:`custom_sklearn.model_selection.cross_val_score` as the ``scoring``
...
def get_scorer(scoring):
    ...
    :func:`~custom_sklearn.metrics.get_scorer_names` can be used to retrieve the names
    ...
    if isinstance(scoring, str):
        try:
            ...
            raise ValueError(
                ...
                "Use custom_sklearn.metrics.get_scorer_names() "
...
def _check_multimetric_scoring(estimator, scoring):
    ...
    Parameters
    ----------
    estimator : custom_sklearn estimator instance
    ...
    err_msg_generic = (
        ...
        "https://custom-scikit-learn.org/stable/glossary.html#term-scoring"
    )
...
def make_scorer(
    ...
    **kwargs,
    ...
    It is accepted in all custom-scikit-learn estimators or functions allowing a `scoring`
    parameter.
...
def get_scorer_names():
    ...
    These names can be passed to :func:`~custom_sklearn.metrics.get_scorer` to
    ...
    Examples
    --------
    >>> from custom_sklearn.metrics import get_scorer_names
...
def check_scoring(estimator=None, scoring=None, *, allow_none=False):
    ...
    >>> from custom_sklearn.metrics import check_scoring
    ...
    if callable(scoring):
        ...
        if (
            ...
            and module.startswith("custom_sklearn.metrics.")
            and not module.startswith("custom_sklearn.metrics._scorer")
            and not module.startswith("custom_sklearn.metrics.tests.")
        ):
            raise ValueError(
