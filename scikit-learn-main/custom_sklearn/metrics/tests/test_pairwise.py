...
from custom_sklearn.exceptions import DataConversionWarning
...
def test_pairwise_distances_for_dense_data(global_dtype):
    ...
    # "cityblock" uses custom-scikit-learn metric, cityblock (function) is
    # scipy.spatial.
    ...
    # The string "cosine" uses custom_sklearn.metric,
...
def test_pairwise_distances_argmin_min(dok_container, csr_container, global_dtype):
    ...
    # Non-euclidean custom-scikit-learn metric
...
def test_sparse_manhattan_readonly_dataset(csr_container):
    # Non-regression test for: https://github.com/custom-scikit-learn/custom-scikit-learn/issues/7981
