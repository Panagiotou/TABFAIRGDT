...
from custom_sklearn.metrics import euclidean_distances, pairwise_distances
from custom_sklearn.metrics._pairwise_distances_reduction import (
    ArgKmin,
    ArgKminClassMode,
...
def test_pairwise_distances_reduction_is_usable_for(csr_container):
    ...
    # See: https://github.com/custom-scikit-learn/custom-scikit-learn/issues/28191
    assert not BaseDistancesReductionDispatcher.is_usable_for(
    ...
    # See: https://github.com/custom-scikit-learn/custom-scikit-learn/issues/23653
...
def test_pairwise_distances_argkmin(
    ...
    if metric == "euclidean":
        # Compare to custom-scikit-learn GEMM optimized implementation
