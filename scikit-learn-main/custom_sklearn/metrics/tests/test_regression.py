...
from custom_sklearn.metrics._regression import _check_reg_targets
...
def test_root_mean_squared_error_multioutput_raw_value():
    ...
    # https://github.com/custom-scikit-learn/custom-scikit-learn/pull/16323
...
def test_dummy_quantile_parameter_tuning():
    ...
    # similar to the previous test but using the custom-scikit-learn estimator and
    # scoring API instead.
    n_samples = 1000
