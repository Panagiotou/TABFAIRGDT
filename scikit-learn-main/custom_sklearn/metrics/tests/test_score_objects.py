...
from custom_sklearn.linear_model import LogisticRegression, Perceptron, Ridge
...
from custom_sklearn.metrics import cluster as cluster_module
from custom_sklearn.metrics._scorer import (
...
from custom_sklearn.utils.metadata_routing import MetadataRouter, MethodMapping
...
def memmap_data_and_estimators(tmp_path_factory):
    temp_folder = tmp_path_factory.mktemp("custom_sklearn_test_score_objects")
...
def test_get_scorer_multilabel_indicator():
    ...
    https://github.com/custom-scikit-learn/custom-scikit-learn/issues/26817
    """
...
def test_metadata_routing_multimetric_metadata_routing(enable_metadata_routing):
    ...
    Non-regression test for https://github.com/custom-scikit-learn/custom-scikit-learn/issues/28256
    """
