...
from custom_sklearn.metrics._base import _average_binary_score
...
from custom_sklearn.utils.fixes import COO_CONTAINERS
from custom_sklearn.utils.multiclass import type_of_target
from custom_sklearn.utils.validation import _num_samples, check_random_state
...
def precision_recall_curve_padded_thresholds(*args, **kwargs):
    ...
    func:`custom_sklearn.metrics.precision_recall_curve`
...
@pytest.mark.parametrize(
    ...
    # https://github.com/custom-scikit-learn/custom-scikit-learn/issues/6809
    [
        ([np.nan, 1, 2], [1, 2, 3]),
        ([np.inf, 1, 2], [1, 2, 3]),
    ],  # type: ignore
