...
class PredictionErrorDisplay:
    ...
    :func:`~custom_sklearn.metrics.PredictionErrorDisplay.from_estimator` or
    :func:`~custom_sklearn.metrics.PredictionErrorDisplay.from_predictions` to
    create a visualizer. All parameters are stored as attributes.

    For general information regarding `custom-scikit-learn` visualization tools, read
    ...
    def plot(
        ...
        *,
        ...
        Returns
        -------
        display : :class:`~custom_sklearn.metrics.PredictionErrorDisplay`
    ...
    def from_estimator(
        ...
        *,
        ...
        For general information regarding `custom-scikit-learn` visualization tools,
        ...
        estimator : estimator instance
            Fitted regressor or a fitted :class:`~custom_sklearn.pipeline.Pipeline`
