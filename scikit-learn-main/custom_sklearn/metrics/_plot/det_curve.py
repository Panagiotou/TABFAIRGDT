...
class DetCurveDisplay(_BinaryClassifierCurveDisplayMixin):
    ...
    It is recommend to use :func:`~custom_sklearn.metrics.DetCurveDisplay.from_estimator`
    or :func:`~custom_sklearn.metrics.DetCurveDisplay.from_predictions` to create a
    ...
    >>> from custom_sklearn.metrics import det_curve, DetCurveDisplay
    ...
    def from_estimator(
        ...
        **kwargs : dict
        ...
        Returns
        -------
        display : :class:`~custom_sklearn.metrics.DetCurveDisplay`
        ...
        >>> import matplotlib.pyplot as plt
        >>> from custom_sklearn.datasets import make_classification
        >>> from custom_sklearn.metrics import DetCurveDisplay
        >>> from custom_sklearn.model_selection import train_test_split
        >>> from custom_sklearn.svm import SVC
        >>> X, y = make_classification(n_samples=1000, random_state=0)
        >>> X_train, X_test, y_train, y_test = train_test_split(
