...
class ConfusionMatrixDisplay:
    ...
    :func:`~custom_sklearn.metrics.ConfusionMatrixDisplay.from_estimator` or
    :func:`~custom_sklearn.metrics.ConfusionMatrixDisplay.from_predictions` to
    ...
    >>> from custom_sklearn.metrics import confusion_matrix, ConfusionMatrixDisplay
    ...
    def plot(
        ...
        *,
        ...
        Returns
        -------
        display : :class:`~custom_sklearn.metrics.ConfusionMatrixDisplay`
            Returns a :class:`~custom_sklearn.metrics.ConfusionMatrixDisplay` instance
