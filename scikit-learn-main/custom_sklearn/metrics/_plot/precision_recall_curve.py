...
class PrecisionRecallDisplay(_BinaryClassifierCurveDisplayMixin):
    ...
    :func:`~custom_sklearn.metrics.PrecisionRecallDisplay.from_estimator` or
    :func:`~custom_sklearn.metrics.PrecisionRecallDisplay.from_predictions` to create
    a :class:`~custom_sklearn.metrics.PrecisionRecallDisplay`. All parameters are
    ...
    Notes
    -----
    The average precision (cf. :func:`~custom_sklearn.metrics.average_precision_score`) in
    custom-scikit-learn is computed without any interpolation. To be consistent with
    ...
    def plot(
        ...
        **kwargs : dict
        ...
        Returns
        -------
        display : :class:`~custom_sklearn.metrics.PrecisionRecallDisplay`
            Object that stores computed values.

        Notes
        -----
        The average precision (cf. :func:`~custom_sklearn.metrics.average_precision_score`)
        in custom-scikit-learn is computed without any interpolation. To be consistent
