...
class BaseDistancesReductionDispatcher:
    ...
    def is_usable_for(cls, X, Y, metric) -> bool:
        ...
        metric : str, default='euclidean'
            ...
            :class:`~custom_sklearn.metrics.DistanceMetric`.
...
class ArgKmin(BaseDistancesReductionDispatcher):
    ...
    def compute(
        ...
        chunk_size : int, default=None,
            ...
            custom-scikit-learn configuration for `pairwise_dist_chunk_size`,
        ...
        strategy : str, {'auto', 'parallel_on_X', 'parallel_on_Y'}, default=None
            ...
            in parallel with the Cython `prange` construct:
              ...
              - None (default) looks-up in custom-scikit-learn configuration for
...
class ArgKminClassMode(BaseDistancesReductionDispatcher):
    ...
    def compute(
        ...
        metric : str, default='euclidean'
            ...
            the documentation of :class:`~custom_sklearn.metrics.DistanceMetric`.
