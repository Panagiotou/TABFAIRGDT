...
def euclidean_distances(
    ...
    Examples
    --------
    >>> from custom_sklearn.metrics.pairwise import euclidean_distances
    >>> X = [[0, 1], [1, 1]]
...
def nan_euclidean_distances(
    ...
    * John K. Dixon, "Pattern Recognition with Partly Missing Data",
    ...
    Examples
    --------
    >>> from custom_sklearn.metrics.pairwise import nan_euclidean_distances
    >>> nan = float("NaN")
    >>> X = [[0, 1], [1, nan]]
...
def pairwise_distances_argmin_min(
    ...
    metric : str or callable, default='euclidean'
        Metric to use for distance computation. Any metric from custom-scikit-learn
        ...
        - from custom-scikit-learn: ['cityblock', 'cosine', 'euclidean', 'l1', 'l2',
          'manhattan']
    ...
    Examples
    --------
    >>> from custom_sklearn.metrics.pairwise import pairwise_distances_argmin_min
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
...
def pairwise_distances_argmin(X, Y, *, axis=1, metric="euclidean", metric_kwargs=None):
    ...
    Examples
    --------
    >>> from custom_sklearn.metrics.pairwise import pairwise_distances_argmin
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
...
def haversine_distances(X, Y=None):
    ...
    >>> from custom_sklearn.metrics.pairwise import haversine_distances
...
def manhattan_distances(X, Y=None):
    ...
    Examples
    --------
    >>> from custom_sklearn.metrics.pairwise import manhattan_distances
...
def cosine_distances(X, Y=None):
    ...
    Examples
    --------
    >>> from custom_sklearn.metrics.pairwise import cosine_distances
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
...
def paired_euclidean_distances(X, Y):
    ...
    Examples
    --------
    >>> from custom_sklearn.metrics.pairwise import paired_euclidean_distances
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
...
def paired_manhattan_distances(X, Y):
    ...
    Examples
    --------
    >>> from custom_sklearn.metrics.pairwise import paired_manhattan_distances
    >>> import numpy as np
...
def paired_cosine_distances(X, Y):
    ...
    Examples
    --------
    >>> from custom_sklearn.metrics.pairwise import paired_cosine_distances
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
...
def paired_distances(X, Y, *, metric="euclidean", **kwds):
    ...
    **kwds : dict
    ...
    See Also
    --------
    custom_sklearn.metrics.pairwise_distances : Computes the distance between every pair of
        samples.

    Examples
    --------
    >>> from custom_sklearn.metrics.pairwise import paired_distances
    >>> X = [[0, 1], [1, 1]]
    >>> Y = [[0, 1], [2, 1]]
...
def linear_kernel(X, Y=None, dense_output=True):
    ...
    Examples
    --------
    >>> from custom_sklearn.metrics.pairwise import linear_kernel
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
    >>> linear_kernel(X, Y)
    array([[0., 0.],
...
def polynomial_kernel(X, Y=None, degree=3, gamma=None, coef0=1):
    ...
    Examples
    --------
    >>> from custom_sklearn.metrics.pairwise import polynomial_kernel
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
...
def sigmoid_kernel(X, Y=None, gamma=None, coef0=1):
    ...
    Examples
    --------
    >>> from custom_sklearn.metrics.pairwise import sigmoid_kernel
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
    >>> sigmoid_kernel(X, Y)
    array([[0.76..., 0.76...],
...
def rbf_kernel(X, Y=None, gamma=None):
    ...
    Examples
    --------
    >>> from custom_sklearn.metrics.pairwise import rbf_kernel
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
    >>> rbf_kernel(X, Y)
    array([[0.71..., 0.51...],
...
def laplacian_kernel(X, Y=None, gamma=None):
    ...
    Examples
    --------
    >>> from custom_sklearn.metrics.pairwise import laplacian_kernel
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
...
def cosine_similarity(X, Y=None, dense_output=True):
    ...
    Examples
    --------
    >>> from custom_sklearn.metrics.pairwise import cosine_similarity
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
...
def additive_chi2_kernel(X, Y=None):
    ...
    chi2_kernel : The exponentiated version of the kernel, which is usually
        preferable.
    custom_sklearn.kernel_approximation.AdditiveChi2Sampler : A Fourier approximation
        to this kernel.
    ...
    * Zhang, J. and Marszalek, M. and Lazebnik, S. and Schmid, C.
    ...
    Examples
    --------
    >>> from custom_sklearn.metrics.pairwise import additive_chi2_kernel
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
...
def chi2_kernel(X, Y=None, gamma=1.0):
    ...
    * Zhang, J. and Marszalek, M. and Lazebnik, S. and Schmid, C.
    ...
    Examples
    --------
    >>> from custom_sklearn.metrics.pairwise import chi2_kernel
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
    >>> chi2_kernel(X, Y)
    array([[0.36..., 0.13...],
...
def pairwise_distances_chunked(
    ...
    **kwds,
    ...
    working_memory : float, default=None
        ...
        ``custom_sklearn.get_config()['working_memory']`` is used.
    ...
    **kwds : optional keyword parameters
    ...
    >>> import numpy as np
    >>> from custom_sklearn.metrics import pairwise_distances_chunked
...
def pairwise_distances(
    ...
    **kwds,
    ...
    valid scipy.spatial.distance metrics), the custom-scikit-learn implementation
    will be used, which is faster and has support for sparse matrices (except
    for 'cityblock'). For a verbose description of the metrics from
    custom-scikit-learn, see :func:`custom_sklearn.metrics.pairwise.distance_metrics`
    function.
    ...
    **kwds : optional keyword parameters
    ...
    custom_sklearn.metrics.pairwise.paired_distances : Computes the distances between
        corresponding elements of two arrays.

    Examples
    --------
    >>> from custom_sklearn.metrics.pairwise import pairwise_distances
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
...
def kernel_metrics():
    ...
    The valid distance metrics, and the function they map to, are:
      ...
      metric            Function
      ===============   ========================================
      'additive_chi2'   custom_sklearn.pairwise.additive_chi2_kernel
      'chi2'            custom_sklearn.pairwise.chi2_kernel
      'linear'          custom_sklearn.pairwise.linear_kernel
      'poly'            custom_sklearn.pairwise.polynomial_kernel
      'polynomial'      custom_sklearn.pairwise.polynomial_kernel
      'rbf'             custom_sklearn.pairwise.rbf_kernel
      'laplacian'       custom_sklearn.pairwise.laplacian_kernel
      'sigmoid'         custom_sklearn.pairwise.sigmoid_kernel
      'cosine'          custom_sklearn.pairwise.cosine_similarity
      ===============   ========================================
...
def pairwise_kernels(
    ...
    metric : str or callable, default="linear"
        ...
        :mod:`custom_sklearn.metrics.pairwise` are not allowed, as they operate on
    ...
    **kwds : optional keyword parameters
    ...
    Examples
    --------
    >>> from custom_sklearn.metrics.pairwise import pairwise_kernels
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
