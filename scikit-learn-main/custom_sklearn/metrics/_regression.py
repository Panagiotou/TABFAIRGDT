    ...
    *,
    ...
    squared : bool, default=True
        ...
        .. deprecated:: 1.4
           ...
           Use :func:`~custom_sklearn.metrics.root_mean_squared_error`
...
def root_mean_squared_error(
    ...
    Examples
    --------
    >>> from custom_sklearn.metrics import root_mean_squared_error
    >>> y_true = [3, -0.5, 2, 7]
    >>> y_pred = [2.5, 0.0, 2, 8]
...
def mean_squared_log_error(
    ...
    *,
    ...
    squared : bool, default=True
        ...
        .. deprecated:: 1.4
           `squared` is deprecated in 1.4 and will be removed in 1.6.
           Use :func:`~custom_sklearn.metrics.root_mean_squared_log_error`
...
def root_mean_squared_log_error(
    ...
    Examples
    --------
    >>> from custom_sklearn.metrics import root_mean_squared_log_error
    >>> y_true = [3, 5, 2.5, 7]
    >>> y_pred = [2.5, 5, 4, 8]
...
def mean_poisson_deviance(y_true, y_pred, *, sample_weight=None):
    ...
    Examples
    --------
    >>> from custom_sklearn.metrics import mean_poisson_deviance
    >>> y_true = [2, 0, 1, 4]
    >>> y_pred = [0.5, 0.5, 2., 2.]
...
def mean_gamma_deviance(y_true, y_pred, *, sample_weight=None):
    ...
    Examples
    --------
    >>> from custom_sklearn.metrics import mean_gamma_deviance
    >>> y_true = [2, 0.5, 1, 4]
    >>> y_pred = [0.5, 0.5, 2., 2.]
...
def d2_tweedie_score(y_true, y_pred, *, sample_weight=None, power=0):
    ...
    Examples
    --------
    >>> from custom_sklearn.metrics import d2_tweedie_score
    >>> y_true = [0.5, 1, 2.5, 7]
    >>> y_pred = [1, 1, 5, 3.5]
...
def d2_pinball_score(
    ...
    Examples
    --------
    >>> from custom_sklearn.metrics import d2_pinball_score
    >>> y_true = [1, 2, 3]
    >>> y_pred = [1, 3, 3]
