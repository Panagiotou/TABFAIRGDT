...
def silhouette_score(
    ...
    metric : str or callable, default='euclidean'
        ...
        allowed by :func:`~custom_sklearn.metrics.pairwise_distances`. If ``X`` is
    ...
    **kwds : optional keyword parameters
    ...
    >>> from custom_sklearn.metrics import silhouette_score
...
def silhouette_samples(X, labels, *, metric="euclidean", **kwds):
    ...
    metric : str or callable, default='euclidean'
        The metric to use when calculating distance between instances in a
        feature array. If metric is a string, it must be one of the options
        allowed by :func:`~custom_sklearn.metrics.pairwise_distances`.
    ...
    **kwds : optional keyword parameters
    ...
    Examples
    --------
    >>> from custom_sklearn.metrics import silhouette_samples
    >>> from custom_sklearn.datasets import make_blobs
    >>> from custom_sklearn.cluster import KMeans
...
def calinski_harabasz_score(X, labels):
    ...
    >>> from custom_sklearn.datasets import make_blobs
    >>> from custom_sklearn.cluster import KMeans
    >>> from custom_sklearn.metrics import calinski_harabasz_score
