...
def contingency_matrix(
    ...
    contingency : {array-like, sparse}, shape=[n_classes_true, n_classes_pred]
        ...
        will be float.
        Will be a ``custom_sklearn.sparse.csr_matrix`` if ``sparse=True``.
...
def pair_confusion_matrix(labels_true, labels_pred):
    ...
    See Also
    --------
    custom_sklearn.metrics.rand_score : Rand Score.
    custom_sklearn.metrics.adjusted_rand_score : Adjusted Rand Score.
    custom_sklearn.metrics.adjusted_mutual_info_score : Adjusted Mutual Information.
...
def rand_score(labels_true, labels_pred):
    ...
    Perfectly matching labelings have a score of 1 even
      ...
      >>> from custom_sklearn.metrics.cluster import rand_score
...
def adjusted_rand_score(labels_true, labels_pred):
    ...
    Perfectly matching labelings have a score of 1 even
      ...
      >>> from custom_sklearn.metrics.cluster import adjusted_rand_score
...
def homogeneity_completeness_v_measure(labels_true, labels_pred, *, beta=1.0):
    ...
    Examples
    --------
    >>> from custom_sklearn.metrics import homogeneity_completeness_v_measure
...
def homogeneity_score(labels_true, labels_pred):
    ...
    Perfect labelings are homogeneous::
      ...
      >>> from custom_sklearn.metrics.cluster import homogeneity_score
...
def completeness_score(labels_true, labels_pred):
    ...
    Perfect labelings are complete::
      ...
      >>> from custom_sklearn.metrics.cluster import completeness_score
...
def v_measure_score(labels_true, labels_pred, *, beta=1.0):
    ...
    Perfect labelings are both homogeneous and complete, hence have score 1.0::
      ...
      >>> from custom_sklearn.metrics.cluster import v_measure_score
...
def mutual_info_score(labels_true, labels_pred, *, contingency=None):
    ...
    contingency : {array-like, sparse matrix} of shape \
        ...
        :func:`~custom_sklearn.metrics.cluster.contingency_matrix` function. If value
    ...
    Examples
    --------
    >>> from custom_sklearn.metrics import mutual_info_score
...
def adjusted_mutual_info_score(
    ...
    score 1.0::
      ...
      >>> from custom_sklearn.metrics.cluster import adjusted_mutual_info_score
...
def normalized_mutual_info_score(
    ...
    score 1.0::
      ...
      >>> from custom_sklearn.metrics.cluster import normalized_mutual_info_score
...
def fowlkes_mallows_score(labels_true, labels_pred, *, sparse=False):
    ...
    **False Negative** (i.e. the number of pair of points that belongs in the
    ...
    score 1.0::
      ...
      >>> from custom_sklearn.metrics.cluster import fowlkes_mallows_score
