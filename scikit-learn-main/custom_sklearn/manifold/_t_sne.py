...
# mypy error: Module 'custom_sklearn.manifold' has no attribute '_utils'
...
def trustworthiness(X, X_embedded, *, n_neighbors=5, metric="euclidean"):
    ...
    metric : str or callable, default='euclidean'
        ...
        `custom_sklearn.pairwise.pairwise_distances` and metrics listed in
        `custom_sklearn.metrics.pairwise.PAIRWISE_DISTANCE_FUNCTIONS`. Note that the
        "cosine" metric uses :func:`~custom_sklearn.metrics.pairwise.cosine_distances`.
    ...
    >>> from custom_sklearn.manifold import trustworthiness
...
class TSNE(ClassNamePrefixFeaturesOutMixin, TransformerMixin, BaseEstimator):
    ...
    See Also
    --------
    custom_sklearn.decomposition.PCA : Principal component analysis that is a linear
        dimensionality reduction method.
    custom_sklearn.decomposition.KernelPCA : Non-linear dimensionality reduction using
        kernels and PCA.
    ...
    Notes
    -----
    For an example of using :class:`~custom_sklearn.manifold.TSNE` in combination with
    :class:`~custom_sklearn.neighbors.KNeighborsTransformer` see
