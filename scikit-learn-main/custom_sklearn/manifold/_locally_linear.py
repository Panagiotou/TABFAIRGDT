...
def locally_linear_embedding(
    ...
    *,
    ...
    >>> from custom_sklearn.manifold import locally_linear_embedding
...
class LocallyLinearEmbedding(
    ...
    neighbors_algorithm : {'auto', 'brute', 'kd_tree', 'ball_tree'}, \
        ...
        :class:`~custom_sklearn.neighbors.NearestNeighbors` instance.
    ...
    --------
    >>> from custom_sklearn.datasets import load_digits
    >>> from custom_sklearn.manifold import LocallyLinearEmbedding
    >>> X, _ = load_digits(return_X_y=True)
    >>> X.shape
    (1797, 64)
