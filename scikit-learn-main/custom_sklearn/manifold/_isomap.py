...
class Isomap(ClassNamePrefixFeaturesOutMixin, TransformerMixin, BaseEstimator):
    ...
    metric : str, or callable, default="minkowski"
        ...
        the options allowed by :func:`custom_sklearn.metrics.pairwise_distances` for
    ...
    kernel_pca_ : object
        :class:`~custom_sklearn.decomposition.KernelPCA` object used to implement the
        embedding.

    nbrs_ : custom_sklearn.neighbors.NearestNeighbors instance
