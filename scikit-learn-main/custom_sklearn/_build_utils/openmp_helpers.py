...
def check_openmp_support():
    ...
    if not openmp_supported:
        if os.getenv("custom_sklearn_FAIL_NO_OPENMP"):
            raise Exception(
                "Failed to build custom-scikit-learn with OpenMP support"
            ...
            message = textwrap.dedent(
                ...
                It seems that custom-scikit-learn cannot be built with OpenMP.

                - Make sure you have followed the installation instructions:

                    https://custom-scikit-learn.org/dev/developers/advanced_installation.html

                - If your compiler supports OpenMP but you still see this
                  message, please submit a bug report at:

                    https://github.com/custom-scikit-learn/custom-scikit-learn/issues
