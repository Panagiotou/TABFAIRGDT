...
DEFAULT_ROOT = "custom_sklearn"


def _check_cython_version():
    message = (
        "Please install Cython with a version >= {0} in order "
        "to build a custom-scikit-learn from source."
...
def cythonize_extensions(extension):
    ...
    # check simple compilation with OpenMP. If it fails custom-scikit-learn will be
    ...
    # The result of this check is cached as a private attribute on the custom_sklearn
    ...
    custom_sklearn._OPENMP_SUPPORTED = check_openmp_support()
    ...
    cython_enable_debug_directives = (
        os.environ.get("custom_sklearn_ENABLE_DEBUG_CYTHON_DIRECTIVES", "0") != "0"
    )
