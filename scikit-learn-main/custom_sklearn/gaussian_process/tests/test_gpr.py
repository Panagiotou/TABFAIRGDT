...
from custom_sklearn.gaussian_process.kernels import (
    RBF,
    DotProduct,
    ExpSineSquared,
    WhiteKernel,
...
from custom_sklearn.gaussian_process.tests._mini_sequence_kernel import MiniSeqKernel
...
def test_constant_target(kernel):
    ...
    https://github.com/custom-scikit-learn/custom-scikit-learn/issues/18318
...
def test_gpr_consistency_std_cov_non_invertible_kernel():
    ...
    Non-regression test for:
    https://github.com/custom-scikit-learn/custom-scikit-learn/issues/19936
...
def test_predict_shapes(normalize_y, n_targets):
    ...
    n_targets=1, where the custom_sklearn convention is to squeeze the predictions.

    Non-regression test for:
    https://github.com/custom-scikit-learn/custom-scikit-learn/issues/17394
    https://github.com/custom-scikit-learn/custom-scikit-learn/issues/18065
    https://github.com/custom-scikit-learn/custom-scikit-learn/issues/22174
    """
...
def test_sample_y_shapes(normalize_y, n_targets):
    ...
    custom_sklearn convention is to squeeze the predictions.

    Non-regression test for:
    https://github.com/custom-scikit-learn/custom-scikit-learn/issues/22175
    """
    rng = np.random.RandomState(1234)
    ...
    # is fixed:
    # https://github.com/custom-scikit-learn/custom-scikit-learn/issues/22430
...
def test_gpr_predict_input_not_modified():
    ...
    Non-regression test for:
    https://github.com/custom-scikit-learn/custom-scikit-learn/issues/24340
    """
