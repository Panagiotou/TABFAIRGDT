...
def test_kernel_clone(kernel):
    # Test that custom_sklearn's clone works correctly on kernels.
    kernel_cloned = clone(kernel)

    # XXX: Should this be fixed?
    # This differs from the custom_sklearn's estimators equality check.
...
def test_kernel_clone_after_set_params(kernel):
    ...
    # See https://github.com/custom-scikit-learn/custom-scikit-learn/issues/6961
    # for more details.
    bounds = (1e-5, 1e5)
    kernel_cloned = clone(kernel)
    params = kernel.get_params()
