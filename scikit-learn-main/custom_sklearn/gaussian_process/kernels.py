...
class Hyperparameter(
    ...
    Examples
    --------
    >>> from custom_sklearn.gaussian_process.kernels import ConstantKernel
    >>> from custom_sklearn.datasets import make_friedman2
    >>> from custom_sklearn.gaussian_process import GaussianProcessRegressor
    >>> from custom_sklearn.gaussian_process.kernels import Hyperparameter
...
class Kernel(metaclass=ABCMeta):
    ...
    Examples
    --------
    >>> from custom_sklearn.gaussian_process.kernels import Kernel, RBF
    >>> import numpy as np
    ...
    def get_params(self, deep=True):
        ...
        if len(varargs) != 0:
            raise RuntimeError(
                "custom-scikit-learn kernels should always "
...
class CompoundKernel(Kernel):
    ...
    Examples
    --------
    >>> from custom_sklearn.gaussian_process.kernels import WhiteKernel
    >>> from custom_sklearn.gaussian_process.kernels import RBF
    >>> from custom_sklearn.gaussian_process.kernels import CompoundKernel
...
class Sum(KernelOperator):
    ...
    >>> from custom_sklearn.datasets import make_friedman2
    >>> from custom_sklearn.gaussian_process import GaussianProcessRegressor
    >>> from custom_sklearn.gaussian_process.kernels import RBF, Sum, ConstantKernel
...
class Product(KernelOperator):
    ...
    >>> from custom_sklearn.datasets import make_friedman2
    >>> from custom_sklearn.gaussian_process import GaussianProcessRegressor
    >>> from custom_sklearn.gaussian_process.kernels import (RBF, Product,
    ...            ConstantKernel)
    >>> X, y = make_friedman2(n_samples=500, noise=0, random_state=0)
...
class Exponentiation(Kernel):
    ...
    >>> from custom_sklearn.datasets import make_friedman2
    >>> from custom_sklearn.gaussian_process import GaussianProcessRegressor
    >>> from custom_sklearn.gaussian_process.kernels import (RationalQuadratic,
    ...            Exponentiation)
    >>> X, y = make_friedman2(n_samples=500, noise=0, random_state=0)
...
class ConstantKernel(StationaryKernelMixin, GenericKernelMixin, Kernel):
    ...
    >>> from custom_sklearn.datasets import make_friedman2
    >>> from custom_sklearn.gaussian_process import GaussianProcessRegressor
    >>> from custom_sklearn.gaussian_process.kernels import RBF, ConstantKernel
    >>> X, y = make_friedman2(n_samples=500, noise=0, random_state=0)
    >>> kernel = RBF() + ConstantKernel(constant_value=2)
    >>> gpr = GaussianProcessRegressor(kernel=kernel, alpha=5,
    ...         random_state=0).fit(X, y)
...
class WhiteKernel(StationaryKernelMixin, GenericKernelMixin, Kernel):
    ...
    >>> from custom_sklearn.datasets import make_friedman2
    >>> from custom_sklearn.gaussian_process import GaussianProcessRegressor
    >>> from custom_sklearn.gaussian_process.kernels import DotProduct, WhiteKernel
    >>> X, y = make_friedman2(n_samples=500, noise=0, random_state=0)
...
class RBF(StationaryKernelMixin, NormalizedKernelMixin, Kernel):
    ...
    >>> from custom_sklearn.gaussian_process import GaussianProcessClassifier
    >>> from custom_sklearn.gaussian_process.kernels import RBF
...
class Matern(RBF):
    ...
    >>> from custom_sklearn.datasets import load_iris
    >>> from custom_sklearn.gaussian_process import GaussianProcessClassifier
    >>> from custom_sklearn.gaussian_process.kernels import Matern
    >>> X, y = load_iris(return_X_y=True)
...
class PairwiseKernel(Kernel):
    """Wrapper for kernels in custom_sklearn.metrics.pairwise.

    A thin wrapper around the functionality of the kernels in
    custom_sklearn.metrics.pairwise.
    ...
    >>> from custom_sklearn.datasets import load_iris
    >>> from custom_sklearn.gaussian_process import GaussianProcessClassifier
    >>> from custom_sklearn.gaussian_process.kernels import PairwiseKernel
    >>> X, y = load_iris(return_X_y=True)
