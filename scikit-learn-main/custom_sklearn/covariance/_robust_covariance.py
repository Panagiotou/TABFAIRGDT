...
# exported by custom_sklearn.covariance. Deprecate?
def c_step(
    X,
    n_support,
    ...
    cov_computation_method : callable, \
            default=:func:`custom_sklearn.covariance.empirical_covariance`
...
class MinCovDet(EmpiricalCovariance):
    ...
    --------
    >>> import numpy as np
    >>> from custom_sklearn.covariance import MinCovDet
