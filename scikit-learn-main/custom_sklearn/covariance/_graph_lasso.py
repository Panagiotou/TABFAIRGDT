...
def _graphical_lasso(
    ...
    *,
    ...
    try:
        ...
        # https://github.com/custom-scikit-learn/custom-scikit-learn/issues/4134
        d_gap = np.inf
...
def graphical_lasso(
    ...
    *,
    ...
    >>> from custom_sklearn.covariance import empirical_covariance, graphical_lasso
...
class GraphicalLasso(BaseGraphicalLasso):
    ...
    --------
    >>> import numpy as np
    >>> from custom_sklearn.covariance import GraphicalLasso
