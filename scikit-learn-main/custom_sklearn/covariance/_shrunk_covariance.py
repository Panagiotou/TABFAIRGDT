...
def shrunk_covariance(emp_cov, shrinkage=0.1):
    ...
    >>> from custom_sklearn.covariance import empirical_covariance, shrunk_covariance
...
class ShrunkCovariance(EmpiricalCovariance):
    ...
    --------
    >>> import numpy as np
    >>> from custom_sklearn.covariance import ShrunkCovariance
    >>> from custom_sklearn.datasets import make_gaussian_quantiles
...
def ledoit_wolf_shrinkage(X, assume_centered=False, block_size=1000):
    ...
    --------
    >>> import numpy as np
    >>> from custom_sklearn.covariance import ledoit_wolf_shrinkage
...
def ledoit_wolf(X, *, assume_centered=False, block_size=1000):
    ...
    --------
    >>> import numpy as np
    >>> from custom_sklearn.covariance import empirical_covariance, ledoit_wolf
    >>> real_cov = np.array([[.4, .2], [.2, .8]])
    >>> rng = np.random.RandomState(0)
    >>> X = rng.multivariate_normal(mean=[0, 0], cov=real_cov, size=50)
...
class LedoitWolf(EmpiricalCovariance):
    ...
    --------
    >>> import numpy as np
    >>> from custom_sklearn.covariance import LedoitWolf
...
def oas(X, *, assume_centered=False):
    ...
    --------
    >>> import numpy as np
    >>> from custom_sklearn.covariance import oas
    >>> rng = np.random.RandomState(0)
    >>> real_cov = [[.8, .3], [.3, .4]]
    >>> X = rng.multivariate_normal(mean=[0, 0], cov=real_cov, size=500)
