...
:class:`~custom_sklearn.ensemble.HistGradientBoostingRegressor` when they were still
:term:`experimental`, but these estimators are now stable and can be imported
normally from `custom_sklearn.ensemble`.
"""
...
warnings.warn(
    ...
    "stable and can be normally imported from custom_sklearn.ensemble."
)
