...
class PolynomialCountSketch(
    ...
    custom_sklearn.metrics.pairwise.kernel_metrics : List of built-in kernels.
...
class RBFSampler(ClassNamePrefixFeaturesOutMixin, TransformerMixin, BaseEstimator):
    ...
    Examples
    --------
    >>> from custom_sklearn.kernel_approximation import RBFSampler
    >>> from custom_sklearn.linear_model import SGDClassifier
    >>> X = [[0, 0], [1, 1], [1, 0], [0, 1]]
    >>> y = [0, 0, 1, 1]
...
class SkewedChi2Sampler(
    ...
    RBFSampler : Approximate a RBF kernel feature map using random Fourier
        features.
    SkewedChi2Sampler : Approximate feature map for "skewed chi-squared" kernel.
    custom_sklearn.metrics.pairwise.chi2_kernel : The exact chi squared kernel.
    custom_sklearn.metrics.pairwise.kernel_metrics : List of built-in kernels.
    ...
    Examples
    --------
    >>> from custom_sklearn.kernel_approximation import SkewedChi2Sampler
    >>> from custom_sklearn.linear_model import SGDClassifier
    >>> X = [[0, 0], [1, 1], [1, 0], [0, 1]]
    >>> y = [0, 0, 1, 1]
...
class AdditiveChi2Sampler(TransformerMixin, BaseEstimator):
    ...
    custom_sklearn.metrics.pairwise.additive_chi2_kernel : The exact additive chi
        squared kernel.
    ...
    >>> from custom_sklearn.linear_model import SGDClassifier
    >>> from custom_sklearn.kernel_approximation import AdditiveChi2Sampler
...
class Nystroem(ClassNamePrefixFeaturesOutMixin, TransformerMixin, BaseEstimator):
    ...
    gamma : float, default=None
        ...
        the kernel; see the documentation for custom_sklearn.metrics.pairwise.
