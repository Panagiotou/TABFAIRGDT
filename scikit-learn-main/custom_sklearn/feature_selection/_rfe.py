...
class RFE(_RoutingNotSupportedMixin, SelectorMixin, MetaEstimatorMixin, BaseEstimator):
    ...
    importance_getter : str or callable, default='auto'
        ...
        :class:`~custom_sklearn.compose.TransformedTargetRegressor`  or
        `named_steps.clf.feature_importances_` in case of
        class:`~custom_sklearn.pipeline.Pipeline` with its last step named `clf`.
    ...
    >>> from custom_sklearn.feature_selection import RFE
...
class RFECV(RFE):
    ...
    cv : int, cross-validation generator or an iterable, default=None
        ...
        :class:`~custom_sklearn.model_selection.StratifiedKFold` is used. If the
    ...
    >>> from custom_sklearn.datasets import make_friedman1
    >>> from custom_sklearn.feature_selection import RFECV
    >>> from custom_sklearn.svm import SVR
    >>> X, y = make_friedman1(n_samples=50, n_features=10, random_state=0)
    >>> estimator = SVR(kernel="linear")
    ...
    def fit(self, X, y, groups=None):
        ...
        groups : array-like of shape (n_samples,) or None, default=None
            ...
            instance (e.g., :class:`~custom_sklearn.model_selection.GroupKFold`).
