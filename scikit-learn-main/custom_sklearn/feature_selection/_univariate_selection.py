...
def chi2(X, y):
    ...
    --------
    >>> import numpy as np
    >>> from custom_sklearn.feature_selection import chi2
    >>> X = np.array([[1, 1, 3],
    ...               [0, 1, 5],
    ...               [5, 4, 1],
    ...               [6, 6, 2],
...
def r_regression(X, y, *, center=True, force_finite=True):
    ...
    >>> from custom_sklearn.feature_selection import r_regression
    >>> X, y = make_regression(
...
def f_regression(X, y, *, center=True, force_finite=True):
    ...
    --------
    >>> from custom_sklearn.datasets import make_regression
    >>> from custom_sklearn.feature_selection import f_regression
    >>> X, y = make_regression(
    ...     n_samples=50, n_features=3, n_informative=1, noise=1e-4, random_state=42
    ... )
...
class SelectPercentile(_BaseFilter):
    ...
    >>> from custom_sklearn.feature_selection import SelectPercentile, chi2
...
class SelectKBest(_BaseFilter):
    ...
    --------
    >>> from custom_sklearn.datasets import load_digits
    >>> from custom_sklearn.feature_selection import SelectKBest, chi2
    >>> X, y = load_digits(return_X_y=True)
    >>> X.shape
    (1797, 64)
...
class SelectFpr(_BaseFilter):
    ...
    >>> from custom_sklearn.feature_selection import SelectFpr, chi2
...
class SelectFdr(_BaseFilter):
    ...
    --------
    >>> from custom_sklearn.datasets import load_breast_cancer
    >>> from custom_sklearn.feature_selection import SelectFdr, chi2
    >>> X, y = load_breast_cancer(return_X_y=True)
    >>> X.shape
    (569, 30)
...
class SelectFwe(_BaseFilter):
    ...
    --------
    >>> from custom_sklearn.datasets import load_breast_cancer
    >>> from custom_sklearn.feature_selection import SelectFwe, chi2
    >>> X, y = load_breast_cancer(return_X_y=True)
    >>> X.shape
    (569, 30)
...
class GenericUnivariateSelect(_BaseFilter):
    ...
    --------
    >>> from custom_sklearn.datasets import load_breast_cancer
    >>> from custom_sklearn.feature_selection import GenericUnivariateSelect, chi2
    >>> X, y = load_breast_cancer(return_X_y=True)
    >>> X.shape
    (569, 30)
