...
from custom_sklearn.feature_selection import mutual_info_classif, mutual_info_regression
from custom_sklearn.feature_selection._mutual_info import _compute_mi
...
def test_mutual_information_symmetry_classif_regression(correlated, global_random_seed):
    ...
    https://github.com/custom-scikit-learn/custom-scikit-learn/issues/23720
    """
