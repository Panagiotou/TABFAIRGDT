...
from custom_sklearn.cross_decomposition import CCA, PLSCanonical, PLSRegression
from custom_sklearn.datasets import load_iris, make_classification, make_friedman1
from custom_sklearn.ensemble import RandomForestClassifier
from custom_sklearn.feature_selection import RFE, RFECV
from custom_sklearn.impute import SimpleImputer
from custom_sklearn.linear_model import LinearRegression, LogisticRegression
from custom_sklearn.metrics import get_scorer, make_scorer, zero_one_loss
from custom_sklearn.model_selection import GroupKFold, cross_val_score
from custom_sklearn.pipeline import make_pipeline
from custom_sklearn.preprocessing import StandardScaler
from custom_sklearn.svm import SVC, SVR, LinearSVR
from custom_sklearn.utils import check_random_state
from custom_sklearn.utils._testing import ignore_warnings
...
def test_rfe_wrapped_estimator(importance_getter, selector, expected_n_features):
    ...
    # https://github.com/custom-scikit-learn/custom-scikit-learn/issues/15312
...
def test_rfe_pls(ClsRFE, PLSEstimator):
    ...
    Non-regression test for:
    https://github.com/custom-scikit-learn/custom-scikit-learn/issues/12410
    """
    X, y = make_friedman1(n_samples=50, n_features=10, random_state=0)
