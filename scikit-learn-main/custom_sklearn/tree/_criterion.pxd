...
cdef class Criterion:
    ...
    cdef SIZE_t n_outputs_y                # Number of outputs
    cdef SIZE_t n_outputs_sens                # Number of outputs for sens
...
cdef class ClassificationCriterion(Criterion):
    ...
    cdef SIZE_t n_classes_0
    cdef SIZE_t n_sens_0
    ...
    cdef double[:, ::1] sum_total_sens_y   # The sum of the weighted count of each SENS.
    cdef double[:, ::1] sum_left_sens_y    # Same as above, but for the left side of the split
    cdef double[:, ::1] sum_right_sens_y   # Same as above, but for the right side of the split
