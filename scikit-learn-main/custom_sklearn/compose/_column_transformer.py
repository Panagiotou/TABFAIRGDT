"""
The :mod:`custom_sklearn.compose._column_transformer` module implements utilities
...
class ColumnTransformer(TransformerMixin, _BaseComposition):
    ...
    transformers_ : list
        ...
        :class:`~custom_sklearn.preprocessing.FunctionTransformer`. In case there were
    ...
    named_transformers_ : :class:`~custom_sklearn.utils.Bunch`
            ...
            for col_name, dtype in Xs.dtypes.to_dict().items():
                ...
                warnings.warn(
                    (
                        ...
                        " can cause errors in downstream custom-scikit-learn estimators, and"
                        " inefficiencies. Starting with custom-scikit-learn version 1.6, this"
    ...
    def fit(self, X, y=None, **params):
        ...
        **params : dict, default=None
            ...
            can enable using ``custom_sklearn.set_config(enable_metadata_routing=True)``.
