...
from custom_sklearn.compose import (
    ColumnTransformer,
    make_column_selector,
    make_column_transformer,
)
from custom_sklearn.compose._column_transformer import _RemainderColsList
...
from custom_sklearn.utils.fixes import CSR_CONTAINERS, parse_version
...
def test_column_transformer_mixed_cols_sparse():
    ...
    # See: https://github.com/custom-scikit-learn/custom-scikit-learn/issues/11912
...
def test_column_transformer_remainder_passthrough_naming_consistency(transform_output):
    ...
    https://github.com/custom-scikit-learn/custom-scikit-learn/issues/28232
    """
    pd = pytest.importorskip("pandas")
...
def test_column_transformer_column_renaming(dataframe_lib):
    ...
    Non-regression test for:
    https://github.com/custom-scikit-learn/custom-scikit-learn/issues/28260
    """
...
def test_get_metadata_routing_works_without_fit():
    # Regression test for https://github.com/custom-scikit-learn/custom-scikit-learn/issues/28186
