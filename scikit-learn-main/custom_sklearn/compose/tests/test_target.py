...
def test_transform_target_regressor_1d_transformer(X, y):
    # All transformer in custom-scikit-learn expect 2D data. FunctionTransformer with
...
def test_transform_target_regressor_3d_target():
    ...
    # https://github.com/custom-scikit-learn/custom-scikit-learn/issues/18866
