...
class TransformedTargetRegressor(
    ...
    such as the :class:`~custom_sklearn.preprocessing.QuantileTransformer` or as a
    ...
    regressor : object, default=None
        ...
        :class:`~custom_sklearn.base.RegressorMixin`. This regressor will
        automatically be cloned each time prior to fitting. If `regressor is
        None`, :class:`~custom_sklearn.linear_model.LinearRegression` is created and used.

    transformer : object, default=None
        Estimator object such as derived from
        :class:`~custom_sklearn.base.TransformerMixin`. Cannot be set at the same time
    ...
    See Also
    --------
    custom_sklearn.preprocessing.FunctionTransformer : Construct a transformer from an
        arbitrary callable.

    Notes
    -----
    Internally, the target `y` is always converted into a 2-dimensional array
    to be used by custom-scikit-learn transformers. At the time of prediction, the
