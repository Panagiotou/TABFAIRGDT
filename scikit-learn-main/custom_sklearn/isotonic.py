...
def check_increasing(x, y):
    ...
    Examples
    --------
    >>> from custom_sklearn.isotonic import check_increasing
...
def isotonic_regression(
    ...
    Examples
    --------
    >>> from custom_sklearn.isotonic import isotonic_regression
...
class IsotonicRegression(RegressorMixin, TransformerMixin, BaseEstimator):
    ...
    See Also
    --------
    custom_sklearn.linear_model.LinearRegression : Ordinary least squares Linear
        Regression.
    custom_sklearn.ensemble.HistGradientBoostingRegressor : Gradient boosting that
