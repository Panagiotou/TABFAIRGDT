...
class StackingClassifier(ClassifierMixin, _BaseStacking):
    ...
    cv : int, cross-validation generator, iterable, or "prefit", default=None
        ...
        * `"prefit"` to assume the `estimators` are prefit. In this case, the
        ...
        :class:`~custom_sklearn.model_selection.StratifiedKFold` is used.
        In all other cases, :class:`~custom_sklearn.model_selection.KFold` is used.
    ...
    named_estimators_ : :class:`~custom_sklearn.utils.Bunch`
    ...
    def fit(self, X, y, *, sample_weight=None, **fit_params):
        ...
        **fit_params : dict
            ...
            .. versionadded:: 1.6
                ...
                set by using ``custom_sklearn.set_config(enable_metadata_routing=True)``.
...
class StackingRegressor(RegressorMixin, _BaseStacking):
    ...
    final_estimator : estimator, default=None
        ...
        The default regressor is a :class:`~custom_sklearn.linear_model.RidgeCV`.
