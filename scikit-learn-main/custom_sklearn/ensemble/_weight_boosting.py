...
- :class:`~custom_sklearn.ensemble.AdaBoostClassifier` implements adaptive boosting
  (AdaBoost-SAMME) for classification problems.

- :class:`~custom_sklearn.ensemble.AdaBoostRegressor` implements adaptive boosting
...
class AdaBoostClassifier(
    ...
    estimator : object, default=None
        ...
        the base estimator is :class:`~custom_sklearn.tree.DecisionTreeClassifier`
    ...
    custom_sklearn.tree.DecisionTreeClassifier : A non-parametric supervised learning
...
class AdaBoostRegressor(_RoutingNotSupportedMixin, RegressorMixin, BaseWeightBoosting):
    ...
    estimator : object, default=None
        ...
        :class:`~custom_sklearn.tree.DecisionTreeRegressor` initialized with
        `max_depth=3`.
    ...
    Examples
    --------
    >>> from custom_sklearn.ensemble import AdaBoostRegressor
