...
class BaseGradientBoosting(BaseEnsemble, metaclass=ABCMeta):
    ...
    def _get_loss(self, sample_weight):
        """Get loss object from custom_sklearn._loss.loss."""
...
class GradientBoostingClassifier(ClassifierMixin, BaseGradientBoosting):
    ...
    :class:`custom_sklearn.ensemble.HistGradientBoostingClassifier` is a much faster
...
class GradientBoostingRegressor(RegressorMixin, BaseGradientBoosting):
    ...
    :class:`custom_sklearn.ensemble.HistGradientBoostingRegressor` is a much faster
    variant of this algorithm for intermediate datasets (`n_samples >= 10_000`).
    ...
    custom_sklearn.ensemble.RandomForestRegressor : A random forest regressor.
