...
def _patch_raw_predict(estimator, raw_predictions):
    ...
    enforced for custom-scikit-learn estimators in general.
    ...
    default for most custom-scikit-learn models and would like to keep it that way.
...
class HistGradientBoostingRegressor(RegressorMixin, BaseHistGradientBoosting):
    ...
    :class:`GradientBoostingRegressor<custom_sklearn.ensemble.GradientBoostingRegressor>`
...
class HistGradientBoostingClassifier(ClassifierMixin, BaseHistGradientBoosting):
    ...
    This estimator is much faster than
    :class:`GradientBoostingClassifier<custom_sklearn.ensemble.GradientBoostingClassifier>`
    for big datasets (n_samples >= 10 000).
