...
from custom_sklearn._loss.loss import (
    AbsoluteError,
    HalfBinomialLoss,
    HalfSquaredError,
    PinballLoss,
)
from custom_sklearn.base import BaseEstimator, TransformerMixin, clone, is_regressor
from custom_sklearn.compose import make_column_transformer
from custom_sklearn.datasets import make_classification, make_low_rank_matrix, make_regression
from custom_sklearn.dummy import DummyRegressor
from custom_sklearn.ensemble import (
    HistGradientBoostingClassifier,
    HistGradientBoostingRegressor,
)
from custom_sklearn.ensemble._hist_gradient_boosting.binning import _BinMapper
from custom_sklearn.ensemble._hist_gradient_boosting.common import G_H_DTYPE
from custom_sklearn.ensemble._hist_gradient_boosting.grower import TreeGrower
from custom_sklearn.ensemble._hist_gradient_boosting.predictor import TreePredictor
from custom_sklearn.exceptions import NotFittedError
from custom_sklearn.metrics import get_scorer, mean_gamma_deviance, mean_poisson_deviance
from custom_sklearn.model_selection import cross_val_score, train_test_split
from custom_sklearn.pipeline import make_pipeline
from custom_sklearn.preprocessing import KBinsDiscretizer, MinMaxScaler, OneHotEncoder
from custom_sklearn.utils import shuffle
from custom_sklearn.utils._openmp_helpers import _openmp_effective_n_threads
from custom_sklearn.utils._testing import _convert_container
from custom_sklearn.utils.fixes import _IS_32BIT
...
def test_max_depth_max_leaf_nodes():
    ...
    # https://github.com/custom-scikit-learn/custom-scikit-learn/issues/16179
...
def test_early_stopping_with_sample_weights(monkeypatch):
    ...
    monkeypatch.setattr(
        custom_sklearn.ensemble._hist_gradient_boosting.gradient_boosting,
        "check_scoring",
        mock_check_scoring,
    )
...
def test_uint8_predict(Est):
    # Non regression test for
    # https://github.com/custom-scikit-learn/custom-scikit-learn/issues/18408
...
def get_different_bitness_node_ndarray(node_ndarray):
    ...
    # custom_sklearn/ensemble/_hist_gradient_boosting/common.pyx)
...
def test_pandas_nullable_dtype():
    # Non regression test for https://github.com/custom-scikit-learn/custom-scikit-learn/issues/28317
    pd = pytest.importorskip("pandas")
