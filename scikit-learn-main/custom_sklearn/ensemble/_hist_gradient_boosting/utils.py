...
def get_equivalent_estimator(estimator, lib="lightgbm", n_classes=None):
    ...
    This utility function takes care of renaming the custom_sklearn parameters into
    ...
    custom_sklearn_params = estimator.get_params()

    if custom_sklearn_params["loss"] == "auto":
        raise ValueError(
            "auto loss is not accepted. We need to know if "
            "the problem is binary or multiclass classification."
        )
    if custom_sklearn_params["early_stopping"]:
    ...
    lightgbm_params = {
        "objective": lightgbm_loss_mapping[custom_sklearn_params["loss"]],
        "learning_rate": custom_sklearn_params["learning_rate"],
        "n_estimators": custom_sklearn_params["max_iter"],
        "num_leaves": custom_sklearn_params["max_leaf_nodes"],
        "max_depth": custom_sklearn_params["max_depth"],
        "min_data_in_leaf": custom_sklearn_params["min_samples_leaf"],
        "reg_lambda": custom_sklearn_params["l2_regularization"],
        "max_bin": custom_sklearn_params["max_bins"],
        "min_data_in_bin": 1,
        "min_sum_hessian_in_leaf": 1e-3,
        "min_split_gain": 0,
        "verbosity": 10 if custom_sklearn_params["verbose"] else -10,
        ...
        "feature_fraction_bynode": custom_sklearn_params["max_features"],
    }

    if custom_sklearn_params["loss"] == "log_loss" and n_classes > 2:
    ...
    xgboost_params = {
        ...
        "objective": xgboost_loss_mapping[custom_sklearn_params["loss"]],
        "learning_rate": custom_sklearn_params["learning_rate"],
        "n_estimators": custom_sklearn_params["max_iter"],
        "max_leaves": custom_sklearn_params["max_leaf_nodes"],
        "max_depth": custom_sklearn_params["max_depth"] or 0,
        "lambda": custom_sklearn_params["l2_regularization"],
        "max_bin": custom_sklearn_params["max_bins"],
        "min_child_weight": 1e-3,
        "verbosity": 2 if custom_sklearn_params["verbose"] else 0,
        "silent": custom_sklearn_params["verbose"] == 0,
        "n_jobs": -1,
        "colsample_bynode": custom_sklearn_params["max_features"],
    }
    ...
    catboost_params = {
        "loss_function": catboost_loss_mapping[custom_sklearn_params["loss"]],
        "learning_rate": custom_sklearn_params["learning_rate"],
        "iterations": custom_sklearn_params["max_iter"],
        "depth": custom_sklearn_params["max_depth"],
        "reg_lambda": custom_sklearn_params["l2_regularization"],
        "max_bin": custom_sklearn_params["max_bins"],
        "feature_border_type": "Median",
        "leaf_estimation_method": "Newton",
        "verbose": bool(custom_sklearn_params["verbose"]),
    }
