...
class IsolationForest(OutlierMixin, BaseBagging):
    ...
    See Also
    --------
    custom_sklearn.covariance.EllipticEnvelope : An object for detecting outliers in a
        Gaussian distributed dataset.
    custom_sklearn.svm.OneClassSVM : Unsupervised Outlier Detection.
        Estimate the support of a high-dimensional distribution.
        The implementation is based on libsvm.
    custom_sklearn.neighbors.LocalOutlierFactor : Unsupervised Outlier Detection
    ...
    def _compute_chunked_score_samples(self, X):
        ...
        # (defined by custom_sklearn.get_config()['working_memory']) to store
