"""Testing for the boost module (custom_sklearn.ensemble.boost)."""
...
from custom_sklearn.ensemble import AdaBoostClassifier, AdaBoostRegressor
from custom_sklearn.ensemble._weight_boosting import _samme_proba
from custom_sklearn.linear_model import LinearRegression
from custom_sklearn.model_selection import GridSearchCV, train_test_split
...
def test_oneclass_adaboost_proba():
    ...
    # https://github.com/custom-scikit-learn/custom-scikit-learn/issues/7501
    y_t = np.ones(len(X))
...
def test_adaboost_consistent_predict(algorithm):
    ...
    # regression test for:
    # https://github.com/custom-scikit-learn/custom-scikit-learn/issues/14084
...
def test_adaboost_numerically_stable_feature_importance_with_small_weights():
    ...
    https://github.com/custom-scikit-learn/custom-scikit-learn/issues/20320
    """
    rng = np.random.RandomState(42)
...
def test_adaboost_decision_function(algorithm, global_random_seed):
    ...
    Non-regression test for:
    https://github.com/custom-scikit-learn/custom-scikit-learn/issues/26520
    """
    n_classes = 3
    X, y = datasets.make_classification(
