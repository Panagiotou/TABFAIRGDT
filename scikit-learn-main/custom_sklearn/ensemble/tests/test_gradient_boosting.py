"""
Testing for the gradient boosting module (custom_sklearn.ensemble.gradient_boosting).
"""
...
from custom_sklearn.ensemble import GradientBoostingClassifier, GradientBoostingRegressor
from custom_sklearn.ensemble._gb import _safe_divide
from custom_sklearn.ensemble._gradient_boosting import predict_stages
from custom_sklearn.exceptions import DataConversionWarning, NotFittedError
...
from custom_sklearn.utils._mocking import NoSampleWeightWrapper
from custom_sklearn.utils._param_validation import InvalidParameterError
...
def test_complete_classification():
    ...
    from custom_sklearn.tree._tree import TREE_LEAF
...
def test_gradient_boosting_with_init(
    ...
    # Check that GradientBoostingRegressor works when init is a custom_sklearn
    # estimator.
...
def test_squared_error_exact_backward_compat():
    ...
    The results to compare against are taken from custom-scikit-learn v1.2.0.
    """
    n_samples = 10
