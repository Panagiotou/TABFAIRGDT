"""
Testing for the bagging ensemble module (custom_sklearn.ensemble.bagging).
"""
...
from custom_sklearn.datasets import load_diabetes, load_iris, make_hastie_10_2
from custom_sklearn.dummy import DummyClassifier, DummyRegressor
...
from custom_sklearn.linear_model import LogisticRegression, Perceptron
from custom_sklearn.model_selection import GridSearchCV, ParameterGrid, train_test_split
from custom_sklearn.neighbors import KNeighborsClassifier, KNeighborsRegressor
from custom_sklearn.pipeline import make_pipeline
from custom_sklearn.preprocessing import FunctionTransformer, scale
from custom_sklearn.random_projection import SparseRandomProjection
...
from custom_sklearn.utils._testing import assert_array_almost_equal, assert_array_equal
from custom_sklearn.utils.fixes import CSC_CONTAINERS, CSR_CONTAINERS
...
def test_set_oob_score_label_encoding():
    ...
    # See: https://github.com/custom-scikit-learn/custom-scikit-learn/issues/8933
    random_state = 5
    X = [[-1], [0], [1]] * 5
    Y1 = ["A", "B", "C"] * 5
    Y2 = [-1, 0, 1] * 5
...
def test_bagging_get_estimators_indices():
    ...
    # https://github.com/custom-scikit-learn/custom-scikit-learn/issues/16436
...
def test_bagging_with_metadata_routing(model):
    ...
    with custom_sklearn.config_context(enable_metadata_routing=True):
