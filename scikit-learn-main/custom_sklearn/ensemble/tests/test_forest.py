"""
Testing for the forest module (custom_sklearn.ensemble.forest).
"""
...
from custom_sklearn import clone, datasets
from custom_sklearn.datasets import make_classification, make_hastie_10_2
...
from custom_sklearn.ensemble._forest import (
...
from custom_sklearn.model_selection import GridSearchCV, cross_val_score, train_test_split
from custom_sklearn.svm import LinearSVC
from custom_sklearn.tree._classes import SPARSE_SPLITTERS
...
from custom_sklearn.utils.fixes import COO_CONTAINERS, CSC_CONTAINERS, CSR_CONTAINERS
from custom_sklearn.utils.multiclass import type_of_target
from custom_sklearn.utils.parallel import Parallel
...
def test_mse_criterion_object_segfault_smoke_test(Forest):
    ...
    # https://github.com/custom-scikit-learn/custom-scikit-learn/issues/12623
    from custom_sklearn.tree._criterion import MSE
...
def test_read_only_buffer(csr_container, monkeypatch):
    ...
    Non-regression test for: https://github.com/custom-scikit-learn/custom-scikit-learn/issues/25333
    """
    monkeypatch.setattr(
        custom_sklearn.ensemble._forest,
        "Parallel",
