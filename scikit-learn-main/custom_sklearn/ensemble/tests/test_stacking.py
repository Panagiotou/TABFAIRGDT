...
from custom_sklearn.base import BaseEstimator, ClassifierMixin, RegressorMixin, clone
...
from custom_sklearn.exceptions import ConvergenceWarning, NotFittedError
...
from custom_sklearn.model_selection import KFold, StratifiedKFold, train_test_split
...
from custom_sklearn.svm import SVC, LinearSVC, LinearSVR
...
@pytest.mark.filterwarnings("ignore::custom_sklearn.exceptions.ConvergenceWarning")
@pytest.mark.parametrize(
    "stacker, X, y",
    [
        (
...
def test_stacking_final_estimator_attribute_error():
    ...
    https://github.com/custom-scikit-learn/custom-scikit-learn/issues/28108
    """
