"""
Testing for Isolation Forest algorithm (custom_sklearn.ensemble.iforest).
"""
...
from custom_sklearn.datasets import load_diabetes, load_iris, make_classification
from custom_sklearn.ensemble import IsolationForest
from custom_sklearn.ensemble._iforest import _average_path_length
from custom_sklearn.metrics import roc_auc_score
from custom_sklearn.model_selection import ParameterGrid, train_test_split
...
# chunk has 3 rows):
@patch(
    "custom_sklearn.ensemble._iforest.get_chunk_n_rows",
...
def test_iforest_sparse_input_float_contamination(sparse_container):
    ...
    https://github.com/custom-scikit-learn/custom-scikit-learn/issues/27626
    """
