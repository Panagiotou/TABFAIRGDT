...
from custom_sklearn.datasets import fetch_lfw_pairs, fetch_lfw_people
from custom_sklearn.datasets.tests.test_common import check_return_X_y
...
def test_fetch_lfw_people_internal_cropping(mock_data_home):
    ...
    https://github.com/custom-scikit-learn/custom-scikit-learn/issues/24942
    """
