...
def make_circles(
    ...
    Examples
    --------
    >>> from custom_sklearn.datasets import make_circles
...
/ X[:, 0]) + noise * N(0, 1).
    ...
    Examples
    --------
    >>> from custom_sklearn.datasets import make_friedman3
...
def make_low_rank_matrix(
    ...
    *,
    ...
    >>> from custom_sklearn.datasets import make_low_rank_matrix
    >>> X = make_low_rank_matrix(
    ...     n_samples=50,
    ...     n_features=25,
    ...     effective_rank=5,
...
def make_sparse_uncorrelated(n_samples=100, n_features=10, *, random_state=None):
    ...
    Examples
    --------
    >>> from custom_sklearn.datasets import make_sparse_uncorrelated
...
def make_spd_matrix(n_dim, *, random_state=None):
    ...
    Examples
    --------
    >>> from custom_sklearn.datasets import make_spd_matrix
...
def make_sparse_spd_matrix(
    ...
    *,
    ...
    Examples
    --------
    >>> from custom_sklearn.datasets import make_sparse_spd_matrix
...
def make_swiss_roll(n_samples=100, *, noise=0.0, random_state=None, hole=False):
    ...
    Examples
    --------
    >>> from custom_sklearn.datasets import make_swiss_roll
...
def make_s_curve(n_samples=100, *, noise=0.0, random_state=None):
    ...
    Examples
    --------
    >>> from custom_sklearn.datasets import make_s_curve
...
def make_biclusters(
    ...
    *,
    ...
    Examples
    --------
    >>> from custom_sklearn.datasets import make_biclusters
...
def make_checkerboard(
    ...
    *,
    ...
    Examples
    --------
    >>> from custom_sklearn.datasets import make_checkerboard
