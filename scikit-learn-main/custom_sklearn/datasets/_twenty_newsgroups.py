...
(classification).
    ...
    data_home : str or path-like, default=None
        ...
        all custom-scikit-learn data is stored in '~/scikit_learn_data' subfolders.
    ...
    Returns
    -------
    bunch : :class:`~custom_sklearn.utils.Bunch`
...
def fetch_20newsgroups_vectorized(
    *,
    ...
    :class:`~custom_sklearn.feature_extraction.text.CountVectorizer`. For more
    advanced usage (stopword filtering, n-gram extraction, etc.), combine
    fetch_20newsgroups with a custom
    :class:`~custom_sklearn.feature_extraction.text.CountVectorizer`,
    :class:`~custom_sklearn.feature_extraction.text.HashingVectorizer`,
    :class:`~custom_sklearn.feature_extraction.text.TfidfTransformer` or
    :class:`~custom_sklearn.feature_extraction.text.TfidfVectorizer`.

    The resulting counts are normalized using
    :func:`custom_sklearn.preprocessing.normalize` unless normalize is set to False.
    ...
    normalize : bool, default=True
        ...
        :func:`custom_sklearn.preprocessing.normalize`.
    ...
    Examples
    --------
    >>> from custom_sklearn.datasets import fetch_20newsgroups_vectorized
    ...
    if os.path.exists(target_file):
        try:
            ...
            raise ValueError(
                ...
                "with an older custom-scikit-learn version and it is not compatible "
                "with the custom-scikit-learn version imported. You need to "
