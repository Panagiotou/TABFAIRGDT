...
DATA_MODULE = "custom_sklearn.datasets.data"
DESCR_MODULE = "custom_sklearn.datasets.descr"
IMAGES_MODULE = "custom_sklearn.datasets.images"
...
def get_data_home(data_home=None) -> str:
    """Return the path of the custom-scikit-learn data directory.
    ...
    data_home : str or path-like, default=None
        The path to custom-scikit-learn data directory. If `None`, the default path
        is `~/scikit_learn_data`.

    Returns
    -------
    data_home: str
        The path to custom-scikit-learn data directory.

    Examples
    --------
    >>> import os
    >>> from custom_sklearn.datasets import get_data_home
...
def clear_data_home(data_home=None):
    ...
    Examples
    --------
    >>> from custom_sklearn.datasets import clear_data_home
...
def load_files(
    ...
    *,
    ...
    To use text files in a custom-scikit-learn classification or clustering algorithm,
    you will need to use the :mod:`~custom_sklearn.feature_extraction.text` module to
    ...
    to use most functions in :mod:`~custom_sklearn.feature_extraction.text`.
    ...
    Returns
    -------
    data : :class:`~custom_sklearn.utils.Bunch`
    ...
    Examples
    --------
    >>> from custom_sklearn.datasets import load_files
    >>> container_path = "./"
...
def load_csv_data(
    ...
    *,
    ...
    data_module : str or module, default='custom_sklearn.datasets.data'
        Module where data lives. The default is `'custom_sklearn.datasets.data'`.
    ...
    descr_module : str or module, default='custom_sklearn.datasets.descr'
        Module where `descr_file_name` lives. See also :func:`load_descr`.
        The default is `'custom_sklearn.datasets.descr'`.
...
def load_wine(*, return_X_y=False, as_frame=False):
    ...
    >>> from custom_sklearn.datasets import load_wine
    >>> data = load_wine()
...
def load_linnerud(*, return_X_y=False, as_frame=False):
    ...
    Examples
    --------
    >>> from custom_sklearn.datasets import load_linnerud
...
def load_sample_images():
    ...
    >>> from custom_sklearn.datasets import load_sample_images
...
def load_sample_image(image_name):
    ...
    >>> from custom_sklearn.datasets import load_sample_image
...
def _pkl_filepath(*args, **kwargs):
    ...
    older custom-scikit-learn versions, a suffix is inserted before the extension.
