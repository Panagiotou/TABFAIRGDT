...
if not _IS_PYPY:
    ...
    def _load_svmlight_file(*args, **kwargs):
        raise NotImplementedError(
            ...
            "https://github.com/custom-scikit-learn/custom-scikit-learn/issues/11543 "
...
def _dump_svmlight(X, y, f, multilabel, one_based, comment, query_id):
    if comment:
        f.write(
            (
                "# Generated by dump_svmlight_file from custom-scikit-learn %s\n" % __version__
            ).encode()
        )
        f.write(
...
def dump_svmlight_file(
    ...
    *,
    ...
    comment : str or bytes, default=None
        ...
        the file as having been dumped by custom-scikit-learn. Note that not all
    ...
    Examples
    --------
    >>> from custom_sklearn.datasets import dump_svmlight_file, make_classification
