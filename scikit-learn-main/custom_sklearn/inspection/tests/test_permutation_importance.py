...
from custom_sklearn.ensemble import RandomForestClassifier, RandomForestRegressor
...
from custom_sklearn.preprocessing import KBinsDiscretizer, OneHotEncoder, StandardScaler, scale
...
def test_permutation_importance_large_memmaped_data(input_type):
    ...
    # https://github.com/custom-scikit-learn/custom-scikit-learn/issues/15810
