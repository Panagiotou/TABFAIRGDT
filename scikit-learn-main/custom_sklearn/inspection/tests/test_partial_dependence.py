...
from custom_sklearn.base import BaseEstimator, ClassifierMixin, clone, is_regressor
from custom_sklearn.cluster import KMeans
from custom_sklearn.compose import make_column_transformer
from custom_sklearn.datasets import load_iris, make_classification, make_regression
...
from custom_sklearn.inspection import partial_dependence
from custom_sklearn.inspection._partial_dependence import (
    _grid_from_X,
    _partial_dependence_brute,
    _partial_dependence_recursion,
)
from custom_sklearn.linear_model import LinearRegression, LogisticRegression, MultiTaskLasso
...
from custom_sklearn.tree.tests.test_tree import assert_is_subtree
from custom_sklearn.utils._testing import assert_allclose, assert_array_equal
...
def test_recursion_decision_tree_vs_forest_and_gbdt(seed):
    ...
    try:
        ...
        # https://github.com/custom-scikit-learn/custom-scikit-learn/issues/8853
...
@pytest.mark.parametrize(
    "Estimator",
    (
        custom_sklearn.tree.DecisionTreeClassifier,
        custom_sklearn.tree.ExtraTreeClassifier,
        custom_sklearn.ensemble.ExtraTreesClassifier,
        custom_sklearn.neighbors.KNeighborsClassifier,
        custom_sklearn.neighbors.RadiusNeighborsClassifier,
        custom_sklearn.ensemble.RandomForestClassifier,
    ),
)
...
def test_mixed_type_categorical():
    ...
    from custom_sklearn.preprocessing import OrdinalEncoder
