...
class PartialDependenceDisplay:
    ...
    :func:`~custom_sklearn.inspection.PartialDependenceDisplay.from_estimator` to create a
    :class:`~custom_sklearn.inspection.PartialDependenceDisplay`. All parameters are
    ...
    pd_results : list of Bunch
        Results of :func:`~custom_sklearn.inspection.partial_dependence` for
        ``features``.
    ...
    def from_estimator(
        ...
        *,
        ...
        .. warning::
            ...
            For :class:`~custom_sklearn.ensemble.GradientBoostingClassifier` and
            :class:`~custom_sklearn.ensemble.GradientBoostingRegressor`, the
            ...
            :class:`~custom_sklearn.ensemble.GradientBoostingClassifier` and
            :class:`~custom_sklearn.ensemble.GradientBoostingRegressor`, not to
        ...
        method : str, default='auto'
            ...
            - `'recursion'` is only supported for some tree-based estimators
              (namely
              :class:`~custom_sklearn.ensemble.GradientBoostingClassifier`,
              :class:`~custom_sklearn.ensemble.GradientBoostingRegressor`,
              :class:`~custom_sklearn.ensemble.HistGradientBoostingClassifier`,
              :class:`~custom_sklearn.ensemble.HistGradientBoostingRegressor`,
              :class:`~custom_sklearn.tree.DecisionTreeRegressor`,
              :class:`~custom_sklearn.ensemble.RandomForestRegressor`
        ...
        Returns
        -------
        display : :class:`~custom_sklearn.inspection.PartialDependenceDisplay`
    ...
    def plot(
        ...
        *,
        ...
        -------
        display : :class:`~custom_sklearn.inspection.PartialDependenceDisplay`
            Returns a :class:`~custom_sklearn.inspection.PartialDependenceDisplay`
