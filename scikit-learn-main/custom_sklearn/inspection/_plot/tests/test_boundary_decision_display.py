...
from custom_sklearn.inspection._plot.decision_boundary import _check_boundary_response_method
...
def test_dataframe_support(pyplot, constructor_name):
    ...
    * https://github.com/custom-scikit-learn/custom-scikit-learn/issues/23311
    * https://github.com/custom-scikit-learn/custom-scikit-learn/issues/28717
    """
...
def test_subclass_named_constructors_return_type_is_subclass(pyplot):
    ...
    Non-regression test for:
    https://github.com/custom-scikit-learn/custom-scikit-learn/pull/27675
    """
    clf = LogisticRegression().fit(X, y)
