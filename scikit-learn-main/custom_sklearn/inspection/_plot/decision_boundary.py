...
class DecisionBoundaryDisplay:
    ...
    :func:`~custom_sklearn.inspection.DecisionBoundaryDisplay.from_estimator`
    ...
    def plot(self, plot_method="contourf", ax=None, xlabel=None, ylabel=None, **kwargs):
        ...
        **kwargs : dict
        ...
        Returns
        -------
        display: :class:`~custom_sklearn.inspection.DecisionBoundaryDisplay`
    ...
    def from_estimator(
        ...
        **kwargs : dict
        ...
        custom_sklearn.metrics.ConfusionMatrixDisplay.from_estimator : Plot the
            confusion matrix given an estimator, the data, and the label.
        custom_sklearn.metrics.ConfusionMatrixDisplay.from_predictions : Plot the
