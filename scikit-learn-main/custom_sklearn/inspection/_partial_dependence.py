    ...
    for feature, is_cat in enumerate(is_categorical):
        try:
            ...
            raise ValueError(
                ...
                "case is not yet supported in custom-scikit-learn."
            ) from exc
...
def _partial_dependence_recursion(est, grid, features):
    ...
    (:func:`~custom_sklearn.inspection._partial_dependence._partial_dependence_brute`).
...
def _partial_dependence_brute(
    ...
    (:func:`~custom_sklearn.inspection._partial_dependence._partial_dependence_recursion`)
...
def partial_dependence(
    ...
    *,
    ...
    Returns
    -------
    predictions : :class:`~custom_sklearn.utils.Bunch`
