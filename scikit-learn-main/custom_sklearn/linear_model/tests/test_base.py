...
from custom_sklearn.datasets import load_iris, make_regression, make_sparse_uncorrelated
from custom_sklearn.linear_model import LinearRegression
from custom_sklearn.linear_model._base import (
    _preprocess_data,
    _rescale_data,
    make_dataset,
)
...
def test_linear_regression_sample_weight_consistency(
    ...
    if fit_intercept and sparse_container is None:
        # FIXME: https://github.com/custom-scikit-learn/custom-scikit-learn/issues/26164
        # This often fails, e.g. when calling
        # custom_sklearn_TESTS_GLOBAL_RANDOM_SEED="all" pytest \
        # custom_sklearn/linear_model/tests/test_base.py\
