"""
Testing for Theil-Sen module (custom_sklearn.linear_model.theil_sen)
"""
...
from custom_sklearn.linear_model import LinearRegression, TheilSenRegressor
from custom_sklearn.linear_model._theil_sen import (
    _breakdown_point,
