...
from custom_sklearn.base import clone, is_classifier
from custom_sklearn.datasets import load_diabetes, make_regression
...
from custom_sklearn.linear_model._coordinate_descent import _set_order
from custom_sklearn.model_selection import (
    BaseCrossValidator,
    GridSearchCV,
    LeaveOneGroupOut,
)
from custom_sklearn.model_selection._split import GroupsConsumerMixin
from custom_sklearn.pipeline import make_pipeline
from custom_sklearn.preprocessing import StandardScaler
from custom_sklearn.utils import check_array
...
def test_elasticnet_precompute_gram():
    ...
    # (see https://github.com/custom-scikit-learn/custom-scikit-learn/pull/22059
    # and https://github.com/custom-scikit-learn/custom-scikit-learn/issues/21997).
...
def test_lassoCV_does_not_set_precompute(monkeypatch, precompute, inner_precompute):
    ...
    monkeypatch.setattr("custom_sklearn.linear_model._coordinate_descent.Lasso", LassoMock)
...
def test_linear_models_cv_fit_with_loky(estimator):
    ...
    # Unfortunately the custom-scikit-learn and joblib APIs do not make it possible to
