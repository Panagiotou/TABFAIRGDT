...
from custom_sklearn.datasets import load_iris, make_classification
from custom_sklearn.exceptions import ConvergenceWarning
from custom_sklearn.linear_model import SGDClassifier
from custom_sklearn.linear_model._logistic import (
...
from custom_sklearn.metrics import get_scorer, log_loss
...
from custom_sklearn.preprocessing import LabelEncoder, StandardScaler, scale
from custom_sklearn.svm import l1_min_c
from custom_sklearn.utils import compute_class_weight, shuffle
from custom_sklearn.utils._testing import ignore_warnings, skip_if_no_parallel
from custom_sklearn.utils.fixes import _IS_32BIT, COO_CONTAINERS, CSR_CONTAINERS

pytestmark = pytest.mark.filterwarnings(
    "error::custom_sklearn.exceptions.ConvergenceWarning:custom_sklearn.*"
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # custom-scikit-learn/custom-scikit-learn/pull/
...
def test_logistic_cv_multinomial_score(scoring, multiclass_agg_list):
    ...
    # see https://github.com/custom-scikit-learn/custom-scikit-learn/issues/8720
...
def test_logistic_regressioncv_class_weights(weight, class_weight, global_random_seed):
    ...
    # the warning for now.
    # See: https://github.com/custom-scikit-learn/custom-scikit-learn/pull/27649
...
def test_liblinear_decision_function_zero():
    ...
    # See Issue: https://github.com/custom-scikit-learn/custom-scikit-learn/issues/3600
    # and the PR https://github.com/custom-scikit-learn/custom-scikit-learn/pull/3623
...
def test_dtype_match(solver, multi_class, fit_intercept, csr_container):
    ...
    #
    # See https://github.com/custom-scikit-learn/custom-scikit-learn/pull/13645
    #
...
def test_liblinear_not_stuck():
    # Non-regression https://github.com/custom-scikit-learn/custom-scikit-learn/issues/18264
    X = iris.data.copy()
    y = iris.target.copy()
    X = X[y != 2]
    y = y[y != 2]
