...
from custom_sklearn.linear_model import HuberRegressor, QuantileRegressor
from custom_sklearn.metrics import mean_pinball_loss
from custom_sklearn.utils._testing import assert_allclose, skip_if_32bit
...
def test_error_interior_point_future(X_y_data, monkeypatch):
    ...
    """
    X, y = X_y_data
    import custom_sklearn.linear_model._quantile

    with monkeypatch.context() as m:
        m.setattr(custom_sklearn.linear_model._quantile, "sp_version", parse_version("1.11.0"))
