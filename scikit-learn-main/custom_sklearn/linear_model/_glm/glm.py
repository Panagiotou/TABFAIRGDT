...
class _GeneralizedLinearRegressor(RegressorMixin, BaseEstimator):
    ...
    use the loss functions `from custom_sklearn._loss` which have the link functions included
    ...
    def score(self, X, y, sample_weight=None):
        ...
        # https://github.com/custom-scikit-learn/custom-scikit-learn/pull/22118 is merged.
        #
