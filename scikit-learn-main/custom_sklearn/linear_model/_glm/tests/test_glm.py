...
from custom_sklearn._loss import HalfBinomialLoss, HalfPoissonLoss, HalfTweedieLoss
from custom_sklearn._loss.link import IdentityLink, LogLink
from custom_sklearn.base import clone
from custom_sklearn.datasets import make_low_rank_matrix, make_regression
...
from custom_sklearn.linear_model._glm import _GeneralizedLinearRegressor
from custom_sklearn.linear_model._glm._newton_solver import NewtonCholeskySolver
from custom_sklearn.linear_model._linear_loss import LinearModelLoss
from custom_sklearn.metrics import d2_tweedie_score, mean_poisson_deviance
...
def test_glm_regression_unpenalized(solver, fit_intercept, glm_dataset):
    ...
    if n_samples > n_features:
        ...
        if solver == "newton-cholesky":
            ...
            # See https://github.com/custom-scikit-learn/custom-scikit-learn/issues/23670.
