...
# mypy error: Module 'custom_sklearn.linear_model' has no attribute '_cd_fast'
...
def lasso_path(
    ...
    **params : kwargs
    ...
    custom_sklearn.decomposition.sparse_encode : Estimator that can be used to
    ...
    >>> import numpy as np
    >>> from custom_sklearn.linear_model import lasso_path
    ...
    >>> # same path
    >>> from custom_sklearn.linear_model import lars_path
...
def enet_path(
    ...
    **params : kwargs
    ...
    Examples
    --------
    >>> from custom_sklearn.linear_model import enet_path
...
class Lasso(ElasticNet):
    ...
    custom_sklearn.decomposition.sparse_encode : Sparse coding array estimator.
    ...
    models such as :class:`~custom_sklearn.linear_model.LogisticRegression` or
    :class:`~custom_sklearn.svm.LinearSVC`. If an array is passed, penalties are
    ...
    It should not be confused with :class:`~custom_sklearn.linear_model.MultiTaskLasso` which
...
class LassoCV(RegressorMixin, LinearModelCV):
    ...
    cv : int, cross-validation generator or iterable, default=None
        ...
        For int/None inputs, :class:`~custom_sklearn.model_selection.KFold` is used.
    ...
    search using :class:`~custom_sklearn.model_selection.GridSearchCV` with a
    ...
    Examples
    --------
    >>> from custom_sklearn.linear_model import LassoCV
    >>> from custom_sklearn.datasets import make_regression
...
class ElasticNetCV(RegressorMixin, LinearModelCV):
    ...
    Examples
    --------
    >>> from custom_sklearn.linear_model import ElasticNetCV
    >>> from custom_sklearn.datasets import make_regression
...
class MultiTaskLassoCV(RegressorMixin, LinearModelCV):
    ...
    Examples
    --------
    >>> from custom_sklearn.linear_model import MultiTaskLassoCV
    >>> from custom_sklearn.datasets import make_regression
