...
_LOGISTIC_SOLVER_CONVERGENCE_MSG = (
    ...
    "    https://custom-scikit-learn.org/stable/modules/linear_model.html"
    "#logistic-regression"
)
...
def _log_reg_scoring_path(
    ...
    *,
    ...
    scoring : callable
        ...
        that can be used, look at :mod:`custom_sklearn.metrics`.
...
class LogisticRegression(LinearClassifierMixin, SparseCoefMixin, BaseEstimator):
    ...
    solver : {'lbfgs', 'liblinear', 'newton-cg', 'newton-cholesky', 'sag', 'saga'}, \
        ...
        .. note::
           ...
           a scaler from :mod:`custom_sklearn.preprocessing`.
    ...
    multi_class : {'auto', 'ovr', 'multinomial'}, default='auto'
        ...
        .. deprecated:: 1.5
           ...
           Use `custom_sklearn.multiclass.OneVsRestClassifier(LogisticRegression())` if you
...
class LogisticRegressionCV(LogisticRegression, LinearClassifierMixin, BaseEstimator):
    ...
    :class:`~custom_sklearn.model_selection.StratifiedKFold`, but it can be changed
    ...
    cv : int or cross-validation generator, default=None
        ...
        See the module :mod:`custom_sklearn.model_selection` module for the
    ...
    scoring : str or callable, default=None
        ...
        a scorer callable object / function with signature
        ``scorer(estimator, X, y)``. For a list of scoring functions
        that can be used, look at :mod:`custom_sklearn.metrics`. The
    ...
    multi_class : {'auto, 'ovr', 'multinomial'}, default='auto'
        ...
        .. deprecated:: 1.5
           ...
           `n_classes >= 3`.
           Solvers that do not support 'multinomial' will raise an error.
           Use `custom_sklearn.multiclass.OneVsRestClassifier(LogisticRegressionCV())` if you
           still want to use OvR.
