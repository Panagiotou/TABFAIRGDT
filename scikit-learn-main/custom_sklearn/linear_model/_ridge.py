    ...
    *,
    ...
    solver : {'auto', 'svd', 'cholesky', 'lsqr', 'sparse_cg', \
        ...
        - 'sag' uses a Stochastic Average Gradient descent, and 'saga' uses
          ...
          scaler from custom_sklearn.preprocessing.
    ...
    return_intercept : bool, default=False
        ...
        data, use custom_sklearn.linear_model._preprocess_data before your regression.
    ...
    >>> from custom_sklearn.linear_model import ridge_regression
...
class Ridge(MultiOutputMixin, RegressorMixin, _BaseRidge):
    ...
    :class:`~custom_sklearn.kernel_ridge.KernelRidge` : Kernel ridge regression
    ...
    regularization. Alpha corresponds to ``1 / (2C)`` in other linear
    models such as :class:`~custom_sklearn.linear_model.LogisticRegression` or
    :class:`~custom_sklearn.svm.LinearSVC`.

    Examples
    --------
    >>> from custom_sklearn.linear_model import Ridge
    >>> import numpy as np
...
class RidgeClassifier(_RidgeClassifierMixin, _BaseRidge):
    ...
    alpha : float, default=1.0
        ...
        :class:`~custom_sklearn.linear_model.LogisticRegression` or
        :class:`~custom_sklearn.svm.LinearSVC`.
    ...
    >>> from custom_sklearn.linear_model import RidgeClassifier
...
class RidgeCV(MultiOutputMixin, RegressorMixin, _BaseRidgeCV):
    ...
    cv : int, cross-validation generator or an iterable, default=None
        ...
        :class:`~custom_sklearn.model_selection.StratifiedKFold` is used, else,
        :class:`~custom_sklearn.model_selection.KFold` is used.
