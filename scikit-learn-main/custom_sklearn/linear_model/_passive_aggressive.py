...
class PassiveAggressiveClassifier(BaseSGDClassifier):
    ...
    max_iter : int, default=1000
        ...
        :meth:`~custom_sklearn.linear_model.PassiveAggressiveClassifier.partial_fit` method.
    ...
    Examples
    --------
    >>> from custom_sklearn.linear_model import PassiveAggressiveClassifier
        ...
        if not hasattr(self, "classes_"):
            ...
            if self.class_weight == "balanced":
                raise ValueError(
                    ...
                    "`custom_sklearn.utils.compute_class_weight` with "
...
class PassiveAggressiveRegressor(BaseSGDRegressor):
    ...
    max_iter : int, default=1000
        The maximum number of passes over the training data (aka epochs).
        It only impacts the behavior in the ``fit`` method, and not the
        :meth:`~custom_sklearn.linear_model.PassiveAggressiveRegressor.partial_fit` method.
    ...
    Examples
    --------
    >>> from custom_sklearn.linear_model import PassiveAggressiveRegressor
