...
def orthogonal_mp(
    ...
    *,
    ...
    >>> from custom_sklearn.linear_model import orthogonal_mp
...
def orthogonal_mp_gram(
    ...
    *,
    ...
    lars_path : Compute Least Angle Regression or Lasso path using
        LARS algorithm.
    custom_sklearn.decomposition.sparse_encode : Generic sparse coding.
    ...
    --------
    >>> from custom_sklearn.datasets import make_regression
    >>> from custom_sklearn.linear_model import orthogonal_mp_gram
    >>> X, y = make_regression(noise=4, random_state=0)
...
class OrthogonalMatchingPursuit(MultiOutputMixin, RegressorMixin, LinearModel):
    ...
    Examples
    --------
    >>> from custom_sklearn.linear_model import OrthogonalMatchingPursuit
    >>> from custom_sklearn.datasets import make_regression
    >>> X, y = make_regression(noise=4, random_state=0)
...
class OrthogonalMatchingPursuitCV(RegressorMixin, LinearModel):
    ...
    Examples
    --------
    >>> from custom_sklearn.linear_model import OrthogonalMatchingPursuitCV
    >>> from custom_sklearn.datasets import make_regression
