...
class SGDClassifier(BaseSGDClassifier):
    ...
    loss : {'hinge', 'log_loss', 'modified_huber', 'squared_hinge',\
        ...
        - The other losses, 'squared_error', 'huber', 'epsilon_insensitive' and
          ...
          :class:`~custom_sklearn.linear_model.SGDRegressor` for a description.
    ...
    See Also
    --------
    custom_sklearn.svm.LinearSVC : Linear support vector classification.
    ...
    def predict_proba(self, X):
        ...
        the classifier with
        :class:`~custom_sklearn.calibration.CalibratedClassifierCV` instead.
...
class SGDRegressor(BaseSGDRegressor):
    ...
    custom_sklearn.svm.SVR : Epsilon-Support Vector Regression.
    TheilSenRegressor : Theil-Sen Estimator robust multivariate regression model.

    Examples
    --------
    >>> import numpy as np
    >>> from custom_sklearn.linear_model import SGDRegressor
    >>> from custom_sklearn.pipeline import make_pipeline
    >>> from custom_sklearn.preprocessing import StandardScaler
...
class SGDOneClassSVM(BaseSGD, OutlierMixin):
    ...
    technique (e.g. `custom_sklearn.kernel_approximation.Nystroem`) to obtain results
    similar to `custom_sklearn.svm.OneClassSVM` which uses a Gaussian kernel by
    default.
    ...
    See Also
    --------
    custom_sklearn.svm.OneClassSVM : Unsupervised Outlier Detection.

    Notes
    -----
    This estimator has a linear complexity in the number of training samples
    and is thus better suited than the `custom_sklearn.svm.OneClassSVM`
