...
class LinearModelLoss:
    ...
    Parameters
    ----------
    base_loss : instance of class BaseLoss from custom_sklearn._loss.
    fit_intercept : bool
    """
    ...
    def gradient_hessian_product(
        ...
        if not self.base_loss.is_multiclass:
            ...
            #
            # See also https://github.com/custom-scikit-learn/custom-scikit-learn/pull/3646#discussion_r17461411  # noqa
            def hessp(s):
