...
# mypy error: Module 'custom_sklearn.utils' has no attribute 'arrayfuncs'
...
def lars_path(
    ...
    *,
    ...
    custom_sklearn.decomposition.sparse_encode : Sparse coding.
...
def lars_path_gram(
    ...
    *,
    ...
    Examples
    --------
    >>> from custom_sklearn.linear_model import lars_path_gram
    >>> from custom_sklearn.datasets import make_regression
    >>> X, y, true_coef = make_regression(
    ...    n_samples=100, n_features=5, n_informative=2, coef=True, random_state=0
    ... )
...
class LarsCV(Lars):
    ...
    cv : int, cross-validation generator or an iterable, default=None
        ...
        For integer/None inputs, :class:`~custom_sklearn.model_selection.KFold` is used.
    ...
    Examples
    --------
    >>> from custom_sklearn.linear_model import LarsCV
    >>> from custom_sklearn.datasets import make_regression
...
class LassoLarsCV(LarsCV):
    ...
    :class:`~custom_sklearn.linear_model.LassoCV` object. However, unlike the
    :class:`~custom_sklearn.linear_model.LassoCV`, it find the relevant alphas values
    by itself. In general, because of this property, it will be more stable.
    However, it is more fragile to heavily multicollinear datasets.

    It is more efficient than the :class:`~custom_sklearn.linear_model.LassoCV` if
    ...
    Examples
    --------
    >>> from custom_sklearn.linear_model import LassoLarsCV
    >>> from custom_sklearn.datasets import make_regression
