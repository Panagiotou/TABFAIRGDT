...
class RANSACRegressor(
    ...
    estimator : object, default=None
        ...
        :class:`~custom_sklearn.linear_model.LinearRegression` is used for
    ...
    min_samples : int (>= 1) or float ([0, 1]), default=None
        ...
        :class:`~custom_sklearn.linear_model.LinearRegression` estimator is assumed and
        `min_samples` is chosen as ``X.shape[1] + 1``. This parameter is highly
        dependent upon the model, so if a `estimator` other than
        :class:`~custom_sklearn.linear_model.LinearRegression` is used, the user must
        provide a value.
    ...
    Examples
    --------
    >>> from custom_sklearn.linear_model import RANSACRegressor
