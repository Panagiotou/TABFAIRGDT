...
from custom_sklearn.feature_extraction.text import (
    ENGLISH_STOP_WORDS,
    CountVectorizer,
    HashingVectorizer,
    TfidfTransformer,
...
from custom_sklearn.utils.fixes import _IS_PYPY, _IS_WASM, CSC_CONTAINERS, CSR_CONTAINERS
...
def test_countvectorizer_custom_token_pattern():
    ...
    https://github.com/custom-scikit-learn/custom-scikit-learn/issues/12971
    """
    corpus = [
...
def test_pickling_built_processors(factory):
    ...
    https://github.com/custom-scikit-learn/custom-scikit-learn/issues/12833
    """
    vec = CountVectorizer()
...
def test_tfidf_vectorizer_type(vectorizer_dtype, output_dtype, warning_expected):
    X = np.array(["numpy", "scipy", "custom_sklearn"])
...
def test_countvectorizer_sort_features_64bit_sparse_indices(csr_container):
    ...
    This test is skipped on 32bit platforms, see:
        https://github.com/custom-scikit-learn/custom-scikit-learn/pull/11295
    for more details.
    """
    ...
    vocabulary = {"custom-scikit-learn": 0, "is": 1, "great!": 2}
