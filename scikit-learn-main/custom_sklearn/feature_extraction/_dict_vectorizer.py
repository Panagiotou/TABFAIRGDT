...
class DictVectorizer(TransformerMixin, BaseEstimator):
    ...
    with custom-scikit-learn estimators.
    ...
    :class:`~custom_sklearn.preprocessing.OneHotEncoder` to complete
    ...
    custom_sklearn.preprocessing.OrdinalEncoder : Handles nominal/categorical
    ...
    def _transform(self, X, fitting):
        ...
        assert array("i").itemsize == 4, (
            ...
            " https://github.com/custom-scikit-learn/custom-scikit-learn/issues and"
