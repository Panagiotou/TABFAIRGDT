...
class BernoulliRBM(ClassNamePrefixFeaturesOutMixin, TransformerMixin, BaseEstimator):
    ...
    See Also
    --------
    custom_sklearn.neural_network.MLPRegressor : Multi-layer Perceptron regressor.
    custom_sklearn.neural_network.MLPClassifier : Multi-layer Perceptron classifier.
    custom_sklearn.decomposition.PCA : An unsupervised linear dimensionality
        reduction model.
