"""
Testing for Multi-layer Perceptron module (custom_sklearn.neural_network)
"""
...
from custom_sklearn.neural_network import MLPClassifier, MLPRegressor
from custom_sklearn.preprocessing import LabelBinarizer, MinMaxScaler, scale
...
def test_warm_start_full_iteration(MLPEstimator):
    ...
    # https://github.com/custom-scikit-learn/custom-scikit-learn/issues/16812
...
def test_mlp_warm_start_no_convergence(MLPEstimator, solver):
    ...
    Non-regression test for:
    https://github.com/custom-scikit-learn/custom-scikit-learn/issues/24764
    """
    model = MLPEstimator(
        solver=solver,
        warm_start=True,
