...
class LinearSVC(LinearClassifierMixin, SparseCoefMixin, BaseEstimator):
    ...
    The main differences between :class:`~custom_sklearn.svm.LinearSVC` and
    :class:`~custom_sklearn.svm.SVC` lie in the loss function used by default, and in
    ...
    SVC : Implementation of Support Vector Machine classifier using libsvm:
        ...
        :class:`~custom_sklearn.multiclass.OneVsRestClassifier` wrapper.

        Finally SVC can fit dense data without memory copy if the input
        is C-contiguous. Sparse data will still incur memory copy though.

    custom_sklearn.linear_model.SGDClassifier : SGDClassifier can optimize the same
...
class LinearSVR(RegressorMixin, LinearModel):
    ...
    The main differences between :class:`~custom_sklearn.svm.LinearSVR` and
    :class:`~custom_sklearn.svm.SVR` lie in the loss function used by default, and in
    the handling of intercept regularization between those two implementations.
    ...
    SVR : Implementation of Support Vector Machine regression using libsvm:
        ...
        large number of samples as :class:`~custom_sklearn.svm.LinearSVR` does.

    custom_sklearn.linear_model.SGDRegressor : SGDRegressor can optimize the same cost
    ...
    Examples
    --------
    >>> from custom_sklearn.svm import LinearSVR
    >>> from custom_sklearn.pipeline import make_pipeline
    >>> from custom_sklearn.preprocessing import StandardScaler
...
class SVC(BaseSVC):
    ...
    consider using :class:`~custom_sklearn.svm.LinearSVC` or
    :class:`~custom_sklearn.linear_model.SGDClassifier` instead, possibly after a
    :class:`~custom_sklearn.kernel_approximation.Nystroem` transformer or
...
class NuSVC(BaseSVC):
    ...
    >>> from custom_sklearn.pipeline import make_pipeline
    >>> from custom_sklearn.preprocessing import StandardScaler
    >>> from custom_sklearn.svm import NuSVC
...
class SVR(RegressorMixin, BaseLibSVM):
    ...
    datasets consider using :class:`~custom_sklearn.svm.LinearSVR` or
    :class:`~custom_sklearn.linear_model.SGDRegressor` instead, possibly after a
    :class:`~custom_sklearn.kernel_approximation.Nystroem` transformer or
    other :ref:`kernel_approximation`.
...
class NuSVR(RegressorMixin, BaseLibSVM):
    ...
    Examples
    --------
    >>> from custom_sklearn.svm import NuSVR
    >>> from custom_sklearn.pipeline import make_pipeline
    >>> from custom_sklearn.preprocessing import StandardScaler
    >>> import numpy as np
    >>> n_samples, n_features = 10, 5
...
class OneClassSVM(OutlierMixin, BaseLibSVM):
    ...
    See Also
    --------
    custom_sklearn.linear_model.SGDOneClassSVM : Solves linear One-Class SVM using
        Stochastic Gradient Descent.
    custom_sklearn.neighbors.LocalOutlierFactor : Unsupervised Outlier Detection using
        Local Outlier Factor (LOF).
    custom_sklearn.ensemble.IsolationForest : Isolation Forest Algorithm.

    Examples
    --------
    >>> from custom_sklearn.svm import OneClassSVM
