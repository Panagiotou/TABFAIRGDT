# custom-scikit-learn documentation build configuration file, created by
...
from custom_sklearn.externals._packaging.version import parse
from custom_sklearn.utils._testing import turn_warnings_into_errors
...
project = "custom-scikit-learn"
copyright = f"2007 - {datetime.now().year}, custom-scikit-learn developers (BSD License)"
...
parsed_version = parse(custom_sklearn.__version__)
...
if parsed_version.is_postrelease:
    ...
    release = custom_sklearn.__version__
...
html_theme_options = {
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/custom-scikit-learn/custom-scikit-learn",
            "icon": "fa-brands fa-square-github",
            "type": "fontawesome",
        },
    ],
    "analytics": {
        "plausible_analytics_domain": "custom-scikit-learn.org",
    ...
    "switcher": {
        "json_url": "https://custom-scikit-learn.org/dev/_static/versions.json",
    ...
    "logo": {
        "alt_text": "custom-scikit-learn homepage",
        "image_relative": "logos/custom-scikit-learn-logo-small.png",
        "image_light": "logos/custom-scikit-learn-logo-small.png",
        "image_dark": "logos/custom-scikit-learn-logo-small.png",
    },
...
html_short_title = "custom-scikit-learn"
...
htmlhelp_basename = "custom-scikit-learndoc"
...
# See https://github.com/custom-scikit-learn/custom-scikit-learn/pull/22550
...
latex_documents = [
    (
        "contents",
        "user_guide.tex",
        "custom-scikit-learn user guide",
        "custom-scikit-learn developers",
        "manual",
    ),
]
...
# the title page.
latex_logo = "logos/custom-scikit-learn-logo.png"
...
def notebook_modification_function(notebook_content, notebook_filename):
    ...
    message = (
        "Running the custom-scikit-learn examples in JupyterLite is experimental and you may"
        " encounter some unexpected behavior.\n\nThe main difference is that imports"
        " will take a lot longer than usual, for example the first `import custom_sklearn` can"
        " take roughly 10-20s.\n\nIf you notice problems, feel free to open an"
        " [issue](https://github.com/custom-scikit-learn/custom-scikit-learn/issues/new/choose)"
        " about it."
    )
...
default_global_config = custom_sklearn.get_config()


def reset_custom_sklearn_config(gallery_conf, fname):
    """Reset custom_sklearn config to default values."""
    custom_sklearn.set_config(**default_global_config)


sg_examples_dir = "../examples"
sg_gallery_dir = "auto_examples"
sphinx_gallery_conf = {
    "doc_module": "custom_sklearn",
    "backreferences_dir": os.path.join("modules", "generated"),
    "show_memory": False,
    "reference_url": {"custom_sklearn": None},
    ...
    "binder": {
        "org": "custom-scikit-learn",
        "repo": "custom-scikit-learn",
    ...
    "reset_modules": ("matplotlib", "seaborn", reset_custom_sklearn_config),
}
if with_jupyterlite:
...
# thumbnails for the front page of the custom-scikit-learn home page.
...
issues_github_path = "custom-scikit-learn/custom-scikit-learn"
...
linkcode_resolve = make_linkcode_resolve(
    "custom_sklearn",
    (
        "https://github.com/custom-scikit-learn/"
        "custom-scikit-learn/blob/{revision}/"
...
if os.environ.get("custom_sklearn_WARNINGS_AS_ERRORS", "0") != "0":
    turn_warnings_into_errors()

# maps functions with a class name that is indistinguishable when case is
# ignore to another filename
autosummary_filename_map = {
    "custom_sklearn.cluster.dbscan": "dbscan-function",
    "custom_sklearn.covariance.oas": "oas-function",
    "custom_sklearn.decomposition.fastica": "fastica-function",
}


# Config for sphinxext.opengraph

ogp_site_url = "https://custom-scikit-learn/stable/"
ogp_image = "https://custom-scikit-learn.org/stable/_static/custom-scikit-learn-logo-small.png"
ogp_use_first_image = True
ogp_site_name = "custom-scikit-learn"
...
# development version; see https://github.com/custom-scikit-learn/custom-scikit-learn/pull/22550
if parsed_version.is_devrelease:
    development_link = "developers/index"
else:
    development_link = "https://custom-scikit-learn.org/dev/developers/index.html"
