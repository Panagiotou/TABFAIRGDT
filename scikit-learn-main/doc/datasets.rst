...
The ``custom_sklearn.datasets`` package embeds some small toy datasets
...
Both loaders and fetchers functions return a :class:`~custom_sklearn.utils.Bunch`
...
For more information about Bunch object, see :class:`~custom_sklearn.utils.Bunch`.
