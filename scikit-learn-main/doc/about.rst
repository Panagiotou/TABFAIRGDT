...
The people behind custom-scikit-learn
------------------------------

custom-scikit-learn is a community project, developed by a large group of
...
github
<https://github.com/custom-scikit-learn/custom-scikit-learn/graphs/contributors>`__.

Maintainers Team
................

The following people are currently maintainers, in charge of
consolidating custom-scikit-learn's development and maintenance:
...
.. note::
  ...
  Instead, please see `What's the best way to ask questions about custom-scikit-learn
  <https://custom-scikit-learn.org/stable/faq.html#what-s-the-best-way-to-get-help-on-custom-scikit-learn-usage>`_
  in the FAQ.
...
The following people help with :ref:`communication around custom-scikit-learn
<communication_team>`.
...
.. _citing-custom-scikit-learn:

Citing custom-scikit-learn
-------------------

If you use custom-scikit-learn in a scientific publication, we would appreciate
citations to the following paper:

`custom-scikit-learn: Machine Learning in Python
<https://jmlr.csail.mit.edu/papers/v12/pedregosa11a.html>`_, Pedregosa
*et al.*, JMLR 12, pp. 2825-2830, 2011.

Bibtex entry::

  @article{custom-scikit-learn,
    title={custom-scikit-learn: Machine Learning in {P}ython},
...
If you want to cite custom-scikit-learn for its API or design, you may also want to consider the
following paper:

:arxiv:`API design for machine learning software: experiences from the custom-scikit-learn
project <1309.0238>`, Buitinck *et al.*, 2013.

Bibtex entry::

  @inproceedings{custom_sklearn_api,
    author    = {Lars Buitinck and Gilles Louppe and Mathieu Blondel and
                  Fabian Pedregosa and Andreas Mueller and Olivier Grisel and
                  Vlad Niculae and Peter Prettenhofer and Alexandre Gramfort
                  and Jaques Grobler and Robert Layton and Jake VanderPlas and
                  Arnaud Joly and Brian Holt and Ga{\"{e}}l Varoquaux},
    title     = {{API} design for machine learning software: experiences from the custom-scikit-learn
                  project},
...
<https://github.com/custom-scikit-learn/custom-scikit-learn/tree/main/doc/logos>`_
source directory.

.. image:: images/custom-scikit-learn-logo-notext.png
  :align: center

Funding
-------

custom-scikit-learn is a community driven project, however institutional and private
...
.. div:: sk-text-image-grid-small
  ...
  .. div:: text-box
    ...
    The `Members <https://custom-scikit-learn.fondation-inria.fr/en/home/#sponsors>`_ of
    the `custom-scikit-learn Consortium at Inria Foundation
    <https://custom-scikit-learn.fondation-inria.fr/en/home/>`_ help at maintaining and
...
.. div:: sk-text-image-grid-small
  ...
  .. div:: text-box
    ...
    and is part of the custom-scikit-learn consortium at Inria.
...
.. div:: sk-text-image-grid-small
  ...
  .. div:: text-box
    ...
    Andreas Müller received a grant to improve custom-scikit-learn from the
...
.. div:: sk-text-image-grid-small
  ...
  .. div:: text-box
    ...
    (2016-2017) and Albert Thomas (2017) to work on custom-scikit-learn.
...
.. div:: sk-text-image-grid-small
  ...
  .. div:: text-box
    ...
    (2018-2019) to work part time on custom-scikit-learn during their PhDs. It also
    funded a custom-scikit-learn coding sprint in 2015.
...
.. div:: sk-text-image-grid-small
  ...
  .. div:: text-box
    ...
    Hug to work full-time on custom-scikit-learn in 2020.
...
<https://opensource.google/>`_ to work on custom-scikit-learn through
...
The following organizations funded the custom-scikit-learn consortium at Inria in
the past:
...
<https://numfocus.org/donate-to-custom-scikit-learn>`_.

.. raw:: html

  <p class="text-center">
    <a class="btn sk-btn-orange mb-1" href="https://numfocus.org/donate-to-custom-scikit-learn">
...
computing software, in particular in Python. As a fiscal home of custom-scikit-learn, it
...
The received donations for the custom-scikit-learn project mostly will go towards covering
