...
.. note::
  ...
  ``True``::
    ...
    >>> custom_sklearn.set_config(enable_metadata_routing=True)
...
custom-scikit-learn. If you are developing a custom-scikit-learn compatible estimator or
...
metadata. Prior to custom-scikit-learn version 1.3, there was no single API for passing
...
The examples in this section require the following imports and data::
  ...
  >>> import numpy as np
  >>> from custom_sklearn.metrics import make_scorer, accuracy_score
  >>> from custom_sklearn.linear_model import LogisticRegressionCV, LogisticRegression
  >>> from custom_sklearn.model_selection import cross_validate, GridSearchCV, GroupKFold
...
metadata routing::
    ...
    >>> custom_sklearn.set_config(enable_metadata_routing=False)
...
- :class:`custom_sklearn.calibration.CalibratedClassifierCV`
- :class:`custom_sklearn.compose.ColumnTransformer`
- :class:`custom_sklearn.covariance.GraphicalLassoCV`
- :class:`custom_sklearn.ensemble.StackingClassifier`
- :class:`custom_sklearn.ensemble.StackingRegressor`
- :class:`custom_sklearn.ensemble.VotingClassifier`
- :class:`custom_sklearn.ensemble.VotingRegressor`
- :class:`custom_sklearn.ensemble.BaggingClassifier`
- :class:`custom_sklearn.ensemble.BaggingRegressor`
- :class:`custom_sklearn.feature_selection.SelectFromModel`
- :class:`custom_sklearn.impute.IterativeImputer`
- :class:`custom_sklearn.linear_model.ElasticNetCV`
- :class:`custom_sklearn.linear_model.LarsCV`
- :class:`custom_sklearn.linear_model.LassoCV`
- :class:`custom_sklearn.linear_model.LassoLarsCV`
- :class:`custom_sklearn.linear_model.LogisticRegressionCV`
- :class:`custom_sklearn.linear_model.MultiTaskElasticNetCV`
- :class:`custom_sklearn.linear_model.MultiTaskLassoCV`
- :class:`custom_sklearn.linear_model.OrthogonalMatchingPursuitCV`
- :class:`custom_sklearn.linear_model.RANSACRegressor`
- :class:`custom_sklearn.linear_model.RidgeClassifierCV`
- :class:`custom_sklearn.linear_model.RidgeCV`
- :class:`custom_sklearn.model_selection.GridSearchCV`
- :class:`custom_sklearn.model_selection.HalvingGridSearchCV`
- :class:`custom_sklearn.model_selection.HalvingRandomSearchCV`
- :class:`custom_sklearn.model_selection.RandomizedSearchCV`
- :func:`custom_sklearn.model_selection.cross_validate`
- :func:`custom_sklearn.model_selection.cross_val_score`
- :func:`custom_sklearn.model_selection.cross_val_predict`
- :class:`custom_sklearn.model_selection.learning_curve`
- :class:`custom_sklearn.multiclass.OneVsOneClassifier`
- :class:`custom_sklearn.multiclass.OneVsRestClassifier`
- :class:`custom_sklearn.multiclass.OutputCodeClassifier`
- :class:`custom_sklearn.multioutput.ClassifierChain`
- :class:`custom_sklearn.multioutput.MultiOutputClassifier`
- :class:`custom_sklearn.multioutput.MultiOutputRegressor`
- :class:`custom_sklearn.multioutput.RegressorChain`
- :class:`custom_sklearn.pipeline.FeatureUnion`
- :class:`custom_sklearn.pipeline.Pipeline`

Meta-estimators and tools not supporting metadata routing yet:

- :class:`custom_sklearn.compose.TransformedTargetRegressor`
- :class:`custom_sklearn.ensemble.AdaBoostClassifier`
- :class:`custom_sklearn.ensemble.AdaBoostRegressor`
- :class:`custom_sklearn.feature_selection.RFE`
- :class:`custom_sklearn.feature_selection.RFECV`
- :class:`custom_sklearn.feature_selection.SequentialFeatureSelector`
- :class:`custom_sklearn.model_selection.permutation_test_score`
- :class:`custom_sklearn.model_selection.validation_curve`
- :class:`custom_sklearn.semi_supervised.SelfTrainingClassifier`
