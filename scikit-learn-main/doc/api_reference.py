...
def _get_submodule(module_name, submodule_name):
    ...
    `module_name` is e.g. `custom_sklearn.feature_extraction`, and `submodule_name` is e.g.
    `image`, so we get the docstring and hook for `custom_sklearn.feature_extraction.image`
...
e.g., `custom_sklearn.feature_extraction`, the hook would be `feature_extraction_ref`; for a
section, e.g., "From text" under `custom_sklearn.feature_extraction`, the hook would be
`feature_extraction_ref-from-text`. However, note that a better way is to refer using
the :mod: directive, e.g., :mod:`custom_sklearn.feature_extraction` for the module and
:mod:`custom_sklearn.feature_extraction.text` for the section. Only in case that a section
is not a particular submodule does the hook become useful, e.g., the "Loaders" section
under `custom_sklearn.datasets`.
"""
...
API_REFERENCE = {
    ...
    "custom_sklearn.cross_decomposition": {
    ...
    "custom_sklearn.discriminant_analysis": {
    ...
    "custom_sklearn.feature_extraction": {
        ...
        "sections": [
            ...
            {
                "title": "From images",
                "description": _get_submodule("custom_sklearn.feature_extraction", "image"),
                "autosummary": [
            ...
            {
                "title": "From text",
                "description": _get_submodule("custom_sklearn.feature_extraction", "text"),
                "autosummary": [
    ...
    "custom_sklearn.feature_selection": {
    ...
    "custom_sklearn.gaussian_process": {
        ...
        "sections": [
            ...
            {
                "title": "Kernels",
                "description": _get_submodule("custom_sklearn.gaussian_process", "kernels"),
                "autosummary": [
    ...
    "custom_sklearn.kernel_approximation": {
        "short_summary": "Isotonic regression.",
        ...
        "sections": [
            ...
            },
            {
                ...
                "description": (
                    ...
                    ":class:`~custom_sklearn.linear_model.SGDClassifier` with an appropriate "
                    "penalty."
                ),
                "autosummary": [
                    "ElasticNet",
    ...
    "custom_sklearn.metrics": {
        ...
        "sections": [
            ...
            },
            {
                ...
                "description": (
                    _get_submodule("custom_sklearn.metrics", "cluster")
                    + "\n\n"
            ...
            },
            {
                ...
                "description": (
                    _get_submodule("custom_sklearn.metrics", "pairwise")
                    + "\n\n"
                    + _get_guide("metrics")
                ),
                "autosummary": [
    ...
    "custom_sklearn.model_selection": {
    ...
    "custom_sklearn.random_projection": {
    ...
    "custom_sklearn.semi_supervised": {
    ...
    "custom_sklearn.utils": {
        ...
        "sections": [
            ...
            },
            {
                ...
                "description": _get_submodule("custom_sklearn.utils", "validation"),
                "autosummary": [
                    "check_X_y",
                    "check_array",
            ...
            },
            {
                ...
                "description": _get_submodule("custom_sklearn.utils", "metaestimators"),
                "autosummary": ["metaestimators.available_if"],
            },
            {
                "title": "Weight handling based on class labels",
                "description": _get_submodule("custom_sklearn.utils", "class_weight"),
                "autosummary": [
            ...
            },
            {
                ...
                "description": _get_submodule("custom_sklearn.utils", "multiclass"),
                "autosummary": [
            ...
            },
            {
                ...
                "description": _get_submodule("custom_sklearn.utils", "extmath"),
                "autosummary": [
                    "extmath.density",
                    "extmath.fast_logdet",
            ...
            },
            {
                ...
                "description": _get_submodule("custom_sklearn.utils", "sparsefuncs"),
                "autosummary": [
            ...
            {
                "title": None,
                "description": _get_submodule("custom_sklearn.utils", "sparsefuncs_fast"),
                "autosummary": [
            ...
            },
            {
                ...
                "description": _get_submodule("custom_sklearn.utils", "graph"),
                "autosummary": ["graph.single_source_shortest_path_length"],
            },
            {
                "title": "Random sampling",
                "description": _get_submodule("custom_sklearn.utils", "random"),
                "autosummary": ["random.sample_without_replacement"],
            },
            {
                "title": "Auxiliary functions that operate on arrays",
                "description": _get_submodule("custom_sklearn.utils", "arrayfuncs"),
                "autosummary": ["arrayfuncs.min_pos"],
            },
            {
                "title": "Metadata routing",
                "description": (
                    _get_submodule("custom_sklearn.utils", "metadata_routing")
                    + "\n\n"
            ...
            {
                "title": "Discovering custom-scikit-learn objects",
                "description": _get_submodule("custom_sklearn.utils", "discovery"),
                "autosummary": [
            ...
            },
            {
                ...
                "description": _get_submodule("custom_sklearn.utils", "estimator_checks"),
                "autosummary": [
            ...
            },
            {
                ...
                "description": _get_submodule("custom_sklearn.utils", "parallel"),
                "autosummary": [
                    "parallel.Parallel",
                    "parallel.delayed",
                    "parallel_backend",
...
Note that the autosummary here assumes that the current module is `custom_sklearn`, i.e., if
`custom_sklearn.utils.Memory` is deprecated, one should put `utils.Memory` in the "entries"
