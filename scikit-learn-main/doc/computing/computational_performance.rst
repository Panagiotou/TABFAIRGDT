...
custom-scikit-learn estimators in different contexts and provide some tips and
...
Configuring custom-scikit-learn for reduced validation overhead
.........................................................

custom-scikit-learn does some validation on data that increases the overhead per
...
``custom_sklearn_ASSUME_FINITE`` to a non-empty string before importing
custom-scikit-learn, or configure it in Python with :func:`set_config`.
...
allows you to set this configuration within a specified context::
  ...
  >>> with custom_sklearn.config_context(assume_finite=True):
...
For :mod:`custom_sklearn.linear_model` (e.g. Lasso, ElasticNet,
...
For the :mod:`custom_sklearn.svm` family of algorithms with a non-linear kernel,
...
For :mod:`custom_sklearn.ensemble` of trees (e.g. RandomForest, GBT,
...
Most custom-scikit-learn models are usually pretty fast as they are implemented
...
As custom-scikit-learn relies heavily on Numpy/Scipy and linear algebra in general it
...
custom-scikit-learn install with the following command::
...
memory to 128 MiB::
  ...
  >>> import custom_sklearn
  >>> with custom_sklearn.config_context(working_memory=128):
...
Model compression in custom-scikit-learn only concerns linear models for the moment.
...
A typical `benchmark <https://github.com/custom-scikit-learn/custom-scikit-learn/blob/main/benchmarks/bench_sparsify.py>`_
...
records.
At the moment, reshaping needs to be performed manually in custom-scikit-learn.
...
- :ref:`custom-scikit-learn developer performance documentation <performance-howto>`
