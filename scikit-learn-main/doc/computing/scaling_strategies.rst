...
approaches. In these cases custom-scikit-learn has a number of options you can
...
custom-scikit-learn. However, when working with data that needs vectorization and
...
:class:`custom_sklearn.feature_extraction.FeatureHasher` for datasets with categorical
variables represented as list of Python dicts or
:class:`custom_sklearn.feature_extraction.text.HashingVectorizer` for text documents.

Incremental learning
.....................

Finally, for 3. we have a number of options inside custom-scikit-learn. Although not
...
- Classification
    + :class:`custom_sklearn.naive_bayes.MultinomialNB`
    + :class:`custom_sklearn.naive_bayes.BernoulliNB`
    + :class:`custom_sklearn.linear_model.Perceptron`
    + :class:`custom_sklearn.linear_model.SGDClassifier`
    + :class:`custom_sklearn.linear_model.PassiveAggressiveClassifier`
    + :class:`custom_sklearn.neural_network.MLPClassifier`
- Regression
    + :class:`custom_sklearn.linear_model.SGDRegressor`
    + :class:`custom_sklearn.linear_model.PassiveAggressiveRegressor`
    + :class:`custom_sklearn.neural_network.MLPRegressor`
- Clustering
    + :class:`custom_sklearn.cluster.MiniBatchKMeans`
    + :class:`custom_sklearn.cluster.Birch`
- Decomposition / feature Extraction
    + :class:`custom_sklearn.decomposition.MiniBatchDictionaryLearning`
    + :class:`custom_sklearn.decomposition.IncrementalPCA`
    + :class:`custom_sklearn.decomposition.LatentDirichletAllocation`
    + :class:`custom_sklearn.decomposition.MiniBatchNMF`
- Preprocessing
    + :class:`custom_sklearn.preprocessing.StandardScaler`
    + :class:`custom_sklearn.preprocessing.MinMaxScaler`
    + :class:`custom_sklearn.preprocessing.MaxAbsScaler`
