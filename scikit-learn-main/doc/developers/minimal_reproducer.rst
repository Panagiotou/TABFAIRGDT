...
==============================================
Crafting a minimal reproducer for custom-scikit-learn
==============================================
...
The first step before submitting a bug report to custom-scikit-learn is to read the
`Issue template
<https://github.com/custom-scikit-learn/custom-scikit-learn/blob/main/.github/ISSUE_TEMPLATE/bug_report.yml>`_.
...
:mod:`custom_sklearn.datasets` module. Most of the times the bug is not related to a
...
as :class:`custom_sklearn.preprocessing.StandardScaler`.
...
Some custom-scikit-learn objects expect pandas dataframes as input. In this case you can
...
In addition, custom-scikit-learn includes various :ref:`sample_generators` that can be
used to build artificial datasets of controlled size and complexity.

`make_regression`
-----------------

As hinted by the name, :class:`custom_sklearn.datasets.make_regression` produces
...
:class:`custom_sklearn.datasets.make_classification` creates multiclass datasets with multiple Gaussian
...
Similarly to `make_classification`, :class:`custom_sklearn.datasets.make_blobs` creates
