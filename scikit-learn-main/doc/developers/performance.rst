...
code for the custom-scikit-learn project.
...
In general, the custom-scikit-learn project emphasizes the **readability** of
...
2. If there exists a well maintained BSD or MIT **C/C++** implementation
   ...
   **Cython wrapper** for it and include a copy of the source code
   of the library in the custom-scikit-learn source tree: this strategy is
...
to make it possible to install custom-scikit-learn stable version
...
of custom-scikit-learn. Let us setup a new IPython session and load the digits
dataset and as in the :ref:`sphx_glr_auto_examples_classification_plot_digits_classification.py` example::

  In [1]: from custom_sklearn.decomposition import NMF

  In [2]: from custom_sklearn.datasets import load_digits
...
Now restart IPython and let us use this new toy::
  ...
  In [1]: from custom_sklearn.datasets import load_digits

  In [2]: from custom_sklearn.decomposition import NMF
    ... : from custom_sklearn.decomposition._nmf import _nls_subproblem
  ...
  File: custom_sklearn/decomposition/nmf.py
...
For more information about developing in Cython for custom-scikit-learn, see :ref:`cython`.
