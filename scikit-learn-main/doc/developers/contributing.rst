...
.. currentmodule:: custom_sklearn

This project is a community effort, and everyone is welcome to
contribute.

The project is hosted on https://github.com/custom-scikit-learn/custom-scikit-learn

The decision making process and governance structure of custom-scikit-learn is laid
out in the governance document: :ref:`governance`.

custom-scikit-learn is somewhat :ref:`selective <selectiveness>` when it comes to
...
.. topic:: **Our community, our values**
    ...
    Source Software and custom-scikit-learn in particular to participate and
...
<https://github.com/custom-scikit-learn/custom-scikit-learn/issues>`_. You are also
...
.. raw:: html
  ...
  <a class="github-button" href="https://github.com/custom-scikit-learn/custom-scikit-learn"
  data-icon="octicon-star" data-size="large" data-show-count="true" aria-label="Star
  custom-scikit-learn/custom-scikit-learn on GitHub">Star</a>
  <script async defer src="https://buttons.github.io/buttons.js"></script>

In case a contribution/issue involves changes to the API principles
or changes to dependencies or supported versions, it must be backed by a
:ref:`slep`, where a SLEP must be submitted as a pull-request to
`enhancement proposals <https://custom-scikit-learn-enhancement-proposals.readthedocs.io>`_
using the `SLEP template <https://custom-scikit-learn-enhancement-proposals.readthedocs.io/en/latest/slep_template.html>`_
and follows the decision-making process outlined in :ref:`governance`.

.. dropdown:: Contributing to related projects

  custom-scikit-learn thrives in an ecosystem of several related projects, which also
  may have relevant issues to work on, including smaller projects such as:

  * `custom-scikit-learn-contrib <https://github.com/search?q=org%3Acustom-scikit-learn-contrib+is%3Aissue+is%3Aopen+sort%3Aupdated-desc&type=Issues>`__
  ...
  * and so on.
  ...
  Helping these projects may help custom-scikit-learn too.
...
In case you experience issues using this package, do not hesitate to submit a
ticket to the
`Bug Tracker <https://github.com/custom-scikit-learn/custom-scikit-learn/issues>`_. You are
...
-  Verify that your issue is not being currently addressed by other
   `issues <https://github.com/custom-scikit-learn/custom-scikit-learn/issues?q=>`_
   or `pull requests <https://github.com/custom-scikit-learn/custom-scikit-learn/pulls?q=>`_.

-  If you are submitting an algorithm or feature request, please verify that
   the algorithm fulfills our
   `new algorithm requirements
   <https://custom-scikit-learn.org/stable/faq.html#what-are-the-inclusion-criteria-for-new-algorithms>`_.
...
<https://github.com/custom-scikit-learn/custom-scikit-learn/issues>`__, please do your best to
...
- Please include your **operating system type and version number**, as well as
  your **Python, custom-scikit-learn, numpy, and scipy versions**. This information
  can be found by running the following code snippet::

    >>> import custom_sklearn
    >>> custom_sklearn.show_versions()  # doctest: +SKIP
...
.. note::
  ...
  `issue tracker <https://github.com/custom-scikit-learn/custom-scikit-learn/issues>`_ and
  the `PR list <https://github.com/custom-scikit-learn/custom-scikit-learn/pulls>`_.
  If in doubt about duplicated work, or if you want to work on a non-trivial
  feature, it's recommended to first open an issue in
  the `issue tracker <https://github.com/custom-scikit-learn/custom-scikit-learn/issues>`_
...
custom-scikit-learn, and are a great companion to the following text guidelines.
Please make sure to still check our guidelines below, since they describe our
latest up-to-date workflow.

- Crash Course in Contributing to custom-scikit-learn & Open Source Projects:
...
- Example of Submitting a Pull Request to custom-scikit-learn:
  `Video <https://youtu.be/PU1WyDPGePI>`__,
  `Transcript
  <https://github.com/data-umbrella/event-transcripts/blob/main/2020/06-reshama-shaikh-custom_sklearn-pr.md>`__

- Sprint-specific instructions and practical tips:
  `Video <https://youtu.be/p_2Uw2BxdhA>`__,
  `Transcript
  <https://github.com/data-umbrella/data-umbrella-custom-scikit-learn-sprint/blob/master/3_transcript_ACM_video_vol2.md>`__
...
.. note::
  ...
  for the custom-scikit-learn GitHub repository to use more inclusive terms.
...
The preferred way to contribute to custom-scikit-learn is to fork the `main
repository <https://github.com/custom-scikit-learn/custom-scikit-learn/>`__ on GitHub,
then submit a "pull request" (PR).

In the first few steps, we explain how to locally install custom-scikit-learn, and
...
2. Fork the `project repository
   <https://github.com/custom-scikit-learn/custom-scikit-learn>`__: click on the 'Fork'
   button near the top of the page. This creates a copy of the code under your
   account on the GitHub user account. For more details on how to fork a
   repository see `this guide <https://help.github.com/articles/fork-a-repo/>`_.

3. Clone your fork of the custom-scikit-learn repo from your GitHub account to your
   local disk:

   .. prompt:: bash $

      git clone git@github.com:YourLogin/custom-scikit-learn.git  # add --depth 1 if your connection is slow
      cd custom-scikit-learn

4. Follow steps 2-6 in :ref:`install_bleeding_edge` to build custom-scikit-learn in
...
6. Add the ``upstream`` remote. This saves a reference to the main
   custom-scikit-learn repository, which you can use to keep your repository
   synchronized with the latest changes:

   .. prompt:: bash $

        git remote add upstream git@github.com:custom-scikit-learn/custom-scikit-learn.git

7. Check that the `upstream` and `origin` remote aliases are configured correctly
   by running `git remote -v` which should display::

        origin	git@github.com:YourLogin/custom-scikit-learn.git (fetch)
        origin	git@github.com:YourLogin/custom-scikit-learn.git (push)
        upstream	git@github.com:custom-scikit-learn/custom-scikit-learn.git (fetch)
        upstream	git@github.com:custom-scikit-learn/custom-scikit-learn.git (push)

You should now have a working installation of custom-scikit-learn, and your git repository
...
latest changes of the main custom-scikit-learn repository:
...
2. **Make sure your code passes the tests**. The whole test suite can be run
   ...
   `custom_sklearn/linear_model/_logistic.py`, running the following commands will
   usually be enough:

   - `pytest custom_sklearn/linear_model/_logistic.py` to make sure the doctest
     examples are correct
   - `pytest custom_sklearn/linear_model/tests/test_logistic.py` to run the tests
     specific to the file
   - `pytest custom_sklearn/linear_model` to test the whole
     :mod:`~custom_sklearn.linear_model` module
   - `pytest doc/modules/linear_model.rst` to make sure the user guide
     examples are correct.
   - `pytest custom_sklearn/tests/test_common.py -k LogisticRegression` to run all our
...
6. When applicable, use the validation tools and scripts in the
   ``custom_sklearn.utils`` submodule.  A list of utility routines available
...
8. PRs should often substantiate the change, through benchmarks of
    ...
    <https://github.com/custom-scikit-learn/custom-scikit-learn/tree/main/examples>`_
    directory for reference. Examples should demonstrate why the new
    functionality is useful in practice and, if possible, compare it to other
    methods available in custom-scikit-learn.
...
* Code with a good unittest coverage (at least 80%, better 100%), check
  ...
  .. prompt:: bash $
    ...
    pytest --cov custom_sklearn path/to/tests_for_package
...
.. note::
  ...
  The current state of the custom-scikit-learn code base is not compliant with
...
* Azure pipelines are used for testing custom-scikit-learn on Linux, Mac and Windows,
...
[float32]              Run float32 tests by setting `custom_sklearn_RUN_FLOAT32_TESTS=1`. See :ref:`environment_variable` for more details
...
`"help wanted" <https://github.com/custom-scikit-learn/custom-scikit-learn/labels/help%20wanted>`_.
...
.. topic:: good first issue tag
    ...
    A great way to start contributing to custom-scikit-learn is to pick an item from
    the list of `good first issues
    <https://github.com/custom-scikit-learn/custom-scikit-learn/labels/good%20first%20issue>`_
    in the issue tracker. Resolving these issues allow you to start contributing
    to the project without much prior knowledge. If you have already contributed
    to custom-scikit-learn, you should look at Easy issues instead.

.. topic:: Easy tag

    If you have already contributed to custom-scikit-learn, another great way to contribute
    to custom-scikit-learn is to pick an item from the list of `Easy issues
    <https://github.com/custom-scikit-learn/custom-scikit-learn/labels/Easy>`_ in the issue
...
.. topic:: help wanted tag
    ...
    `here <https://github.com/custom-scikit-learn/custom-scikit-learn/labels/help%20wanted>`_.
...
* **function/method/class docstrings** (also known as "API documentation") -
  ...
  `custom_sklearn/ <https://github.com/custom-scikit-learn/custom-scikit-learn/tree/main/custom_sklearn>`_.
* **user guide** - these provide more detailed information about the algorithms
  implemented in custom-scikit-learn and generally live in the root
  `doc/ <https://github.com/custom-scikit-learn/custom-scikit-learn/tree/main/doc>`_ directory
  and
  `doc/modules/ <https://github.com/custom-scikit-learn/custom-scikit-learn/tree/main/doc/modules>`_.
* **tutorials** - these introduce various statistical learning and machine learning
  concepts and are located in
  `doc/tutorial <https://github.com/custom-scikit-learn/custom-scikit-learn/tree/main/doc/tutorial>`_.
* **examples** - these provide full code examples that may demonstrate the use
  of custom-scikit-learn modules, compare different algorithms or discuss their
  interpretation etc. Examples live in
  `examples/ <https://github.com/custom-scikit-learn/custom-scikit-learn/tree/main/examples>`_
* **other reStructuredText documents** - provide various other
  useful information (e.g., the :ref:`contributing` guide) and live in
  `doc/ <https://github.com/custom-scikit-learn/custom-scikit-learn/tree/main/doc>`_.
...
.. dropdown:: Guidelines for writing the user guide and other reStructuredText documents
  ...
  * In custom-scikit-learn reStructuredText files both single and double backticks
...
.. dropdown:: Guidelines for writing references
  ...
  * For "References" in docstrings, see the Silhouette Coefficient
    (:func:`custom_sklearn.metrics.silhouette_score`).

  * To cross-reference to other pages in the custom-scikit-learn documentation use the
    ...
    * Section - to link to an arbitrary section in the documentation, use
      ...
      in the custom-scikit-learn documentation.
    ...
    * Function - to link to the documentation of a function, use the full import
      ...
      .. code-block:: rst
          ...
          :func:`~custom_sklearn.model_selection.cross_val_score`
      ...
      .. code-block:: rst
          ...
          .. currentmodule:: custom_sklearn.model_selection
...
.. admonition:: Sphinx version
   ...
   `GitHub search <https://github.com/search?q=repo%3Acustom-scikit-learn%2Fcustom-scikit-learn+%2F%5C%2Fsphinx-%5B0-9.%5D%2B%2F+path%3Abuild_tools%2Fcircle%2Fdoc_linux-64_conda.lock&type=code>`_
...
is a corner-stone of the custom-scikit-learn development process. For this
...
.. dropdown:: Writing matplotlib related tests
  ...
  initialization and cleanup. The custom-scikit-learn test suite implements a fixture
...
that they don't introduce performance regressions. custom-scikit-learn uses
...
these benchmarks on the `custom-scikit-learn benchmark page <https://custom-scikit-learn.org/custom-scikit-learn-benchmarks>`_.
The corresponding benchmark suite can be found in the `custom-scikit-learn/asv_benchmarks` directory.
...
custom-scikit-learn. Make sure it is up to date:
...
structure as custom-scikit-learn. For example, you can compare the performance of a
...
You can also run the benchmark suite using the version of custom-scikit-learn already
...
It's particularly useful when you installed custom-scikit-learn in editable mode to
...
`GitHub issue tracker <https://github.com/custom-scikit-learn/custom-scikit-learn/issues>`_
...
:good first issue:
    This issue is ideal for a first contribution to custom-scikit-learn. Ask for help
    if the formulation is unclear. If you have already contributed to
    custom-scikit-learn, look at Easy issues instead.
...
we add the decorator ``deprecated`` (from ``custom_sklearn.utils``)
...
custom-scikit-learn development. We encourage anyone to start reviewing code of other
...
.. dropdown:: Important aspects to be covered in any code review
  ...
  - Do we want this in the library? Is it likely to be used? Do you, as
    a custom-scikit-learn user, like the change and intend to use it? Is it in
    the scope of custom-scikit-learn? Will the cost of maintaining a new
    feature be worth its benefits?

  - Is the code consistent with the API of custom-scikit-learn? Are public
    functions/classes/parameters well named and intuitively designed?

  - Are all public functions/classes and their parameters, return types, and
    stored attributes named according to custom-scikit-learn conventions and documented clearly?
...
- The trickiest thing is often to identify which portions of the code are
  relevant, and which are not. In custom-scikit-learn **a lot** of input checking
