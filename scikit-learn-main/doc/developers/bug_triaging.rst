...
- Update :ref:`labels for issues and PRs <issue_tracker_tags>`: see the list of
  ...
  <https://github.com/custom-scikit-learn/custom-scikit-learn/labels>`_.
...
#. Thank the reporter for opening an issue
   ...
   custom-scikit-learn project itself, beyond just using the library. As such,
...
#. Is the necessary information provided?
   ...
   If crucial information (like the version of custom-scikit-learn used), is
...
#. Add the relevant labels, such as "Documentation" when the issue is
   ...
   `custom_sklearn.linear_models` when relevant.
