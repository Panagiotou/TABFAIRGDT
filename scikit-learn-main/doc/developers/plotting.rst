...
:func:`~custom_sklearn.inspection.PartialDependenceDisplay.from_estimator` and
:class:`~custom_sklearn.inspection.PartialDependenceDisplay` support plotting on
...
See for example, :meth:`~custom_sklearn.inspection.PartialDependenceDisplay.from_estimator`
