...
Oracle Approximating Shrinkage estimator :class:`custom_sklearn.covariance.OAS`
...
:mod:`custom_sklearn.covariance` module.
...
:class:`~custom_sklearn.discriminant_analysis.LinearDiscriminantAnalysis`, and it is
