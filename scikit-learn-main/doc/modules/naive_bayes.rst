...
instance with the help of :class:`~custom_sklearn.preprocessing.OrdinalEncoder`) such
...
For an overview of available strategies in custom-scikit-learn, see also the
