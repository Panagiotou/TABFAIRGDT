...
Random Projection
==================
.. currentmodule:: custom_sklearn.random_projection

The :mod:`custom_sklearn.random_projection` module implements a simple and
...
bounded distortion introduced by the random projection::
  ...
  >>> from custom_sklearn.random_projection import johnson_lindenstrauss_min_dim
...
projection transformer::
  ...
  >>> import numpy as np
  >>> from custom_sklearn import random_projection
