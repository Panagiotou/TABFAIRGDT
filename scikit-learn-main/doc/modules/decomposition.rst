...
.. currentmodule:: custom_sklearn.decomposition
...
custom-scikit-learn, :class:`PCA` is implemented as a *transformer* object
...
.. dropdown:: About truncated SVD and latent semantic analysis (LSA)
    ...
    (as returned by :class:`~custom_sklearn.feature_extraction.text.CountVectorizer` or
    ...
    .. note::
        ...
        We present LSA in a different way that matches the custom-scikit-learn API better,
...
implemented in custom-scikit-learn using the :class:`Fast ICA <FastICA>`
...
uses an elementwise L1 norm. As in :class:`~custom_sklearn.linear_model.ElasticNet`,
...
stored components::
    ...
    >>> from custom_sklearn.decomposition import NMF
...
non negative matrix factorization (i.e. :class:`~custom_sklearn.decomposition.NMF`),
