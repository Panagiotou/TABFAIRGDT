...
.. currentmodule:: custom_sklearn.calibration
...
.. note::
    ...
    :func:`custom_sklearn.metrics.brier_score_loss` and
    :func:`custom_sklearn.metrics.log_loss` assess calibration (reliability) and
...
In custom-scikit-learn, this is accomplished by binning the predictions such that the x-axis
...
.. currentmodule:: custom_sklearn.naive_bayes
...
a step-wise non-decreasing function, see :mod:`custom_sklearn.isotonic`. It minimizes:
