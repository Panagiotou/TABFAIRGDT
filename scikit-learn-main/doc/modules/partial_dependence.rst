...
.. currentmodule:: custom_sklearn.inspection
...
The :mod:`custom_sklearn.inspection` module provides a convenience function
...
:func:`custom_sklearn.inspection.partial_dependence` function::
...
:func:`custom_sklearn.inspection.partial_dependence` gives the actual values
...
with a :class:`~custom_sklearn.ensemble.HistGradientBoostingRegressor`:.
...
The :mod:`custom_sklearn.inspection` module's :meth:`PartialDependenceDisplay.from_estimator`
