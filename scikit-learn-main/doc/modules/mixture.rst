...
.. currentmodule:: custom_sklearn.mixture

``custom_sklearn.mixture`` is a package which enables one to learn
...
custom-scikit-learn implements different classes to estimate Gaussian
