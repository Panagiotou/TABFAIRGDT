...
.. currentmodule:: custom_sklearn.semi_supervised
...
semi-supervised estimators in :mod:`custom_sklearn.semi_supervised` are able to
...
`custom-scikit-learn` provides two label propagation models:
