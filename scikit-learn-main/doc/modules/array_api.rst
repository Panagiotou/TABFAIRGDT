...
custom-scikit-learn's Array API support requires
`array-api-compat <https://github.com/data-apis/array-api-compat>`__ to be installed.

Some custom-scikit-learn estimators that primarily rely on NumPy (as opposed to using
...
.. note::
    ...
    are known to work with custom-scikit-learn's estimators.
...
transfers an estimator attributes from Array API to a ndarray::
    ...
    >>> from custom_sklearn.utils._array_api import _estimator_with_converted_arrays
...
Estimators and other tools in custom-scikit-learn that support Array API compatible inputs.
...
- :func:`custom_sklearn.metrics.accuracy_score`
- :func:`custom_sklearn.metrics.mean_absolute_error`
- :func:`custom_sklearn.metrics.mean_tweedie_deviance`
- :func:`custom_sklearn.metrics.pairwise.cosine_similarity`
- :func:`custom_sklearn.metrics.r2_score`
- :func:`custom_sklearn.metrics.zero_one_loss`
...
<https://github.com/custom-scikit-learn/custom-scikit-learn/issues/22352>`_ to track progress.
...
At the time of writing all custom-scikit-learn tests should pass, however, the
