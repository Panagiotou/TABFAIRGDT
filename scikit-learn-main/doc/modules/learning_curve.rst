...
:class:`~custom_sklearn.model_selection.ValidationCurveDisplay` is more direct than
using matplotlib manually on the results of a call to :func:`validation_curve`.
You can use the method
:meth:`~custom_sklearn.model_selection.ValidationCurveDisplay.from_estimator` similarly
...
:class:`~custom_sklearn.model_selection.LearningCurveDisplay` will be easier to use.
You can use the method
:meth:`~custom_sklearn.model_selection.LearningCurveDisplay.from_estimator` similarly
