...
.. currentmodule:: custom_sklearn.covariance
...
:mod:`custom_sklearn.covariance` package provides tools for accurately estimating
...
In custom-scikit-learn, this transformation (with a user-defined shrinkage
...
:mod:`custom_sklearn.covariance` package, or it can be otherwise obtained by
...
with the :meth:`oas` function of the :mod:`custom_sklearn.covariance`
...
The ``custom_sklearn.covariance`` package implements a robust estimator of covariance,
...
in custom-scikit-learn when fitting an MCD object to data. The FastMCD
