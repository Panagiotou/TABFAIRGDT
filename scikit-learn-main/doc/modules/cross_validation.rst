...
In custom-scikit-learn a random split into training and test sets
...
<custom_sklearn.base.ClassifierMixin>`.
...
.. dropdown:: Data transformation with held-out data
  ...
  A :class:`Pipeline <custom_sklearn.pipeline.Pipeline>` makes it easier to compose
...
predefined scorer names::
    ...
    >>> from custom_sklearn.metrics import recall_score
...
:class:`KFold`.
  ...
  >>> from custom_sklearn.model_selection import StratifiedKFold, KFold
  >>> import numpy as np
...
:func:`~custom_sklearn.model_selection.permutation_test_score` offers another way
...
:func:`~custom_sklearn.model_selection.permutation_test_score` generates a null
...
samples.
:func:`~custom_sklearn.model_selection.permutation_test_score` provides information
...
Finally, :func:`~custom_sklearn.model_selection.permutation_test_score` is computed
