...
The support vector machines in custom-scikit-learn support both dense
...
.. note::
  ...
  via the :class:`~custom_sklearn.calibration.CalibratedClassifierCV` (see
  ...
  not rely on custom-scikit-learn's
...
* **Avoiding data copy**: For :class:`SVC`, :class:`SVR`, :class:`NuSVC` and
  ...
  <custom_sklearn.linear_model.LogisticRegression>`) any input passed as a numpy
  ...
  <custom_sklearn.linear_model.SGDClassifier>` class instead.  The objective
...
* Support Vector Machine algorithms are not scale invariant, so **it
  ...
  easily by using a :class:`~custom_sklearn.pipeline.Pipeline`::
...
is advised to use :class:`~custom_sklearn.model_selection.GridSearchCV` with
...
.. note::
    ...
    estimator used is :class:`~custom_sklearn.linear_model.Ridge` regression,
