...
.. currentmodule:: custom_sklearn.tree
...
- Able to handle both numerical and categorical data. However, the custom-scikit-learn
...
.. dropdown:: Alternative ways to export trees
  ...
  of external libraries and is more compact:
      ...
      >>> from custom_sklearn.tree import export_text
      >>> iris = load_iris()
...
from each other? Which one is implemented in custom-scikit-learn?
...
custom-scikit-learn uses an optimized version of the CART algorithm; however, the
custom-scikit-learn implementation does not support categorical variables for now.
...
nodes. Alternatively, custom-scikit-learn uses the total sample weighted impurity of
