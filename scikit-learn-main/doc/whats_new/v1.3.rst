...
:mod:`custom_sklearn.decomposition`
............................
...
:mod:`custom_sklearn.calibration`
..........................
...
:mod:`custom_sklearn.cross_decomposition`
..................................
...
:mod:`custom_sklearn.feature_selection`
................................
...
- |Fix| Reintroduce `custom_sklearn.neighbors.BallTree.valid_metrics` and
  `custom_sklearn.neighbors.KDTree.valid_metrics` as public class attributes.
  :pr:`26754` by :user:`Julien Jerphanion <jjerphan>`.

- |Fix| :class:`custom_sklearn.model_selection.HalvingRandomSearchCV` no longer raises
...
:mod:`custom_sklearn.preprocessing`
............................
...
- |Enhancement| Added a multi-threaded Cython routine to the compute squared
  ...
  - :func:`custom_sklearn.metrics.pairwise_distances_argmin`
  - :func:`custom_sklearn.metrics.pairwise_distances_argmin_min`
  - :class:`custom_sklearn.cluster.AffinityPropagation`
  - :class:`custom_sklearn.cluster.Birch`
  - :class:`custom_sklearn.cluster.MeanShift`
  - :class:`custom_sklearn.cluster.OPTICS`
  - :class:`custom_sklearn.cluster.SpectralClustering`
  - :func:`custom_sklearn.feature_selection.mutual_info_regression`
  - :class:`custom_sklearn.neighbors.KNeighborsClassifier`
  - :class:`custom_sklearn.neighbors.KNeighborsRegressor`
  - :class:`custom_sklearn.neighbors.RadiusNeighborsClassifier`
  - :class:`custom_sklearn.neighbors.RadiusNeighborsRegressor`
  - :class:`custom_sklearn.neighbors.LocalOutlierFactor`
  - :class:`custom_sklearn.neighbors.NearestNeighbors`
  - :class:`custom_sklearn.manifold.Isomap`
  - :class:`custom_sklearn.manifold.LocallyLinearEmbedding`
  - :class:`custom_sklearn.manifold.TSNE`
  - :func:`custom_sklearn.manifold.trustworthiness`
  - :class:`custom_sklearn.semi_supervised.LabelPropagation`
  - :class:`custom_sklearn.semi_supervised.LabelSpreading`
  ...
  For instance, :meth:`custom_sklearn.neighbors.NearestNeighbors.kneighbors` is now up
...
- |MajorFeature| :ref:`Metadata routing <metadata_routing>`'s related base
  ...
  :func:`custom_sklearn.set_config` and :func:`custom_sklearn.config_context`. For now this
...
- |Feature| Added a new option `skip_parameter_validation`, to the function
  :func:`custom_sklearn.set_config` and context manager :func:`custom_sklearn.config_context`, that
...
:mod:`custom_sklearn.base`
...................

- |Feature| A `__custom_sklearn_clone__` protocol is now available to override the
...
:mod:`custom_sklearn.discriminant_analysis`
....................................
...
- |Efficiency| :class:`ensemble.IsolationForest` predict time is now faster
  ...
  to load an estimator trained with custom-scikit-learn 1.2 to make it predict with
  custom-scikit-learn 1.3: retraining with custom-scikit-learn 1.3 is required.
...
:mod:`custom_sklearn.exceptions`
.........................

- |Feature| Added :class:`exceptions.InconsistentVersionWarning` which is raised
  when a custom-scikit-learn estimator is unpickled with a custom-scikit-learn version that is
  inconsistent with the sckit-learn version the estimator was pickled with.
  :pr:`25297` by `Thomas Fan`_.

:mod:`custom_sklearn.feature_extraction`
.................................

- |API| :class:`feature_extraction.image.PatchExtractor` now follows the
  transformer API of custom-scikit-learn. This class is defined as a stateless transformer
...
- |Enhancement| All selectors in :mod:`custom_sklearn.feature_selection` will preserve
...
:mod:`custom_sklearn.kernel_approximation`
...................................
...
:mod:`custom_sklearn.linear_model`
...........................
...
- |API| Deprecates `n_iter` in favor of `max_iter` in
  ...
  `n_iter` will be removed in custom-scikit-learn 1.5. This change makes those
  estimators consistent with the rest of estimators.
  :pr:`25697` by :user:`John Pangas <jpangas>`.

:mod:`custom_sklearn.manifold`
.......................
...
:mod:`custom_sklearn.gaussian_process`
...............................
...
:mod:`custom_sklearn.multioutput`
..........................
...
:mod:`custom_sklearn.naive_bayes`
..........................
...
:mod:`custom_sklearn.neural_network`
.............................
...
:mod:`custom_sklearn.semi_supervised`
..............................
