...
- :func:`custom_sklearn.metrics.mean_tweedie_deviance` now supports Array API compatible
  inputs.
  :pr:`28106` by :user:`Thomas Li <lithomas1>`;
- :func:`custom_sklearn.metrics.mean_absolute_error` :pr:`27736` by :user:`Edoardo Abati <EdAbati>`;
- :func:`custom_sklearn.metrics.pairwise.cosine_similarity` :pr:`29014` by :user:`Edoardo Abati <EdAbati>`.
