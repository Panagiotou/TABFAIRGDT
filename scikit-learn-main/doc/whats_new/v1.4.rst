...
- |Fix| Fixes a bug for all custom-scikit-learn transformers when using `set_output` with
...
- |Efficiency| :class:`linear_model.LogisticRegression` and
  ...
  This change also means that with this new version of custom-scikit-learn, the resulting
...
- :func:`custom_sklearn.metrics.accuracy_score` and :func:`custom_sklearn.metrics.zero_one_loss` in
  :pr:`27137` by :user:`Edoardo Abati <EdAbati>`;
- :func:`custom_sklearn.model_selection.train_test_split` in :pr:`26855` by `Tim Head`_;
...
- |Fix| The `degree` parameter in the :class:`cluster.SpectralClustering`
  ...
  :class:`custom_sklearn.metrics.pairwise.polynomial_kernel`.
...
:mod:`custom_sklearn.kernel_ridge`
...........................
...
- |Efficiency| :meth:`custom_sklearn.neighbors.KNeighborsRegressor.predict` and
  :meth:`custom_sklearn.neighbors.KNeighborsClassifier.predict_proba` now efficiently support
...
- |Enhancement| :func:`custom_sklearn.utils.estimator_html_repr` dynamically adapts
...
- |Enhancement| Make :func:`custom_sklearn.utils.check_array` attempt to output
...
- |Fix| :func:`custom_sklearn.utils.check_array` should accept both matrix and array from
...
- |API| :func:`custom_sklearn.extmath.log_logistic` is deprecated and will be removed in 1.6.
...
Ronsin, Sandip Dutta, Sayed Qaiser Ali, scaja, custom-scikit-learn-bot, Sebastian
