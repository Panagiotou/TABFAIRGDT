...
- |Fix| Include `msvcp140.dll` in the custom-scikit-learn wheels since it has been
...
Version 1.1.0 of custom-scikit-learn requires python 3.8+, numpy 1.17.3+ and
...
- |Efficiency| Low-level routines for reductions on pairwise distances
  ...
  For instance :class:`custom_sklearn.neighbors.NearestNeighbors.kneighbors` and
  :class:`custom_sklearn.neighbors.NearestNeighbors.radius_neighbors`
...
- |Enhancement| All custom-scikit-learn models now generate a more informative
...
- |Enhancement| Adds :term:`get_feature_names_out` to all transformers in the
  :mod:`~custom_sklearn.cross_decomposition` module:
...
- |Enhancement| Adds :term:`get_feature_names_out` to all transformers in the
  :mod:`~custom_sklearn.decomposition` module:
  :class:`decomposition.DictionaryLearning`,
...
- |API| Parameters ``sample_weight`` and ``multioutput`` of
  ...
  with `SLEP009 <https://custom-scikit-learn-enhancement-proposals.readthedocs.io/en/latest/slep009/proposal.html>`_.
...
- |API| :class:`metrics.DistanceMetric` has been moved from
  :mod:`custom_sklearn.neighbors` to :mod:`custom_sklearn.metrics`.
...
- |Fix| Defines `__custom_sklearn_is_fitted__` in :class:`pipeline.FeatureUnion` to
...
:mod:`custom_sklearn.random_projection`
................................
...
- |Enhancement| Adds :term:`get_feature_names_out` to all transformers in the
  :mod:`custom_sklearn.random_projection` module:
