...
conventions applied in custom-scikit-learn and its API, while providing a reference
...
.. glossary::
    ...
    API
        ...
        custom-scikit-learn and the *generalized* conventions across types of
        estimators as described in this glossary and :ref:`overviewed in the
        contributor documentation <api_overview>`.

        The specific interfaces that constitute custom-scikit-learn's public API are
    ...
    array-like
        The most common data format for *input* to custom-scikit-learn estimators and
        ...
        * a generator
        ...
        Note that *output* from custom-scikit-learn estimators and functions (e.g.
    ...
    backwards compatibility
        ...
        Serialization
            ...
            subsequent version.  (For estimators in the custom_sklearn package, we
    ...
    categorical feature
        ...
        strings. Strings will be rejected by most custom-scikit-learn
        ...
        :class:`~custom_sklearn.preprocessing.OrdinalEncoder` helps encoding
        string-valued categorical features as ordinal integers, and
        :class:`~custom_sklearn.preprocessing.OneHotEncoder` can be used to
        one-hot encode categorical features.
        See also :ref:`preprocessing_categorical_features` and the
        `categorical-encoding
        <https://github.com/custom-scikit-learn-contrib/category_encoders>`_
    ...
    cloned
        ...
        :term:`attributes`, using :func:`~custom_sklearn.base.clone`.
    ...
    common tests
        ...
        custom-scikit-learn to check they comply with basic API conventions.  They are
        available for external use through
        :func:`utils.estimator_checks.check_estimator`, with most of the
        implementation in ``custom_sklearn/utils/estimator_checks.py``.
    ...
    data type
        ...
        assume simple data types for custom-scikit-learn data: float or integer.
    ...
    examples
        ...
        * as doctests in their docstrings (i.e. within the ``custom_sklearn/`` library
          code itself).
    ...
    evaluation metrics
        ...
        use this term specifically to refer to the functions in :mod:`~custom_sklearn.metrics`
        (disregarding :mod:`~custom_sklearn.metrics.pairwise`), as distinct from the
        ...
        in :mod:`~custom_sklearn.metrics` and are estimator-specific, notably model
        likelihoods.
    ...
    feature vector
        ...
        Nearly all estimators in custom-scikit-learn assume that features are numeric,
    ...
    function
        ...
        In particular, custom-scikit-learn may provide a function interface that fits
    ...
    inductive
        ...
        Most estimators in custom-scikit-learn are inductive, having :term:`predict`
        and/or :term:`transform` methods.

    joblib
        A Python library (https://joblib.readthedocs.io) used in custom-scikit-learn to
    ...
    data leakage
        ...
        We aim to provide interfaces (such as :mod:`~custom_sklearn.pipeline` and
        :mod:`~custom_sklearn.model_selection`) that shield the user from data leakage.
    ...
    memory mapping
        ...
        using :term:`joblib` to parallelize operations in custom-scikit-learn, it
        may automatically memmap large arrays to reduce memory duplication
        overhead in multiprocessing.

    missing values
        Most custom-scikit-learn estimators do not work with missing values. When they
    ...
    narrative documentation
        ...
        * group tools provided by custom-scikit-learn together thematically or in
          terms of usage;
    ...
    custom-scikit-learn-contrib
        A venue for publishing custom-scikit-learn-compatible libraries that are
        broadly authorized by the core developers and the contrib community,
        but not maintained by the core developer team.
        See https://custom-scikit-learn-contrib.github.io.

    custom-scikit-learn enhancement proposals
    SLEP
    SLEPs
        ...
        "custom-scikit-learn Enhancement Proposal" (SLEP), rather than a long discussion on an
        issue. A SLEP must be submitted as a pull-request to
        `enhancement proposals <https://custom-scikit-learn-enhancement-proposals.readthedocs.io>`_ using the
        `SLEP template <https://custom-scikit-learn-enhancement-proposals.readthedocs.io/en/latest/slep_template.html>`_.
    ...
    sparse graph
        ...
        this fact in custom-scikit-learn parameter descriptions.
        ...
        Two semantics for sparse matrices are used in custom-scikit-learn:
    ...
    targets
        ...
        variable*, *response variable*, *ground truth* or *label*. custom-scikit-learn
...
.. glossary::
    ...
    classifiers
        ...
        multioutput` targets.  Within custom-scikit-learn, all classifiers support
...
.. glossary::
    ...
    multi-class
        ...
        Within custom-scikit-learn, all estimators supporting binary classification
    ...
    multi-output multi-class
        ...
        :mod:`~custom_sklearn.multioutput` provides estimators which estimate multi-output
...
.. glossary::
    ...
    ``decision_function``
        ...
        multilabel classification
            custom-scikit-learn is inconsistent in its representation of :term:`multilabel`
...
.. glossary::
    ...
    ``n_jobs``
        ...
        custom-scikit-learn, please refer to our :ref:`parallelism notes
        <parallelism>`.
    ...
    ``random_state``
        Whenever randomization is part of a custom-scikit-learn algorithm, a
        ...
        other function like :func:`~custom_sklearn.cluster.k_means`). `random_state`'s
        value may be:
        ...
        For more details on how to control the randomness of custom-scikit-learn
    ...
    ``verbose``
        Logging is not handled very consistently in custom-scikit-learn at present,
    ...
    ``warm_start``
        ...
        For estimators imported from :mod:`~custom_sklearn.ensemble`,
