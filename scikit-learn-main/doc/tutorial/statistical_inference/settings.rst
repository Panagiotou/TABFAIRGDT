...
==========================================================================
Statistical learning: the setting and the estimator object in custom-scikit-learn
==========================================================================

Datasets
=========

custom-scikit-learn deals with learning information from one or more
...
.. topic:: A simple example shipped with custom-scikit-learn: iris dataset
...
needs to be preprocessed in order to be used by custom-scikit-learn.
...
.. topic:: An example of reshaping data would be the digits dataset
    ...
    To use this dataset with custom-scikit-learn, we transform each 8x8 image into a
...
**Fitting data**: the main API implemented by custom-scikit-learn is that of the
