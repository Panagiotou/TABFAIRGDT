...
custom-scikit-learn has a collection of classes which can be used to generate lists of
...
This example shows an example usage of the ``split`` method.
    ...
    >>> from custom_sklearn.model_selection import KFold, cross_val_score
...
custom-scikit-learn provides an object that, given data, computes the score
...
custom-scikit-learn exposes :ref:`cross_validation` estimators that set their
parameter automatically by cross-validation::

    >>> from custom_sklearn import linear_model, datasets
