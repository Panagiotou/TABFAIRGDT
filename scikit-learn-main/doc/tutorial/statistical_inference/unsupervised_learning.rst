...
::
    ...
    >>> from custom_sklearn import cluster, datasets
...
.. warning::
    ...
    although custom-scikit-learn employs several tricks to mitigate this issue.
...
clustered together by giving a connectivity graph. Graphs in custom-scikit-learn
...
version of the coins image to speed up the process::
    ...
    >>> from custom_sklearn.feature_extraction import grid_to_graph
...
Define the graph structure of the data. Pixels connected to their neighbors::
    ...
    >>> from custom_sklearn.cluster import AgglomerativeClustering
...
::
   ...
   >>> from custom_sklearn import decomposition
