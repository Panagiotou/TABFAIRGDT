...
===========================================
custom-scikit-learn governance and decision-making
===========================================

The purpose of this document is to formalize the governance process used by the
custom-scikit-learn project, to clarify how decisions are made and how the various
...
as being an organization member on the custom-scikit-learn `GitHub organization
<https://github.com/orgs/custom-scikit-learn/people>`_.

They are also welcome to join our `monthly core contributor meetings
<https://github.com/custom-scikit-learn/administrative/tree/master/meeting_notes>`_.
...
on the custom-scikit-learn website.
...
* **Communication Team**
  ...
  for custom-scikit-learn. The goal of the team is to develop public awareness of
  custom-scikit-learn, of its features and usage, as well as branding.

  For this, they can operate the custom-scikit-learn accounts on various social networks
...
* **Documentation Team**
  ...
  To this end, they have permissions to merge pull requests in custom-scikit-learn's
  repository.
...
* **Maintainers Team**
  ...
  community. They have shown they can be trusted to maintain custom-scikit-learn with
...
The Technical Committee of custom-scikit-learn consists of :user:`Thomas Fan
...
place on the project contributors' `mailing list <mailto:custom-scikit-learn@python.org>`_
and the `issue tracker <https://github.com/custom-scikit-learn/custom-scikit-learn/issues>`_.
Occasionally, sensitive discussion occurs on a private list.

custom-scikit-learn uses a "consensus seeking" process for making decisions. The group
...
* **Minor Documentation changes**, such as typo fixes, or addition / correction
  of a sentence, but no change of the ``custom-scikit-learn.org`` landing page or the
...
* **Changes to the governance model** follow the process outlined in `SLEP020
  <https://custom-scikit-learn-enhancement-proposals.readthedocs.io/en/latest/slep020/proposal.html>`__.
...
<https://custom-scikit-learn-enhancement-proposals.readthedocs.io>`_ using the `SLEP
template
<https://custom-scikit-learn-enhancement-proposals.readthedocs.io/en/latest/slep_template.html>`_.
`SLEP000
<https://custom-scikit-learn-enhancement-proposals.readthedocs.io/en/latest/slep000/proposal.html>`__
