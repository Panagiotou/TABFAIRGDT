...
This is an example showing how custom-scikit-learn can be used for classification
...
from custom_sklearn.linear_model import PassiveAggressiveClassifier, Perceptron, SGDClassifier
