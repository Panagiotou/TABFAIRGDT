...
:class:`~custom_sklearn.ensemble.HistGradientBoostingRegressor` on the Bike Sharing
Demand dataset.
...
# :class:`~custom_sklearn.model_selection.train_test_split`) with a proper time
# series evaluation strategy using
# :class:`~custom_sklearn.model_selection.TimeSeriesSplit`. We observed that the
# model trained using :class:`~custom_sklearn.model_selection.train_test_split`,
...
# can be used to extend custom-scikit-learn estimators by making use of recursive time
