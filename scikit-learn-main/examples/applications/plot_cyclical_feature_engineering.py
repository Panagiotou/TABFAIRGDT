...
the :class:`custom_sklearn.preprocessing.SplineTransformer` class and its
...
# :class:`~custom_sklearn.ensemble.HistGradientBoostingRegressor` with native support
...
# :class:`~custom_sklearn.preprocessing.MinMaxScaler`, although in this case it does not
# impact the results much because they are already on comparable scales:
from custom_sklearn.linear_model import RidgeCV
from custom_sklearn.preprocessing import MinMaxScaler, OneHotEncoder
...
# :func:`custom_sklearn.preprocessing.KBinsDiscretizer` instead to re-bin the number
...
from custom_sklearn.metrics import PredictionErrorDisplay
...
# :class:`~custom_sklearn.neural_network.MLPRegressor` with one or two hidden layers
