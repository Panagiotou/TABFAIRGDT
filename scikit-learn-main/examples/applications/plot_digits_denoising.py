...
This example shows how to use :class:`~custom_sklearn.decomposition.KernelPCA` to
...
# :func:`~custom_sklearn.datasets.fetch_openml` to get this dataset. In addition, we
