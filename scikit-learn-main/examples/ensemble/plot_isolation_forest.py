...
An example using :class:`~custom_sklearn.ensemble.IsolationForest` for anomaly
detection.
...
# slightly deformed.
#
# For consistency with the :class:`~custom_sklearn.ensemble.IsolationForest` notation,
...
# -------------------------------
#
# We use the class :class:`~custom_sklearn.inspection.DecisionBoundaryDisplay` to
...
# :class:`~custom_sklearn.inspection.DecisionBoundaryDisplay` represents the measure of
