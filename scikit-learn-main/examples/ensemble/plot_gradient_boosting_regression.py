...
:class:`~custom_sklearn.ensemble.GradientBoostingRegressor` with least squares loss
and 500 regression trees of depth 4.

Note: For larger datasets (n_samples >= 10000), please refer to
:class:`~custom_sklearn.ensemble.HistGradientBoostingRegressor`. See
...
from custom_sklearn import datasets, ensemble
