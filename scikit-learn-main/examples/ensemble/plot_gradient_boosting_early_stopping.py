...
# -----------------------------
# Two :class:`~custom_sklearn.ensemble.GradientBoostingRegressor` models are trained:
...
# Error Calculation
# -----------------
# The code calculates the :func:`~custom_sklearn.metrics.mean_squared_error` for both
...
# Summary
# -------
# In our example with the :class:`~custom_sklearn.ensemble.GradientBoostingRegressor`
