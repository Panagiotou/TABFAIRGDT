...
# distribution).
from custom_sklearn.datasets import make_gaussian_quantiles
...
# ---------------------------------
# We train the :class:`~custom_sklearn.ensemble.AdaBoostClassifier`. The estimator
...
# :class:`~custom_sklearn.tree.DecisionTreeClassifier` and set the maximum number of
...
# :class:`~custom_sklearn.ensemble.AdaBoostClassifier` then uses the correct or
...
# :class:`~custom_sklearn.tree.DecisionTreeClassifier`), which serves as a reference
# point. The second baseline score is obtained from the
# :class:`~custom_sklearn.dummy.DummyClassifier`, which predicts the most prevalent
# class in a dataset.
...
# %%
# After training the :class:`~custom_sklearn.tree.DecisionTreeClassifier` model, the
...
# :class:`~custom_sklearn.dummy.DummyClassifier` does.
#
# Now, we calculate the `misclassification_error`, i.e. `1 - accuracy`, of the
# additive model (:class:`~custom_sklearn.tree.DecisionTreeClassifier`) at each
# boosting iteration on the test set to assess its performance.
#
# We use :meth:`~custom_sklearn.ensemble.AdaBoostClassifier.staged_predict` that makes
...
#
# The convergence of :class:`~custom_sklearn.ensemble.AdaBoostClassifier` is mainly
...
#
# We use the fitted :class:`~custom_sklearn.ensemble.AdaBoostClassifier`'s attributes
