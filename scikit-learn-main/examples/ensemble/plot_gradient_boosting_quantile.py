...
from custom_sklearn.metrics import mean_pinball_loss, mean_squared_error
...
# %%
# Notice that :class:`~custom_sklearn.ensemble.HistGradientBoostingRegressor` is much
# faster than :class:`~custom_sklearn.ensemble.GradientBoostingRegressor` starting with
...
# -----------------------------
#
# Measure the models with :func:`~custom_sklearn.metrics.mean_squared_error` and
# :func:`~custom_sklearn.metrics.mean_pinball_loss` metrics on the training dataset.
import pandas as pd
