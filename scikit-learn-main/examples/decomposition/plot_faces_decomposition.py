...
:mod:`custom_sklearn.decomposition` (see the documentation chapter
:ref:`decompositions`).
...
from custom_sklearn import cluster, decomposition
from custom_sklearn.datasets import fetch_olivetti_faces
...
# .. note::
#
#     The Eigenfaces estimator, via the :py:mod:`custom_sklearn.decomposition.PCA`,
...
# ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
#
# Mini-batch sparse PCA (:class:`~custom_sklearn.decomposition.MiniBatchSparsePCA`)
...
# :class:`~custom_sklearn.decomposition.SparsePCA`.
...
# ^^^^^^^^^^^^^^^^^^^
#
# By default, :class:`~custom_sklearn.decomposition.MiniBatchDictionaryLearning`
...
# ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
#
# :class:`custom_sklearn.cluster.MiniBatchKMeans` is computationally efficient and
# implements on-line learning with a
# :meth:`~custom_sklearn.cluster.MiniBatchKMeans.partial_fit` method. That is
...
# ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
#
# :class:`~custom_sklearn.decomposition.FactorAnalysis` is similar to
# :class:`~custom_sklearn.decomposition.PCA` but has the advantage of modelling the
...
#
# :class:`~custom_sklearn.decomposition.MiniBatchDictionaryLearning` implements a
...
# :class:`~custom_sklearn.decomposition.MiniBatchDictionaryLearning` estimator on all
