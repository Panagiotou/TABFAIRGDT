...
learned by :class:`~custom_sklearn.discriminant_analysis.LinearDiscriminantAnalysis` (LDA) and
:class:`~custom_sklearn.discriminant_analysis.QuadraticDiscriminantAnalysis` (QDA). The
...
# i.e., :class:`~custom_sklearn.discriminant_analysis.LinearDiscriminantAnalysis` (LDA) and
# :class:`~custom_sklearn.discriminant_analysis.QuadraticDiscriminantAnalysis` (QDA). The
...
from custom_sklearn.discriminant_analysis import (
