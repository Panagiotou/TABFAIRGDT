...
it using the :class:`~custom_sklearn.cluster.SpectralBiclustering` algorithm. The
...
# :func:`~custom_sklearn.datasets.make_checkerboard` function. Each pixel within
...
# :class:`~custom_sklearn.cluster.SpectralBiclustering`.
import numpy as np
...
from custom_sklearn.cluster import SpectralBiclustering
from custom_sklearn.metrics import consensus_score
...
# :class:`~custom_sklearn.cluster.SpectralBiclustering` model in ascending order and
