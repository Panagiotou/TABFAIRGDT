...
# ---------------
#
# We use :class:`~custom_sklearn.datasets.make_blobs` to create 3 synthetic clusters.
...
# --------------
#
# One can access the labels assigned by :class:`~custom_sklearn.cluster.DBSCAN` using
...
# However, since :class:`~custom_sklearn.datasets.make_blobs` gives access to the true
