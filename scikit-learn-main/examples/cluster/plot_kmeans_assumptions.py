...
# ---------------
#
# The function :func:`~custom_sklearn.datasets.make_blobs` generates isotropic
...
# :class:`~custom_sklearn.cluster.KMeans` behaves in the following scenarios:
#
...
# :class:`~custom_sklearn.mixture.GaussianMixture`, which also assumes gaussian
