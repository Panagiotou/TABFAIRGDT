...
def bench_k_means(kmeans, name, data, labels):
    ...
    kmeans : KMeans instance
        A :class:`~custom_sklearn.cluster.KMeans` instance with the initialization
        already set.
    name : str
...
# * an initialization based on a :class:`~custom_sklearn.decomposition.PCA`
#   projection. Indeed, we will use the components of the
#   :class:`~custom_sklearn.decomposition.PCA` to initialize KMeans. This method is
...
# -----------------------------------------
#
# :class:`~custom_sklearn.decomposition.PCA` allows to project the data from the
# original 64-dimensional space into a lower dimensional space. Subsequently,
# we can use :class:`~custom_sklearn.decomposition.PCA` to project into a
