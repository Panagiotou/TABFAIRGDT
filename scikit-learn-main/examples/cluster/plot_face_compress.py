...
This example shows how one can use :class:`~custom_sklearn.preprocessing.KBinsDiscretizer`
...
# :class:`~custom_sklearn.preprocessing.KBinsDiscretizer`. We need to choose a strategy
...
from custom_sklearn.preprocessing import KBinsDiscretizer
...
# %%
# Indeed, the output of the :class:`~custom_sklearn.preprocessing.KBinsDiscretizer` is
