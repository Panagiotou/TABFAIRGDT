...
:class:`~custom_sklearn.compose.ColumnTransformer` on a dataset containing
...
# :class:`~custom_sklearn.preprocessing.FunctionTransformer` to create a custom-scikit-learn
# transformer.
