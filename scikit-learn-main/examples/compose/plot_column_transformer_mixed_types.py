...
from custom_sklearn.model_selection import RandomizedSearchCV, train_test_split
...
# :func:`custom_sklearn.compose.make_column_selector` gives this possibility.
...
# :class:`~custom_sklearn.model_selection.RandomizedSearchCV`. This
...
# :class:`~custom_sklearn.model_selection.GridSearchCV` but the cartesian product of
