...
:class:`~custom_sklearn.compose.TransformedTargetRegressor`. We use two examples
...
from custom_sklearn.metrics import median_absolute_error, r2_score
...
# %%
# A :class:`~custom_sklearn.preprocessing.QuantileTransformer` is used to normalize
# the target distribution before applying a
# :class:`~custom_sklearn.linear_model.RidgeCV` model.
f, (ax0, ax1) = plt.subplots(1, 2)
