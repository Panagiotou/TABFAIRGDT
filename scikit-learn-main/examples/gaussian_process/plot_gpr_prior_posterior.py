...
:class:`~custom_sklearn.gaussian_process.GaussianProcessRegressor` with different
...
# :class:`~custom_sklearn.gaussian_process.GaussianProcessRegressor` model and will
...
def plot_gpr_samples(gpr_model, n_samples, ax):
    ...
    gpr_model : `GaussianProcessRegressor`
        A :class:`~custom_sklearn.gaussian_process.GaussianProcessRegressor` model.
    n_samples : int
...
# Dot-product kernel
# ..................
from custom_sklearn.gaussian_process.kernels import ConstantKernel, DotProduct
