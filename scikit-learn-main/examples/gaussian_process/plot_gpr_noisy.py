...
:class:`~custom_sklearn.gaussian_process.kernels.WhiteKernel` to estimate the noise
...
# :class:`~custom_sklearn.gaussian_process.GaussianProcessRegressor`
# using an additive kernel adding a
# :class:`~custom_sklearn.gaussian_process.kernels.RBF` and
# :class:`~custom_sklearn.gaussian_process.kernels.WhiteKernel` kernels.
# The :class:`~custom_sklearn.gaussian_process.kernels.WhiteKernel` is a kernel that
# will able to estimate the amount of noise present in the data while the
# :class:`~custom_sklearn.gaussian_process.kernels.RBF` will serve at fitting the
...
from custom_sklearn.gaussian_process.kernels import RBF, WhiteKernel
...
# :class:`~custom_sklearn.gaussian_process.kernels.RBF` with a
# larger `length_scale` and the
# :class:`~custom_sklearn.gaussian_process.kernels.WhiteKernel`
