...
This is an example showing how custom-scikit-learn can be used to classify documents by
...
# :class:`~custom_sklearn.linear_model.RidgeClassifier` class. This is a linear
# classification model that uses the mean squared error on {-1, 1} encoded
# targets, one for each possible class. Contrary to
# :class:`~custom_sklearn.linear_model.LogisticRegression`,
# :class:`~custom_sklearn.linear_model.RidgeClassifier` does not
...
from custom_sklearn.metrics import ConfusionMatrixDisplay
...
# -----------------------------
#
# The `remove` option of the 20 newsgroups dataset loader in custom-scikit-learn allows
...
# ========================
#
# custom-scikit-learn provides many different kinds of classification algorithms. In
...
from custom_sklearn.utils.extmath import density
...
from custom_sklearn.neighbors import KNeighborsClassifier, NearestCentroid
