...
:class:`~custom_sklearn.covariance.EmpiricalCovariance`. It is unbiased, i.e. it
...
from custom_sklearn.covariance import ShrunkCovariance, empirical_covariance, log_likelihood
...
#   criterion), yielding the :class:`~custom_sklearn.covariance.LedoitWolf`
#   covariance estimate.
#
# * An improvement of the Ledoit-Wolf shrinkage, the
#   :class:`~custom_sklearn.covariance.OAS`, proposed by Chen et al. Its
#   convergence is significantly better under the assumption that the data
#   are Gaussian, in particular for small samples.


from custom_sklearn.covariance import OAS, LedoitWolf
