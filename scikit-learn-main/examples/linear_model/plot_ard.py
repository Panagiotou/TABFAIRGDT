...
from custom_sklearn.linear_model import ARDRegression, BayesianRidge, LinearRegression
...
# :class:`~custom_sklearn.linear_model.ARDRegression` and
# :class:`~custom_sklearn.linear_model.BayesianRidge`, then
# :class:`~custom_sklearn.preprocessing.PolynomialFeatures` should not introduce an
