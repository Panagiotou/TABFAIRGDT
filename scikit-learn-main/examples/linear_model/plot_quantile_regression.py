...
# :class:`~custom_sklearn.linear_model.LinearRegression` less efficient, i.e. we need
...
# :class:`~custom_sklearn.linear_model.QuantileRegressor` can be used in practice and
# give the intuition into the properties of the fitted models. Finally,
# we will compare the both :class:`~custom_sklearn.linear_model.QuantileRegressor`
# and :class:`~custom_sklearn.linear_model.LinearRegression`.
#
...
from custom_sklearn.utils.fixes import parse_version, sp_version
...
# %%
from custom_sklearn.linear_model import QuantileRegressor
...
# :class:`~custom_sklearn.linear_model.QuantileRegressor` and
# :class:`~custom_sklearn.linear_model.LinearRegression` are minimizing.
#
# Indeed, :class:`~custom_sklearn.linear_model.LinearRegression` is a least squares
# approach minimizing the mean squared error (MSE) between the training and
# predicted targets. In contrast,
# :class:`~custom_sklearn.linear_model.QuantileRegressor` with `quantile=0.5`
...
from custom_sklearn.metrics import mean_absolute_error, mean_squared_error
...
# :class:`~custom_sklearn.linear_model.QuantileRegressor` than
# :class:`~custom_sklearn.linear_model.LinearRegression`. In contrast to that, MSE is
# lower for :class:`~custom_sklearn.linear_model.LinearRegression` than
# :class:`~custom_sklearn.linear_model.QuantileRegressor`. These results confirms that
# MAE is the loss minimized by :class:`~custom_sklearn.linear_model.QuantileRegressor`
# while MSE is the loss minimized
# :class:`~custom_sklearn.linear_model.LinearRegression`.
#
