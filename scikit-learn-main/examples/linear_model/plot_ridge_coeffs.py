...
:class:`~custom_sklearn.linear_model.Ridge` regression affects a model's performance by
...
# ****************************
# We use :class:`~custom_sklearn.linear_model.Ridge`, a linear model with L2
...
#
# Here, we saw that :class:`~custom_sklearn.linear_model.Ridge` adds a penalty to the
...
# :class:`~custom_sklearn.linear_model.HuberRegressor`. You can learn more about it in
