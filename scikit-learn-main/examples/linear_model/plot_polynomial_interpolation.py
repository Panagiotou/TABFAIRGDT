...
- :class:`~custom_sklearn.preprocessing.PolynomialFeatures` generates all monomials
...
- :class:`~custom_sklearn.preprocessing.SplineTransformer` generates B-spline basis
...
from custom_sklearn.preprocessing import PolynomialFeatures, SplineTransformer
