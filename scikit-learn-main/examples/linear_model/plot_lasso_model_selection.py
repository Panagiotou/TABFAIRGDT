...
# --------------------------------------------
# :class:`~custom_sklearn.linear_model.LassoLarsIC` provides a Lasso estimator that
...
# :class:`~custom_sklearn.preprocessing.StandardScaler`. In addition, we will
...
#
# In custom-scikit-learn, two different estimators are available with integrated
# cross-validation: :class:`~custom_sklearn.linear_model.LassoCV` and
# :class:`~custom_sklearn.linear_model.LassoLarsCV` that respectively solve the
