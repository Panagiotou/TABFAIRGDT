...
:class:`~custom_sklearn.linear_model.LassoLarsIC` estimator is fit on a
...
.. note::
    ...
    :class:`~custom_sklearn.linear_model.LassoLarsIC` relies on the AIC or BIC
...
# %%
# custom-scikit-learn provides an estimator called
# :class:`~custom_sklearn.linear_model.LassoLarsIC` that uses either Akaike's
...
from custom_sklearn.linear_model import LassoLarsIC
