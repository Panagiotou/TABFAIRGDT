# Authors: The custom-scikit-learn developers
...
# :class:`~custom_sklearn.linear_model.Ridge`) we ignore the corresponding samples,
# meaning that the obtained Poisson deviance is approximate. An alternative
# approach could be to use :class:`~custom_sklearn.compose.TransformedTargetRegressor`
...
# integer using :class:`~custom_sklearn.preprocessing.OrdinalEncoder`. With this
...
# :class:`~custom_sklearn.preprocessing.OrdinalEncoder` over the
# :class:`~custom_sklearn.preprocessing.OneHotEncoder` is that it will make training
# faster.
#
...
from custom_sklearn.utils import gen_even_slices
...
from custom_sklearn.metrics import auc
...
# (:func:`~custom_sklearn.preprocessing.PolynomialFeatures`) indeed increases their
