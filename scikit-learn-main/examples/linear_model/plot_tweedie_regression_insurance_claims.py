...
#   more than one claim.
from custom_sklearn.linear_model import GammaRegressor
...
# :class:`~custom_sklearn.linear_model.GammaRegressor` is able to leverage some
...
#
# The :func:`custom_sklearn.metrics.mean_tweedie_deviance` depends on a `power`
...
# maintain as it consists of a single custom-scikit-learn estimator instead of a pair
