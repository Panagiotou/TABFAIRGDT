...
:class:`~custom_sklearn.ensemble.RandomForestClassifier` with the
permutation importance on the titanic dataset using
:func:`~custom_sklearn.inspection.permutation_importance`. We will show that the
...
#
# - use :class:`~custom_sklearn.preprocessing.OrdinalEncoder` to encode the
#   categorical features;
# - use :class:`~custom_sklearn.impute.SimpleImputer` to fill missing values for
