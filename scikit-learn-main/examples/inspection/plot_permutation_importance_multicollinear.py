...
:func:`~custom_sklearn.inspection.permutation_importance` of the features to a trained
:class:`~custom_sklearn.ensemble.RandomForestClassifier` using the
...
# %%
# We then train a :class:`~custom_sklearn.ensemble.RandomForestClassifier` on the
...
# custom-scikit-learn implementation of
# :class:`~custom_sklearn.ensemble.RandomForestClassifier` uses a random subsets of
