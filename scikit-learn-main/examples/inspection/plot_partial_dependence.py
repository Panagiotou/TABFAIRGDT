...
:class:`~custom_sklearn.neural_network.MLPRegressor` and a
:class:`~custom_sklearn.ensemble.HistGradientBoostingRegressor` trained on the
...
# :class:`~custom_sklearn.neural_network.MLPRegressor` and a
# :class:`~custom_sklearn.ensemble.HistGradientBoostingRegressor`, we create two different
# preprocessors, specific for each model.
#
# Preprocessor for the neural network model
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#
# We will use a :class:`~custom_sklearn.preprocessing.QuantileTransformer` to scale the
...
from custom_sklearn.preprocessing import OneHotEncoder, QuantileTransformer
...
# :class:`~custom_sklearn.preprocessing.OrdinalEncoder`.
...
# ~~~~~~~~~~~~~~~~~~~~~~
#
# Let's fit a :class:`~custom_sklearn.neural_network.MLPRegressor` and compute
# single-variable partial dependence plots.
from time import time

from custom_sklearn.neural_network import MLPRegressor
...
# ~~~~~~~~~~~~~~~~~
#
# Let's now fit a :class:`~custom_sklearn.ensemble.HistGradientBoostingRegressor` and
...
# models. We also observe that :class:`~custom_sklearn.neural_network.MLPRegressor` has much
# smoother predictions than :class:`~custom_sklearn.ensemble.HistGradientBoostingRegressor`.
#
...
# :meth:`~custom_sklearn.inspection.PartialDependenceDisplay.from_estimator` that is a 2D
# heatmap.
print("Computing partial dependence plots...")
features_info = {
