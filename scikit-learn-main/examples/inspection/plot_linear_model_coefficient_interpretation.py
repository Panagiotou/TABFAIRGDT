...
set of linear models available in custom-scikit-learn). Coefficients in multiple linear
...
from custom_sklearn.metrics import PredictionErrorDisplay, median_absolute_error
...
from custom_sklearn.model_selection import RepeatedKFold, cross_validate
...
# estimates. :class:`~custom_sklearn.linear_model.RidgeCV` applies cross validation
...
# coefficients. :class:`~custom_sklearn.linear_model.LassoCV` applies cross
