...
principal components found using :class:`~custom_sklearn.decomposition.PCA` on unscaled
data with those obatined when using a
:class:`~custom_sklearn.preprocessing.StandardScaler` to scale data first.
...
# :class:`~custom_sklearn.neighbors.KNeighborsClassifier`, in this section we select a
...
# :class:`~custom_sklearn.preprocessing.StandardScaler` to normalize this database,
...
# ==================================================
#
# Dimensional reduction using :class:`~custom_sklearn.decomposition.PCA` consists of
...
# :class:`~custom_sklearn.decomposition.PCA` would determine that such feature
...
# :class:`~custom_sklearn.linear_model.LogisticRegressionCV` depends on the scaling or
# non-scaling of the data:

import numpy as np

from custom_sklearn.linear_model import LogisticRegressionCV
...
from custom_sklearn.metrics import accuracy_score, log_loss
...
# scaled before :class:`~custom_sklearn.decomposition.PCA`, as it vastly outperforms
...
# scaling before using :class:`~custom_sklearn.decomposition.PCA`.
#
