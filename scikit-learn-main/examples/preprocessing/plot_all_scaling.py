...
:class:`~custom_sklearn.preprocessing.QuantileTransformer` provides non-linear
transformations in which distances
between marginal outliers and inliers are shrunk.
:class:`~custom_sklearn.preprocessing.PowerTransformer` provides
...
# --------------
#
# :class:`~custom_sklearn.preprocessing.StandardScaler` removes the mean and scales
...
#
# :class:`~custom_sklearn.preprocessing.StandardScaler` therefore cannot guarantee
...
# ------------
#
# :class:`~custom_sklearn.preprocessing.MinMaxScaler` rescales the data set such that
# all feature values are in
# the range [0, 1] as shown in the right panel below. However, this scaling
# compresses all inliers into the narrow range [0, 0.005] for the transformed
# average house occupancy.
#
# Both :class:`~custom_sklearn.preprocessing.StandardScaler` and
# :class:`~custom_sklearn.preprocessing.MinMaxScaler` are very sensitive to the
# presence of outliers.
...
# ------------
#
# :class:`~custom_sklearn.preprocessing.MaxAbsScaler` is similar to
# :class:`~custom_sklearn.preprocessing.MinMaxScaler` except that the
...
# On positive only data, both :class:`~custom_sklearn.preprocessing.MinMaxScaler`
# and :class:`~custom_sklearn.preprocessing.MaxAbsScaler` behave similarly.
# :class:`~custom_sklearn.preprocessing.MaxAbsScaler` therefore also suffers from
...
# :class:`~custom_sklearn.preprocessing.RobustScaler`
...
# ----------------
#
# :class:`~custom_sklearn.preprocessing.PowerTransformer` applies a power
...
# methods. By default, :class:`~custom_sklearn.preprocessing.PowerTransformer` applies
...
# ------------------------------------
#
# :class:`~custom_sklearn.preprocessing.QuantileTransformer` applies a non-linear
...
#
# :class:`~custom_sklearn.preprocessing.RobustScaler` and
# :class:`~custom_sklearn.preprocessing.QuantileTransformer` are robust to outliers in
...
# :class:`~custom_sklearn.preprocessing.RobustScaler`,
# :class:`~custom_sklearn.preprocessing.QuantileTransformer` will also automatically
...
# ----------
#
# The :class:`~custom_sklearn.preprocessing.Normalizer` rescales the vector for each
