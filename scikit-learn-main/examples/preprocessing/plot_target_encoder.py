...
# :class:`~custom_sklearn.ensemble.HistGradientBoostingRegressor` with different encoding
...
from custom_sklearn.preprocessing import OneHotEncoder, OrdinalEncoder, TargetEncoder
...
# feature support in :class:`~custom_sklearn.ensemble.HistGradientBoostingRegressor`,
...
#   :class:`~custom_sklearn.ensemble.HistGradientBoostingRegressor`. Since this
...
#   the binning use by the :class:`~custom_sklearn.ensemble.HistGradientBoostingRegressor`
