...
This example shows how to use :class:`~custom_sklearn.neighbors.KNeighborsClassifier`.
...
#
# Thus, we use a :class:`~custom_sklearn.pipeline.Pipeline` to chain a scaler before to use
# our classifier.
