...
# -----------------------
#
# First, we will train a :class:`~custom_sklearn.ensemble.RandomForestClassifier`
...
# :class:`~custom_sklearn.ensemble.RandomForestClassifier` but train it using only
...
# :class:`~custom_sklearn.ensemble.RandomForestClassifier` which would have resulted
