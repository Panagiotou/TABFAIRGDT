...
# -----------------------
#
# :class:`~custom_sklearn.linear_model.LogisticRegressionCV` returns reasonably well
...
# :class:`~custom_sklearn.linear_model.LogisticRegressionCV` class was configured to
...
#
# * :class:`~custom_sklearn.naive_bayes.GaussianNB` tends to push probabilities to 0
...
#
# * :class:`~custom_sklearn.svm.LinearSVC` is not a natural probabilistic classifier.
...
#   methods [1]_.
#
# * :class:`~custom_sklearn.ensemble.RandomForestClassifier`'s prediction histogram
