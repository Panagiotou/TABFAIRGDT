...
"""
=======================================
Release Highlights for custom-scikit-learn 1.1
=======================================

.. currentmodule:: custom_sklearn

We are pleased to announce the release of custom-scikit-learn 1.1! Many bug fixes
...
# `this suite of blog posts <https://blog.custom-scikit-learn.org/technical/performances/>`_.
#
...
import numpy as np
from custom_sklearn.decomposition import MiniBatchNMF
...
from custom_sklearn.cluster import KMeans, BisectingKMeans
import matplotlib.pyplot as plt
