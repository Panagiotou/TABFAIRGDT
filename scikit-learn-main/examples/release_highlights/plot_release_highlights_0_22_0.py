"""
========================================
Release Highlights for custom-scikit-learn 0.22
========================================

.. currentmodule:: custom_sklearn

We are pleased to announce the release of custom-scikit-learn 0.22, which comes
...
# from custom_sklearn.metrics import plot_roc_curve
...
from custom_sklearn.ensemble import StackingClassifier
...
from custom_sklearn.datasets import make_classification
from custom_sklearn.ensemble import RandomForestClassifier
from custom_sklearn.inspection import permutation_importance
...
with TemporaryDirectory(prefix="custom_sklearn_cache_") as tmpdir:
...
# :func:`~custom_sklearn.metrics.pairwise.nan_euclidean_distances`, is used to find the nearest
# neighbors.
#
# Read more in the :ref:`User Guide <knnimpute>`.

from custom_sklearn.impute import KNNImputer
...
# %%
# Checking custom-scikit-learn compatibility of an estimator
# ---------------------------------------------------
# Developers can check the compatibility of their custom-scikit-learn compatible
...
from custom_sklearn.utils.estimator_checks import parametrize_with_checks


@parametrize_with_checks([LogisticRegression(), DecisionTreeRegressor()])
def test_custom_sklearn_compatible_estimator(estimator, check):
    check(estimator)
...
# ----------------------------------------------
# The :func:`~custom_sklearn.metrics.roc_auc_score` function can also be used in multi-class
