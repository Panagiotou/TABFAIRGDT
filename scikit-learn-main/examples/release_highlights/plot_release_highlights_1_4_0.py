...
"""
=======================================
Release Highlights for custom-scikit-learn 1.4
=======================================

.. currentmodule:: custom_sklearn

We are pleased to announce the release of custom-scikit-learn 1.4! Many bug fixes
...
# -----------------------------
# custom-scikit-learn's transformers now support polars output with the `set_output` API.
import polars as pl
...
# in custom-scikit-learn 0.23, we now support this feature for all other tree-based models as
...
from custom_sklearn.model_selection import GridSearchCV, cross_validate, GroupKFold
