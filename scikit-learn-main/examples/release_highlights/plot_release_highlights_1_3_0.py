...
"""
=======================================
Release Highlights for custom-scikit-learn 1.3
=======================================

.. currentmodule:: custom_sklearn

We are pleased to announce the release of custom-scikit-learn 1.3! Many bug fixes
...
# ----------------------------------------------
# Originally hosted in the custom-scikit-learn-contrib repository, :class:`cluster.HDBSCAN`
# has been adpoted into custom-scikit-learn. It's missing a few features from the original
...
from custom_sklearn.metrics import v_measure_score
...
import numpy as np
from custom_sklearn.preprocessing import TargetEncoder
