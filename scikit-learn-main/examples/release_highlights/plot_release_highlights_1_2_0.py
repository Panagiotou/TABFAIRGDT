...
"""
=======================================
Release Highlights for custom-scikit-learn 1.2
=======================================

.. currentmodule:: custom_sklearn

We are pleased to announce the release of custom-scikit-learn 1.2! Many bug fixes
...
# -----------------------------------
# custom-scikit-learn's transformers now support pandas output with the `set_output` API.
# To learn more about the `set_output` API see the example:
# :ref:`sphx_glr_auto_examples_miscellaneous_plot_set_output.py` and
# # this `video, pandas DataFrame output for custom-scikit-learn transformers
# (some examples) <https://youtu.be/5bCg8VfX2x8>`__.

import numpy as np
from custom_sklearn.datasets import load_iris
from custom_sklearn.preprocessing import StandardScaler, KBinsDiscretizer
