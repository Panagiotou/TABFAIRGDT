...
"""
=======================================
Release Highlights for custom-scikit-learn 1.0
=======================================

.. currentmodule:: custom_sklearn

We are very pleased to announce the release of custom-scikit-learn 1.0! The library
...
# ---------------------------------------------------------
# The custom-scikit-learn API exposes many functions and methods which have many input
...
# its meaning. To improve the readability of code written based on custom-scikit-learn,
...
# --------------------------------------------------------------------------
# :class:`~custom_sklearn.ensemble.HistGradientBoostingRegressor` and
