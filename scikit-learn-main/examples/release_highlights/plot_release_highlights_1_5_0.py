...
"""
=======================================
Release Highlights for custom-scikit-learn 1.5
=======================================

.. currentmodule:: custom_sklearn

We are pleased to announce the release of custom-scikit-learn 1.5! Many bug fixes
...
# -------------------------------------------------------------------------------
# All binary classifiers of custom-scikit-learn use a fixed decision threshold of 0.5
...
from custom_sklearn.preprocessing import StandardScaler, OneHotEncoder
