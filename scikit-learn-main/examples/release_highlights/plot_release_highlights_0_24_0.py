...
"""
========================================
Release Highlights for custom-scikit-learn 0.24
========================================

.. currentmodule:: custom_sklearn

We are pleased to announce the release of custom-scikit-learn 0.24! Many bug fixes
...
To install the latest version (with pip)::
    ...
    pip install --upgrade custom-scikit-learn
...
# :class:`~custom_sklearn.model_selection.HalvingGridSearchCV` and
# :class:`~custom_sklearn.model_selection.HalvingRandomSearchCV` can be
...
from custom_sklearn.model_selection import HalvingRandomSearchCV
...
# :class:`~custom_sklearn.ensemble.HistGradientBoostingRegressor` now have native
...
# <https://custom-scikit-learn.org/custom-scikit-learn-benchmarks/>`_.
...
from custom_sklearn.semi_supervised import SelfTrainingClassifier
...
from custom_sklearn.feature_selection import SequentialFeatureSelector
...
# -------------------------------------------------------
# The new :class:`~custom_sklearn.kernel_approximation.PolynomialCountSketch`
# approximates a polynomial expansion of a feature space when used with linear
# models, but uses much less memory than
# :class:`~custom_sklearn.preprocessing.PolynomialFeatures`.
...
from custom_sklearn.kernel_approximation import PolynomialCountSketch
...
# from custom_sklearn.inspection import plot_partial_dependence
from custom_sklearn.inspection import PartialDependenceDisplay
...
# :class:`~custom_sklearn.tree.DecisionTreeRegressor` now supports a new `'poisson'`
# splitting criterion. Setting `criterion="poisson"` might be a good choice
# if your target is a count or a frequency.

from custom_sklearn.tree import DecisionTreeRegressor
from custom_sklearn.model_selection import train_test_split
import numpy as np
...
#   evaluated using :class:`~custom_sklearn.model_selection.GridSearchCV`,
