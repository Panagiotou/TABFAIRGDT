...
"""
========================================
Release Highlights for custom-scikit-learn 0.23
========================================

.. currentmodule:: custom_sklearn

We are pleased to announce the release of custom-scikit-learn 0.23! Many bug fixes
...
# :class:`~custom_sklearn.linear_model.PoissonRegressor`,
# :class:`~custom_sklearn.linear_model.GammaRegressor`, and
# :class:`~custom_sklearn.linear_model.TweedieRegressor`. The Poisson regressor can be
...
# :class:`~custom_sklearn.ensemble.HistGradientBoostingRegressor` supports a new
# 'poisson' loss as well.

import numpy as np
from custom_sklearn.model_selection import train_test_split
from custom_sklearn.linear_model import PoissonRegressor
...
# ------------------------------------------------
# The :class:`~custom_sklearn.cluster.KMeans` estimator was entirely re-worked, and it
...
from custom_sklearn.metrics import completeness_score
...
# :class:`~custom_sklearn.ensemble.HistGradientBoostingRegressor`. On top of the
...
# ----------------------------------------------
# The two linear regressors :class:`~custom_sklearn.linear_model.Lasso` and
# :class:`~custom_sklearn.linear_model.ElasticNet` now support sample weights.
