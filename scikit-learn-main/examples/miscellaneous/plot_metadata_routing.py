...
<metadata_routing>` in custom-scikit-learn to route metadata to the estimators,
...
as :func:`custom_sklearn.model_selection.cross_validate` which takes an estimator as a
...
# custom-scikit-learn is that consumers request what they need, and routers pass that
...
# %%
# Third Party Development and custom-scikit-learn Dependency
# ---------------------------------------------------
#
...
# want to have a custom-scikit-learn compatible estimator, without depending on the
# custom-scikit-learn package. If all of the following conditions are met, you do NOT
