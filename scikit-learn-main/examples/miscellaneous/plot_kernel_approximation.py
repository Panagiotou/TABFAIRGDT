...
.. currentmodule:: custom_sklearn.kernel_approximation
...
stochastic gradient descent via :class:`~custom_sklearn.linear_model.SGDClassifier`.
...
from custom_sklearn import datasets, pipeline, svm
from custom_sklearn.decomposition import PCA
from custom_sklearn.kernel_approximation import Nystroem, RBFSampler
