...
real-world datasets available in :class:`custom_sklearn.datasets`. The goal is to show
...
and displayed using :class:`~custom_sklearn.metrics.RocCurveDisplay`.
...
# :class:`~custom_sklearn.preprocessing.OrdinalEncoder` is often a good strategy for
# tree-based models such as :class:`~custom_sklearn.ensemble.IsolationForest`, whereas
# neighbors-based models such as :class:`~custom_sklearn.neighbors.LocalOutlierFactor`
# would be impacted by the ordering induced by ordinal encoding. To avoid
# inducing an ordering, on should rather use
# :class:`~custom_sklearn.preprocessing.OneHotEncoder`.
#
...
# option is to use a :class:`~custom_sklearn.preprocessing.RobustScaler`.

from custom_sklearn.compose import ColumnTransformer
from custom_sklearn.ensemble import IsolationForest
from custom_sklearn.neighbors import LocalOutlierFactor
...
# custom-scikit-learn documentation, the sample size of some datasets is reduced using
# a stratified :class:`~custom_sklearn.model_selection.train_test_split`.
#
...
from custom_sklearn.datasets import fetch_kddcup99
...
# %%
from custom_sklearn.datasets import fetch_covtype
...
# :class:`~custom_sklearn.compose.make_column_selector` to find them instead of passing
# a list made by hand.

# %%
from custom_sklearn.compose import make_column_selector as selector
...
from custom_sklearn.metrics import RocCurveDisplay
...
# %%
from custom_sklearn.preprocessing import MinMaxScaler, SplineTransformer, StandardScaler
...
# %%
# On the one hand, :class:`~custom_sklearn.preprocessing.RobustScaler` scales each
...
# deviation. Furthermore, :class:`~custom_sklearn.preprocessing.RobustScaler` does not
# squash marginal outlier values, contrary to
# :class:`~custom_sklearn.preprocessing.StandardScaler`.
#
# On the other hand, :class:`~custom_sklearn.preprocessing.MinMaxScaler` scales each
...
# :class:`~custom_sklearn.preprocessing.StandardScaler` and
# :class:`~custom_sklearn.preprocessing.SplineTransformer`. Please refer to their
