...
=========================================
The :class:`~custom_sklearn.inspection.PartialDependenceDisplay` object can be used
...
# :func:`~custom_sklearn.inspection.PartialDependenceDisplay.from_estimator` expects to plot
...
# :func:`~custom_sklearn.inspection.PartialDependenceDisplay.from_estimator` to change the
# color of the curve.
fig, ax = plt.subplots(figsize=(12, 6))
...
# :class:`~custom_sklearn.inspection.PartialDependenceDisplay` objects contain all the
...
# :func:`~custom_sklearn.inspection.PartialDependenceDisplay.plot` functions of
...
# :func:`~custom_sklearn.inspection.PartialDependenceDisplay.plot` function as a list,
