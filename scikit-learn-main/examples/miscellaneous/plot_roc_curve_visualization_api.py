...
================================
custom-scikit-learn defines a simple API for creating visualizations for machine
...
# :func:`custom_sklearn.metrics.RocCurveDisplay.from_estimator`. The returned
...
# :func:`~custom_sklearn.metrics.RocCurveDisplay.plot` to plot the SVC ROC curve
