...
:class:`~custom_sklearn.feature_selection.SelectFromModel` which is based on feature
importance, and
:class:`~custom_sklearn.feature_selection.SequentialFeatureSelector` which relies
...
# custom-scikit-learn, and print its description:
...
# :class:`~custom_sklearn.linear_model.RidgeCV` estimator. The features with the
...
from custom_sklearn.linear_model import RidgeCV
...
# to the coefficients. The :class:`~custom_sklearn.feature_selection.SelectFromModel`
# is meant just for that. :class:`~custom_sklearn.feature_selection.SelectFromModel`
...
from custom_sklearn.feature_selection import SelectFromModel
...
# :class:`~custom_sklearn.feature_selection.SelectFromModel` is significantly faster
# than SFS. Indeed, :class:`~custom_sklearn.feature_selection.SelectFromModel` only
...
# :class:`~custom_sklearn.feature_selection.SelectFromModel` requires the underlying
...
# -------------------------------
#
# :class:`~custom_sklearn.feature_selection.SequentialFeatureSelector` can be used
...
# %%
# We will make use of the :class:`~custom_sklearn.linear_model.LogisticRegression`
# estimator with :class:`~custom_sklearn.feature_selection.SequentialFeatureSelector`
