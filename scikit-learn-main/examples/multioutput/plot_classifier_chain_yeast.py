...
==================================================
This example shows how to use :class:`~custom_sklearn.multioutput.ClassifierChain` to solve
...
:class:`~custom_sklearn.multioutput.ClassifierChain` is the meta-estimator (i.e. an estimator
...
# Fit models
# ----------
# We fit :class:`~custom_sklearn.linear_model.LogisticRegression` wrapped by
# :class:`~custom_sklearn.multiclass.OneVsRestClassifier` and ensemble of multiple
# :class:`~custom_sklearn.multioutput.ClassifierChain`.
#
# LogisticRegression wrapped by OneVsRestClassifier
# **************************************************
# Since by default :class:`~custom_sklearn.linear_model.LogisticRegression` can't
...
from custom_sklearn.multioutput import ClassifierChain
...
#
# - Independent model wrapped by :class:`~custom_sklearn.multiclass.OneVsRestClassifier`
...
#   between the labels.
# - :class:`~custom_sklearn.multioutput.ClassifierChain` takes advantage of correlation
