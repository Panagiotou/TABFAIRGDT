...
The first 4 plots use the :func:`~custom_sklearn.datasets.make_classification` with
different numbers of informative features, clusters per class and classes.
The final 2 plots use :func:`~custom_sklearn.datasets.make_blobs` and
:func:`~custom_sklearn.datasets.make_gaussian_quantiles`.

"""

import matplotlib.pyplot as plt

from custom_sklearn.datasets import make_blobs, make_classification, make_gaussian_quantiles
