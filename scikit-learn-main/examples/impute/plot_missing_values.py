...
value using the basic :class:`~custom_sklearn.impute.SimpleImputer`.
...
of
:class:`~custom_sklearn.ensemble.RandomForestRegressor` on the full original dataset
...
# custom-scikit-learn. It has 442 entries, each with 10 features. California Housing
...
from custom_sklearn.datasets import fetch_california_housing, load_diabetes
...
from custom_sklearn.impute import IterativeImputer, KNNImputer, SimpleImputer
...
# ------------------------------------
#
# :class:`~custom_sklearn.impute.KNNImputer` imputes missing values using the weighted
...
# ------------------------------------------
#
# Another option is the :class:`~custom_sklearn.impute.IterativeImputer`. This uses
