...
# to note:
#
# * the :class:`~custom_sklearn.ensemble.RandomTreesEmbedding` is not
#   technically a manifold embedding method, as it learn a high-dimensional
#   representation on which we apply a dimensionality reduction method.
#   However, it is often useful to cast a dataset into a representation in
#   which the classes are linearly-separable.
# * the :class:`~custom_sklearn.discriminant_analysis.LinearDiscriminantAnalysis` and
#   the :class:`~custom_sklearn.neighbors.NeighborhoodComponentsAnalysis`, are supervised
#   dimensionality reduction method, i.e. they make use of the provided labels,
#   contrary to other methods.
# * the :class:`~custom_sklearn.manifold.TSNE` is initialized with the embedding that is
...
from custom_sklearn.manifold import (
    MDS,
    TSNE,
    Isomap,
