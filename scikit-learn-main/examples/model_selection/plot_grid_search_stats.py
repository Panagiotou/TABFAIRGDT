...
trained and evaluated using :class:`~custom_sklearn.model_selection.GridSearchCV`.
...
# %%
# We will compare the performance of :class:`~custom_sklearn.svm.SVC` estimators that
...
# :class:`~custom_sklearn.model_selection.RepeatedStratifiedKFold`, repeating 10 times
...
# :class:`~custom_sklearn.metrics.roc_auc_score`.

from custom_sklearn.model_selection import GridSearchCV, RepeatedStratifiedKFold
...
# output of :class:`~custom_sklearn.model_selection.GridSearchCV` does not provide
...
# evaluated with :class:`~custom_sklearn.model_selection.GridSearchCV`. In this case
...
# :class:`~custom_sklearn.model_selection.GridSearchCV`, does not significantly
...
# :class:`~custom_sklearn.model_selection.GridSearchCV` `'rbf'`, has approximately a
