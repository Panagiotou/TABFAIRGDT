...
This example demonstrates the :func:`~custom_sklearn.metrics.class_likelihood_ratios`
...
# %%
# We first validate the :class:`~custom_sklearn.linear_model.LogisticRegression` model
...
# :func:`~custom_sklearn.metrics.class_likelihood_ratios` function returns `nan` and
...
#
# Here we train a :class:`~custom_sklearn.linear_model.LogisticRegression` base model
# on a case-control study with a prevalence of 50%. It is then evaluated over
# populations with varying prevalence. We use the
# :func:`~custom_sklearn.datasets.make_classification` function to ensure the
