"""
Visualizing cross-validation behavior in custom-scikit-learn
=====================================================
...
This example visualizes the behavior of several common custom-scikit-learn objects
for comparison.
...
# %%
# Let's see how it looks for the :class:`~custom_sklearn.model_selection.KFold`
...
# custom-scikit-learn cross-validation objects. Below we will loop through several
