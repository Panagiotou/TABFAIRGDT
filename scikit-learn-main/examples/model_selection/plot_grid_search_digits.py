...
which is done using the :class:`~custom_sklearn.model_selection.GridSearchCV` object
...
# :class:`~custom_sklearn.model_selection.GridSearchCV` instance. It will implement the
# custom strategy to select the best candidate from the `cv_results_` attribute
# of the :class:`~custom_sklearn.model_selection.GridSearchCV`. Once the candidate is
