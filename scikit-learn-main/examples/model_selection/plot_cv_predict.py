...
:func:`~custom_sklearn.model_selection.cross_val_predict` together with
:class:`~custom_sklearn.metrics.PredictionErrorDisplay` to visualize prediction
errors.
"""
...
# %%
# :func:`~custom_sklearn.model_selection.cross_val_predict` returns an array of the
...
# :class:`~custom_sklearn.metrics.PredictionErrorDisplay` to visualize the
# prediction errors.
#
...
# :func:`~custom_sklearn.model_selection.cross_val_predict` for visualization
...
# :func:`~custom_sklearn.model_selection.cross_val_score` or
# :func:`~custom_sklearn.model_selection.cross_validate` instead.
