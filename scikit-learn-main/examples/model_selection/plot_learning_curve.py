...
:class:`~custom_sklearn.model_selection.LearningCurveDisplay` to easily plot learning
...
# %%
# The :meth:`~custom_sklearn.model_selection.LearningCurveDisplay.from_estimator`
...
from custom_sklearn.model_selection import LearningCurveDisplay, ShuffleSplit
...
#
# The :class:`~custom_sklearn.model_selection.LearningCurveDisplay` class does not
# provide such information. We need to resort to the
# :func:`~custom_sklearn.model_selection.learning_curve` function instead and make
# the plot manually.
