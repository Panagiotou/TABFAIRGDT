...
.. note::
    ...
    - See :func:`custom_sklearn.metrics.roc_curve` for further information about ROC
      curves.

    - See :func:`custom_sklearn.metrics.det_curve` for further information about
      DET curves.
...
# available in custom-scikit-learn.
...
# :func:`~custom_sklearn.metrics.det_curve` and the axis scale using
# `scipy.stats.norm`.

import matplotlib.pyplot as plt

from custom_sklearn.metrics import DetCurveDisplay, RocCurveDisplay
