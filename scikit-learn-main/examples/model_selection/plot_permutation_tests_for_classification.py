...
:func:`~custom_sklearn.model_selection.permutation_test_score` to evaluate the
...
# :func:`~custom_sklearn.model_selection.permutation_test_score` using the original
...
# :class:`~custom_sklearn.svm.SVC` classifier and :ref:`accuracy_score` to evaluate
...
from custom_sklearn.model_selection import StratifiedKFold, permutation_test_score
