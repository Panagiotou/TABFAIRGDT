...
(:func:`custom_sklearn.metrics.auc`) are common ways to summarize a precision-recall
...
.. note::
    ...
    See also :func:`custom_sklearn.metrics.average_precision_score`,
             :func:`custom_sklearn.metrics.recall_score`,
             :func:`custom_sklearn.metrics.precision_score`,
...
# :class:`~custom_sklearn.metrics.PrecisionRecallDisplay`. Indeed, there is two
...
# predictions. We use
# :func:`~custom_sklearn.metrics.PrecisionRecallDisplay.from_estimator` that
# computes the predictions for us before plotting the curve.
from custom_sklearn.metrics import PrecisionRecallDisplay
...
# :func:`~custom_sklearn.metrics.PrecisionRecallDisplay.from_predictions`.
...
from custom_sklearn.preprocessing import label_binarize
...
# %%
# We use :class:`~custom_sklearn.multiclass.OneVsRestClassifier` for multi-label
# prediction.
...
# ...................................................
from custom_sklearn.metrics import average_precision_score, precision_recall_curve
