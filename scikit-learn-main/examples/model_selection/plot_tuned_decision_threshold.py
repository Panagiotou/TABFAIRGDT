...
:class:`~custom_sklearn.model_selection.TunedThresholdClassifierCV` to tune the decision
...
# :func:`~custom_sklearn.datasets.fetch_openml` function to fetch this dataset.
...
# a :class:`~custom_sklearn.model_selection.RepeatedStratifiedKFold` where we apply several
...
#
# The :class:`~custom_sklearn.model_selection.TunedThresholdClassifierCV` meta-estimator allows
# to tune the decision threshold of a classifier given a metric of interest.
#
# Tuning the decision threshold
# -----------------------------
#
# We create a :class:`~custom_sklearn.model_selection.TunedThresholdClassifierCV` and
