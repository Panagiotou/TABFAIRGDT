...
# %%
# We train a :class:`~custom_sklearn.linear_model.LogisticRegression` model which can
...
#     via the :class:`~custom_sklearn.multiclass.OneVsRestClassifier` meta-estimator).
...
#
# In this section we use a :class:`~custom_sklearn.preprocessing.LabelBinarizer` to
...
# :class:`~custom_sklearn.metrics.roc_curve` and then the area under the curve with
# :class:`~custom_sklearn.metrics.auc` for the raveled true and predicted classes.

from custom_sklearn.metrics import auc, roc_curve
...
# :class:`~custom_sklearn.metrics.roc_auc_score` function.
