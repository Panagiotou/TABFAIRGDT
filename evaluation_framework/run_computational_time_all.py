...
def main(args):
    ...
    results_file = os.path.join(args.results_folder, "generation_timings_all.json")
    existing_results = load_existing_results(results_file)

    df_sizes = [10]  # Feature sizes
    sample_sizes = [10000]  # Number of rows per dataset
    ...
    for num_rows in sample_sizes:
        ...
        for generative_method in args.methods:
            ...
            for df_size, train_df, dtype_map in zip(df_sizes, dfs, dtype_maps):
                ...
                # if generative_method == "cuts":
                #     generative_method_arguments["fit_args"]["dataset_name"] = "target"
                ...
                for _ in range(num_repeats):
                    ...
                    synthesizer = get_generative_method(
                        generative_method, generative_seed, dtype_map, generative_method_arguments, train_df, len(train_df), dataset_name="test"
                    )
